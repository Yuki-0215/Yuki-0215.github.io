...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/encodeurl/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Encode URL - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#encode-url" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#encodeurlurl" class="md-nav__link">
    encodeUrl(url)
  </a>
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#encode-a-url-containing-user-controlled-data" class="md-nav__link">
    Encode a URL containing user-controlled data
          ...
          <li class="md-nav__item">
  <a href="#encode-a-url-for-use-in-a-header-field" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/encodeurl/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="encode-url">Encode URL<a class="headerlink" href="#encode-url" title="Permanent link">&para;</a></h1>
<p>Encode a URL to a percent-encoded form, excluding already-encoded sequences.</p>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>encodeurl
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">encodeUrl</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;encodeurl&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="encodeurlurl">encodeUrl(url)<a class="headerlink" href="#encodeurlurl" title="Permanent link">&para;</a></h3>
<p>Encode a URL to a percent-encoded form, excluding already-encoded sequences.</p>
<p>This function accepts a URL and encodes all the non-URL code points (as UTF-8 byte sequences). It will not encode the "%" character unless it is not part of a valid sequence (<code>%20</code> will be left as-is, but <code>%foo</code> will be encoded as <code>%25foo</code>).</p>
...
<h3 id="encode-a-url-containing-user-controlled-data">Encode a URL containing user-controlled data<a class="headerlink" href="#encode-a-url-containing-user-controlled-data" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">encodeUrl</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;encodeurl&#39;</span><span class="p">)</span>
...
<h3 id="encode-a-url-for-use-in-a-header-field">Encode a URL for use in a header field<a class="headerlink" href="#encode-a-url-for-use-in-a-header-field" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">encodeUrl</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;encodeurl&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">escapeHtml</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;escape-html&#39;</span><span class="p">)</span>
...
<p>This function is <em>similar</em> to the intrinsic function <code>encodeURI</code>. However, it will not encode:</p>
<ul>
<li>The <code>\</code>, <code>^</code>, or <code>|</code> characters</li>
<li>The <code>%</code> character when it's part of a valid sequence</li>
<li><code>[</code> and <code>]</code> (for IPv6 hostnames)</li>
...
<p>It is expected that any output from <code>new URL(url)</code> will not change when used with this package, as the output has already been encoded. Additionally, if we were to encode before <code>new URL(url)</code>, we do not expect the before and after encoded formats to be parsed any differently.</p>
