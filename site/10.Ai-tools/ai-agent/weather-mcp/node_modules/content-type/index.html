...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/content-type/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>content-type - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#content-type" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#contenttypeparsestring" class="md-nav__link">
    contentType.parse(string)
          ...
          <li class="md-nav__item">
  <a href="#contenttypeparsereq" class="md-nav__link">
    contentType.parse(req)
          ...
          <li class="md-nav__item">
  <a href="#contenttypeparseres" class="md-nav__link">
    contentType.parse(res)
          ...
          <li class="md-nav__item">
  <a href="#contenttypeformatobj" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/content-type/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="content-type">content-type<a class="headerlink" href="#content-type" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/content-type"><img alt="NPM Version" src="https://badgen.net/npm/v/content-type" /></a>
<a href="https://npmjs.org/package/content-type"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/content-type" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/content-type" /></a>
<a href="https://github.com/jshttp/content-type/actions/workflows/ci.yml"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/content-type/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/content-type?branch=master"><img alt="Coverage Status" src="https://badgen.net/coveralls/c/github/jshttp/content-type/master" /></a></p>
<p>Create and parse HTTP Content-Type header according to RFC 7231</p>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>content-type
</code></pre></div>
...
<h3 id="contenttypeparsestring">contentType.parse(string)<a class="headerlink" href="#contenttypeparsestring" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">obj</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">contentType</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">&#39;image/svg+xml; charset=utf-8&#39;</span><span class="p">)</span>
</code></pre></div>
<p>Parse a <code>Content-Type</code> header. This will return an object with the following
...
<h3 id="contenttypeparsereq">contentType.parse(req)<a class="headerlink" href="#contenttypeparsereq" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">obj</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">contentType</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">req</span><span class="p">)</span>
</code></pre></div>
...
<h3 id="contenttypeparseres">contentType.parse(res)<a class="headerlink" href="#contenttypeparseres" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">obj</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">contentType</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">res</span><span class="p">)</span>
</code></pre></div>
...
<p>Throws a <code>TypeError</code> if the <code>Content-Type</code> header is missing or invalid.</p>
<h3 id="contenttypeformatobj">contentType.format(obj)<a class="headerlink" href="#contenttypeformatobj" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">str</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">contentType</span><span class="p">.</span><span class="nx">format</span><span class="p">({</span>
<span class="w">  </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;image/svg+xml&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="nx">parameters</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">charset</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;utf-8&#39;</span><span class="w"> </span><span class="p">}</span>
<span class="p">})</span>
</code></pre></div>
<p>Format an object into a <code>Content-Type</code> header. This will return a string of the
