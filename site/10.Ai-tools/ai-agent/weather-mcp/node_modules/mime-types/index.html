...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/mime-types/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>mime-types - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#mime-types" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#mimelookuppath" class="md-nav__link">
    mime.lookup(path)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#mimecontenttypetype" class="md-nav__link">
    mime.contentType(type)
          ...
          <li class="md-nav__item">
  <a href="#mimeextensiontype" class="md-nav__link">
    mime.extension(type)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#mimecharsettype" class="md-nav__link">
    mime.charset(type)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#var-type-mimetypesextension" class="md-nav__link">
    var type = mime.types[extension]
          ...
          <li class="md-nav__item">
  <a href="#extensions-mimeextensionstype" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/mime-types/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="mime-types">mime-types<a class="headerlink" href="#mime-types" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/mime-types"><img alt="NPM Version" src="https://badgen.net/npm/v/mime-types" /></a>
<a href="https://npmjs.org/package/mime-types"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/mime-types" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/mime-types" /></a>
<a href="https://github.com/jshttp/mime-types/actions/workflows/ci.yml"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/mime-types/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/mime-types?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/jshttp/mime-types/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>mime-types
</code></pre></div>
...
<p>In the past the version of <code>mime-db</code> was pinned to give two decision points when adopting MIME data changes. This is no longer true. We still update the
<code>mime-db</code> package here as a <code>minor</code> release when necessary, but will use a <code>^</code> range going forward. This means that if you want to pin your <code>mime-db</code> data
...
a breaking change.</p>
<p>If you wish to pin your <code>mime-db</code> version you can do that with overrides via your package manager of choice. See their documentation for how to correctly configure that.</p>
<h2 id="adding-types">Adding Types<a class="headerlink" href="#adding-types" title="Permanent link">&para;</a></h2>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">mime</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;mime-types&#39;</span><span class="p">)</span>
</code></pre></div>
<p>All functions return <code>false</code> if input is invalid or not found.</p>
<h3 id="mimelookuppath">mime.lookup(path)<a class="headerlink" href="#mimelookuppath" title="Permanent link">&para;</a></h3>
<p>Lookup the content-type associated with a file.</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">lookup</span><span class="p">(</span><span class="s1">&#39;json&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// &#39;application/json&#39;</span>
...
<h3 id="mimecontenttypetype">mime.contentType(type)<a class="headerlink" href="#mimecontenttypetype" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">contentType</span><span class="p">(</span><span class="s1">&#39;markdown&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// &#39;text/x-markdown; charset=utf-8&#39;</span>
...
<h3 id="mimeextensiontype">mime.extension(type)<a class="headerlink" href="#mimeextensiontype" title="Permanent link">&para;</a></h3>
<p>Get the default extension for a content-type.</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">extension</span><span class="p">(</span><span class="s1">&#39;application/octet-stream&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// &#39;bin&#39;</span>
</code></pre></div>
<h3 id="mimecharsettype">mime.charset(type)<a class="headerlink" href="#mimecharsettype" title="Permanent link">&para;</a></h3>
<p>Lookup the implied default charset of a content-type.</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">charset</span><span class="p">(</span><span class="s1">&#39;text/markdown&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// &#39;UTF-8&#39;</span>
</code></pre></div>
<h3 id="var-type-mimetypesextension">var type = mime.types[extension]<a class="headerlink" href="#var-type-mimetypesextension" title="Permanent link">&para;</a></h3>
<p>A map of content-types by extension.</p>
<h3 id="extensions-mimeextensionstype">[extensions...] = mime.extensions[type]<a class="headerlink" href="#extensions-mimeextensionstype" title="Permanent link">&para;</a></h3>
