...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/send/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>send - Kubernetes 进阶训练营</title>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#sendreq-path-options" class="md-nav__link">
    send(req, path, [options])
  </a>
  
    <nav class="md-nav" aria-label="send(req, path, [options])">
      <ul class="md-nav__list">
  ...
  <a href="#options" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#acceptranges" class="md-nav__link">
    acceptRanges
  </a>
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#serve-a-specific-file" class="md-nav__link">
    Serve a specific file
          ...
          <li class="md-nav__item">
  <a href="#serve-all-files-from-a-directory" class="md-nav__link">
    Serve all files from a directory
          ...
          <li class="md-nav__item">
  <a href="#custom-file-types" class="md-nav__link">
    Custom file types
  </a>
          ...
          <li class="md-nav__item">
  <a href="#custom-directory-index-view" class="md-nav__link">
    Custom directory index view
          ...
          <li class="md-nav__item">
  <a href="#serving-from-a-root-directory-with-custom-error-handling" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/send/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="send">send<a class="headerlink" href="#send" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/send"><img alt="NPM Version" src="https://badgen.net/npm/v/send" /></a>
<a href="https://npmjs.org/package/send"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/send" /></a>
<a href="https://github.com/pillarjs/send/actions/workflows/ci.yml"><img alt="CI" src="https://badgen.net/github/checks/pillarjs/send/master?label=linux" /></a>
<a href="https://coveralls.io/r/pillarjs/send?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/pillarjs/send/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>send
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">send</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;send&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="sendreq-path-options">send(req, path, [options])<a class="headerlink" href="#sendreq-path-options" title="Permanent link">&para;</a></h3>
...
<h5 id="acceptranges">acceptRanges<a class="headerlink" href="#acceptranges" title="Permanent link">&para;</a></h5>
...
<h5 id="cachecontrol">cacheControl<a class="headerlink" href="#cachecontrol" title="Permanent link">&para;</a></h5>
...
<h5 id="dotfiles">dotfiles<a class="headerlink" href="#dotfiles" title="Permanent link">&para;</a></h5>
...
<h5 id="end">end<a class="headerlink" href="#end" title="Permanent link">&para;</a></h5>
...
the 4<sup>th</sup> byte in the stream.</p>
<h5 id="etag">etag<a class="headerlink" href="#etag" title="Permanent link">&para;</a></h5>
<p>Enable or disable etag generation, defaults to true.</p>
<h5 id="extensions">extensions<a class="headerlink" href="#extensions" title="Permanent link">&para;</a></h5>
...
<h5 id="immutable">immutable<a class="headerlink" href="#immutable" title="Permanent link">&para;</a></h5>
<p>Enable or disable the <code>immutable</code> directive in the <code>Cache-Control</code> response
...
<h5 id="index">index<a class="headerlink" href="#index" title="Permanent link">&para;</a></h5>
...
<h5 id="lastmodified">lastModified<a class="headerlink" href="#lastmodified" title="Permanent link">&para;</a></h5>
<p>Enable or disable <code>Last-Modified</code> header, defaults to true. Uses the file
system's last modified value.</p>
<h5 id="maxage">maxAge<a class="headerlink" href="#maxage" title="Permanent link">&para;</a></h5>
...
<h5 id="root">root<a class="headerlink" href="#root" title="Permanent link">&para;</a></h5>
<p>Serve files relative to <code>path</code>.</p>
<h5 id="start">start<a class="headerlink" href="#start" title="Permanent link">&para;</a></h5>
<p>Byte offset at which the stream starts, defaults to 0. The start is inclusive,
meaning <code>start: 2</code> will include the 3<sup>rd</sup> byte in the stream.</p>
...
<h4 id="pipe">.pipe<a class="headerlink" href="#pipe" title="Permanent link">&para;</a></h4>
...
<div class="highlight"><pre><span></span><code>$ DEBUG=send node app
</code></pre></div>
...
<h3 id="serve-a-specific-file">Serve a specific file<a class="headerlink" href="#serve-a-specific-file" title="Permanent link">&para;</a></h3>
...
<h3 id="serve-all-files-from-a-directory">Serve all files from a directory<a class="headerlink" href="#serve-all-files-from-a-directory" title="Permanent link">&para;</a></h3>
<p>This simple example will just serve up all the files in a
given directory as the top-level. For example, a request
<code>GET /foo.txt</code> will send back <code>/www/public/foo.txt</code>.</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">http</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;http&#39;</span><span class="p">)</span>
...
<h3 id="custom-file-types">Custom file types<a class="headerlink" href="#custom-file-types" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">extname</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;path&#39;</span><span class="p">).</span><span class="nx">extname</span>
...
<span class="kd">var</span><span class="w"> </span><span class="nx">server</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="nx">onRequest</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">send</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">parseUrl</span><span class="p">(</span><span class="nx">req</span><span class="p">).</span><span class="nx">pathname</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">root</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;/www/public&#39;</span><span class="w"> </span><span class="p">})</span>
<span class="w">    </span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;headers&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">path</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="k">switch</span><span class="w"> </span><span class="p">(</span><span class="nx">extname</span><span class="p">(</span><span class="nx">path</span><span class="p">))</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="k">case</span><span class="w"> </span><span class="s1">&#39;.x-mt&#39;</span><span class="o">:</span>
<span class="w">        </span><span class="k">case</span><span class="w"> </span><span class="s1">&#39;.x-mtt&#39;</span><span class="o">:</span>
<span class="w">          </span><span class="c1">// custom type for these extensions</span>
<span class="w">          </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;application/x-my-type&#39;</span><span class="p">)</span>
...
<h3 id="custom-directory-index-view">Custom directory index view<a class="headerlink" href="#custom-directory-index-view" title="Permanent link">&para;</a></h3>
<p>This is an example of serving up a structure of directories with a
...
<h3 id="serving-from-a-root-directory-with-custom-error-handling">Serving from a root directory with custom error-handling<a class="headerlink" href="#serving-from-a-root-directory-with-custom-error-handling" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">http</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;http&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">parseUrl</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;parseurl&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">send</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;send&#39;</span><span class="p">)</span>
