...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/http-errors/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>http-errors - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#http-errors" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#error-properties" class="md-nav__link">
    Error Properties
  </a>
          ...
          <li class="md-nav__item">
  <a href="#createerrorstatus-message-properties" class="md-nav__link">
    createError([status], [message], [properties])
          ...
          <li class="md-nav__item">
  <a href="#createerrorstatus-error-properties" class="md-nav__link">
    createError([status], [error], [properties])
          ...
          <li class="md-nav__item">
  <a href="#createerrorishttperrorval" class="md-nav__link">
    createError.isHttpError(val)
          ...
          <li class="md-nav__item">
  <a href="#new-createerrorcode-namemsg" class="md-nav__link">
    new createError[code || name]([msg]))
  </a>
  
    <nav class="md-nav" aria-label="new createError[code || name]([msg]))">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#list-of-all-constructors" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/http-errors/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="http-errors">http-errors<a class="headerlink" href="#http-errors" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/http-errors"><img alt="NPM Version" src="https://badgen.net/npm/v/http-errors" /></a>
<a href="https://nodejs.org/en/download"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/http-errors" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/http-errors" /></a>
<a href="https://github.com/jshttp/http-errors/actions?query=workflow%3Aci"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/http-errors/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/http-errors?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/jshttp/http-errors/master" /></a></p>
...
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>npm<span class="w"> </span>install<span class="w"> </span>http-errors
</code></pre></div>
<h2 id="example">Example<a class="headerlink" href="#example" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">createError</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;http-errors&#39;</span><span class="p">)</span>
...
<h3 id="error-properties">Error Properties<a class="headerlink" href="#error-properties" title="Permanent link">&para;</a></h3>
<ul>
...
<h3 id="createerrorstatus-message-properties">createError([status], [message], [properties])<a class="headerlink" href="#createerrorstatus-message-properties" title="Permanent link">&para;</a></h3>
<p>Create a new error object with the given message <code>msg</code>.
The error object inherits from <code>createError.HttpError</code>.</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">err</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">createError</span><span class="p">(</span><span class="mf">404</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;This video does not exist!&#39;</span><span class="p">)</span>
</code></pre></div>
<ul>
...
<h3 id="createerrorstatus-error-properties">createError([status], [error], [properties])<a class="headerlink" href="#createerrorstatus-error-properties" title="Permanent link">&para;</a></h3>
<p>Extend the given <code>error</code> object with <code>createError.HttpError</code>
properties. This will not alter the inheritance of the given
<code>error</code> object, and the modified <code>error</code> object is the
return value.</p>
<!-- eslint-disable no-redeclare -->

<div class="highlight"><pre><span></span><code><span class="nx">fs</span><span class="p">.</span><span class="nx">readFile</span><span class="p">(</span><span class="s1">&#39;foo.txt&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">err</span><span class="p">,</span><span class="w"> </span><span class="nx">buf</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<h3 id="createerrorishttperrorval">createError.isHttpError(val)<a class="headerlink" href="#createerrorishttperrorval" title="Permanent link">&para;</a></h3>
<p>Determine if the provided <code>val</code> is an <code>HttpError</code>. This will return <code>true</code>
if the error inherits from the <code>HttpError</code> constructor of this module or
matches the "duck type" for an error this module creates. All outputs from
the <code>createError</code> factory will return <code>true</code> for this function, including
if an non-<code>HttpError</code> was passed into the factory.</p>
<h3 id="new-createerrorcode-namemsg">new createError[code || name]([msg]))<a class="headerlink" href="#new-createerrorcode-namemsg" title="Permanent link">&para;</a></h3>
<p>Create a new error object with the given message <code>msg</code>.
The error object inherits from <code>createError.HttpError</code>.</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">err</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">createError</span><span class="p">.</span><span class="nx">NotFound</span><span class="p">()</span>
</code></pre></div>
<ul>
...
<h4 id="list-of-all-constructors">List of all constructors<a class="headerlink" href="#list-of-all-constructors" title="Permanent link">&para;</a></h4>
<table>
<thead>
<tr>
<th>Status Code</th>
