...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/fresh/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>fresh - Kubernetes 进阶训练营</title>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#freshreqheaders-resheaders" class="md-nav__link">
  ...
  <a href="#api-usage" class="md-nav__link">
    API usage
          ...
          <li class="md-nav__item">
  <a href="#using-with-nodejs-http-server" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/fresh/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="fresh">fresh<a class="headerlink" href="#fresh" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/fresh"><img alt="NPM Version" src="https://img.shields.io/npm/v/fresh.svg" /></a>
<a href="https://npmjs.org/package/fresh"><img alt="NPM Downloads" src="https://img.shields.io/npm/dm/fresh.svg" /></a>
<a href="https://nodejs.org/en/"><img alt="Node.js Version" src="https://img.shields.io/node/v/fresh.svg" /></a>
<a href="https://github.com/jshttp/fresh/actions/workflows/ci.yml"><img alt="Build Status" src="https://img.shields.io/github/workflow/status/jshttp/fresh/ci/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/fresh?branch=master"><img alt="Test Coverage" src="https://img.shields.io/coveralls/jshttp/fresh/master.svg" /></a></p>
...
<div class="highlight"><pre><span></span><code>$ npm install fresh
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">fresh</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;fresh&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="freshreqheaders-resheaders">fresh(reqHeaders, resHeaders)<a class="headerlink" href="#freshreqheaders-resheaders" title="Permanent link">&para;</a></h3>
...
<h3 id="api-usage">API usage<a class="headerlink" href="#api-usage" title="Permanent link">&para;</a></h3>
<!-- eslint-disable no-redeclare -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">reqHeaders</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="s1">&#39;if-none-match&#39;</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;&quot;foo&quot;&#39;</span><span class="w"> </span><span class="p">}</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">resHeaders</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">etag</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;&quot;bar&quot;&#39;</span><span class="w"> </span><span class="p">}</span>
...
<span class="kd">var</span><span class="w"> </span><span class="nx">resHeaders</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">etag</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;&quot;foo&quot;&#39;</span><span class="w"> </span><span class="p">}</span>
<span class="nx">fresh</span><span class="p">(</span><span class="nx">reqHeaders</span><span class="p">,</span><span class="w"> </span><span class="nx">resHeaders</span><span class="p">)</span>
<span class="c1">// =&gt; true</span>
</code></pre></div>
<h3 id="using-with-nodejs-http-server">Using with Node.js http server<a class="headerlink" href="#using-with-nodejs-http-server" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">fresh</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;fresh&#39;</span><span class="p">)</span>
...
<span class="w">    </span><span class="nx">etag</span><span class="o">:</span><span class="w"> </span><span class="nx">res</span><span class="p">.</span><span class="nx">getHeader</span><span class="p">(</span><span class="s1">&#39;ETag&#39;</span><span class="p">),</span>
