...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/merge-descriptors/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>merge-descriptors - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#merge-descriptors" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#mergedestination-source-overwrite" class="md-nav__link">
    merge(destination, source, overwrite?)
  </a>
  
    <nav class="md-nav" aria-label="merge(destination, source, overwrite?)">
      <ul class="md-nav__list">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/merge-descriptors/readme.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="merge-descriptors">merge-descriptors<a class="headerlink" href="#merge-descriptors" title="Permanent link">&para;</a></h1>
<blockquote>
<p>Merge objects using their property descriptors</p>
</blockquote>
<h2 id="install">Install<a class="headerlink" href="#install" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>merge-descriptors
</code></pre></div>
<h2 id="usage">Usage<a class="headerlink" href="#usage" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">mergeDescriptors</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;merge-descriptors&#39;</span><span class="p">;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">thing</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">        </span><span class="k">return</span><span class="w"> </span><span class="s1">&#39;John&#39;</span>
<span class="w">    </span><span class="p">}</span>
<span class="p">}</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">animal</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{};</span>

<span class="nx">mergeDescriptors</span><span class="p">(</span><span class="nx">animal</span><span class="p">,</span><span class="w"> </span><span class="nx">thing</span><span class="p">);</span>
...
<h3 id="mergedestination-source-overwrite">merge(destination, source, overwrite?)<a class="headerlink" href="#mergedestination-source-overwrite" title="Permanent link">&para;</a></h3>
<p>Merges "own" properties from a source to a destination object, including non-enumerable and accessor-defined properties. It retains original values and descriptors, ensuring the destination receives a complete and accurate copy of the source's properties.</p>
<p>Returns the modified destination object.</p>
<h4 id="destination">destination<a class="headerlink" href="#destination" title="Permanent link">&para;</a></h4>
<p>Type: <code>object</code></p>
<p>The object to receive properties.</p>
<h4 id="source">source<a class="headerlink" href="#source" title="Permanent link">&para;</a></h4>
<p>Type: <code>object</code></p>
<p>The object providing properties.</p>
<h4 id="overwrite">overwrite<a class="headerlink" href="#overwrite" title="Permanent link">&para;</a></h4>
<p>Type: <code>boolean</code>\
Default: <code>true</code></p>
<p>A boolean to control overwriting of existing properties.</p>
