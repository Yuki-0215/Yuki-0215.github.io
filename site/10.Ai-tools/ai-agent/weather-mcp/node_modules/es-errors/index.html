...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/es-errors/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>es-errors Version Badge - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#es-errors" class="md-skip">
          跳转至
        </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/es-errors/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="es-errors">es-errors <sup><a href="https://npmjs.org/package/es-errors"><img alt="Version Badge" src="https://versionbadg.es/ljharb/es-errors.svg" /></a></sup><a class="headerlink" href="#es-errors" title="Permanent link">&para;</a></h1>
<p><a href="https://github.com/ljharb/es-errors/actions"><img alt="github actions" src="https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/ljharb/es-errors" /></a>
<a href="https://app.codecov.io/gh/ljharb/es-errors/"><img alt="coverage" src="https://codecov.io/gh/ljharb/es-errors/branch/main/graphs/badge.svg" /></a>
<a href="LICENSE"><img alt="License" src="https://img.shields.io/npm/l/es-errors.svg" /></a>
<a href="https://npm-stat.com/charts.html?package=es-errors"><img alt="Downloads" src="https://img.shields.io/npm/dm/es-errors.svg" /></a></p>
<p><a href="https://npmjs.org/package/es-errors"><img alt="npm badge" src="https://nodei.co/npm/es-errors.png?downloads=true&amp;stars=true" /></a></p>
<p>A simple cache for a few of the JS Error constructors.</p>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">Base</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;es-errors&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">Eval</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;es-errors/eval&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">Range</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;es-errors/range&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">Ref</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;es-errors/ref&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">Syntax</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;es-errors/syntax&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">Type</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;es-errors/type&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">URI</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;es-errors/uri&#39;</span><span class="p">);</span>

<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Base</span><span class="p">,</span><span class="w"> </span><span class="ne">Error</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Eval</span><span class="p">,</span><span class="w"> </span><span class="ne">EvalError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Range</span><span class="p">,</span><span class="w"> </span><span class="ne">RangeError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Ref</span><span class="p">,</span><span class="w"> </span><span class="ne">ReferenceError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Syntax</span><span class="p">,</span><span class="w"> </span><span class="ne">SyntaxError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">Type</span><span class="p">,</span><span class="w"> </span><span class="ne">TypeError</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">URI</span><span class="p">,</span><span class="w"> </span><span class="ne">URIError</span><span class="p">);</span>
</code></pre></div>
