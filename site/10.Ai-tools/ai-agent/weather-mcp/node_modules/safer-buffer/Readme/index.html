...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/safer-buffer/Readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>safer-buffer travis npm javascript style guide Security Responsible Disclosure - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#safer-buffer" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#how-to-use" class="md-nav__link">
    How to use?
        ...
        <li class="md-nav__item">
  <a href="#do-i-need-it" class="md-nav__link">
    Do I need it?
  </a>
        ...
        <li class="md-nav__item">
  <a href="#why-not-safe-buffer" class="md-nav__link">
    Why not safe-buffer?
  </a>
        ...
        <li class="md-nav__item">
  <a href="#but-isnt-throwing-bad" class="md-nav__link">
    But isn't throwing bad?
  </a>
  
    <nav class="md-nav" aria-label="But isn't throwing bad?">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#would-it-affect-third-party-modules" class="md-nav__link">
    Would it affect third-party modules?
          ...
          <li class="md-nav__item">
  <a href="#but-i-dont-want-throwing" class="md-nav__link">
    But I don't want throwing…
        ...
        <li class="md-nav__item">
  <a href="#without-footguns" class="md-nav__link">
    «Without footguns»?
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/safer-buffer/Readme.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="safer-buffer">safer-buffer <a href="https://travis-ci.org/ChALkeR/safer-buffer"><img alt="travis" src="https://travis-ci.org/ChALkeR/safer-buffer.svg?branch=master" /></a> <a href="https://npmjs.org/package/safer-buffer"><img alt="npm" src="https://img.shields.io/npm/v/safer-buffer.svg" /></a> <a href="https://standardjs.com"><img alt="javascript style guide" src="https://img.shields.io/badge/code_style-standard-brightgreen.svg" /></a> <a href="https://github.com/nodejs/security-wg/blob/master/processes/responsible_disclosure_template.md"><img alt="Security Responsible Disclosure" src="https://img.shields.io/badge/Security-Responsible%20Disclosure-green.svg" /></a><a class="headerlink" href="#safer-buffer" title="Permanent link">&para;</a></h1>
...
<h2 id="do-i-need-it">Do I need it?<a class="headerlink" href="#do-i-need-it" title="Permanent link">&para;</a></h2>
...
<h2 id="why-not-safe-buffer">Why not <a href="https://npmjs.com/safe-buffer">safe-buffer</a>?<a class="headerlink" href="#why-not-safe-buffer" title="Permanent link">&para;</a></h2>
...
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>cat<span class="w"> </span>example.unsafe.js
<span class="go">console.log(Buffer(20))</span>
<span class="gp">$ </span>./node-v6.13.0-linux-x64/bin/node<span class="w"> </span>example.unsafe.js
<span class="go">&lt;Buffer 0a 00 00 00 00 00 00 00 28 13 de 02 00 00 00 00 05 00 00 00&gt;</span>
<span class="gp">$ </span>standard<span class="w"> </span>example.unsafe.js
<span class="go">standard: Use JavaScript Standard Style (https://standardjs.com)</span>
<span class="go">  /home/chalker/repo/safer-buffer/example.unsafe.js:2:13: &#39;Buffer()&#39; was deprecated since v6. Use &#39;Buffer.alloc()&#39; or &#39;Buffer.from()&#39; (use &#39;https://www.npmjs.com/package/safe-buffer&#39; for &#39;&lt;4.5.0&#39;) instead.</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>cat<span class="w"> </span>example.safe-buffer.js
<span class="go">const Buffer = require(&#39;safe-buffer&#39;).Buffer</span>
<span class="go">console.log(Buffer(20))</span>
<span class="gp">$ </span>standard<span class="w"> </span>example.safe-buffer.js
<span class="gp">$ </span>./node-v6.13.0-linux-x64/bin/node<span class="w"> </span>example.safe-buffer.js
<span class="go">&lt;Buffer 08 00 00 00 00 00 00 00 28 58 01 82 fe 7f 00 00 00 00 00 00&gt;</span>
</code></pre></div>
...
<p>Some examples:
 * <a href="https://github.com/webdriverio/webdriverio/commit/05cbd3167c12e4930f09ef7cf93b127ba4effae4#diff-124380949022817b90b622871837d56cR31">webdriverio</a>
   (a module with 548 759 downloads/month),
 * <a href="https://github.com/maxogden/websocket-stream/commit/c9312bd24d08271687d76da0fe3c83493871cf61">websocket-stream</a>
   (218 288 d/m, fix in <a href="https://github.com/maxogden/websocket-stream/pull/142">maxogden/websocket-stream#142</a>),
 * <a href="https://github.com/node-serialport/node-serialport/commit/e8d9d2b16c664224920ce1c895199b1ce2def48c">node-serialport</a>
   (113 138 d/m, fix in <a href="https://github.com/node-serialport/node-serialport/pull/1510">node-serialport/node-serialport#1510</a>),
 * <a href="https://github.com/karma-runner/karma/commit/3d94b8cf18c695104ca195334dc75ff054c74eec">karma</a>
   (3 973 193 d/m, fix in <a href="https://github.com/karma-runner/karma/pull/2947">karma-runner/karma#2947</a>),
 * <a href="https://github.com/spdy-http2/spdy-transport/commit/5375ac33f4a62a4f65bcfc2827447d42a5dbe8b1">spdy-transport</a>
   (5 970 727 d/m, fix in <a href="https://github.com/spdy-http2/spdy-transport/pull/53">spdy-http2/spdy-transport#53</a>).
 * And there are a lot more over the ecosystem.</p>
<p>I filed a PR at
...
<h2 id="but-isnt-throwing-bad">But isn't throwing bad?<a class="headerlink" href="#but-isnt-throwing-bad" title="Permanent link">&para;</a></h2>
...
<h3 id="would-it-affect-third-party-modules">Would it affect third-party modules?<a class="headerlink" href="#would-it-affect-third-party-modules" title="Permanent link">&para;</a></h3>
<p>No, unless you explicitly do an awful thing like monkey-patching or overriding the built-in <code>Buffer</code>.
Don't do that.</p>
<h3 id="but-i-dont-want-throwing">But I don't want throwing…<a class="headerlink" href="#but-i-dont-want-throwing" title="Permanent link">&para;</a></h3>
...
<h2 id="without-footguns">«Without footguns»?<a class="headerlink" href="#without-footguns" title="Permanent link">&para;</a></h2>
