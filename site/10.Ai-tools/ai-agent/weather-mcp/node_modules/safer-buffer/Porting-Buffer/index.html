...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/safer-buffer/Porting-Buffer/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Porting to the Buffer.from/Buffer.alloc API - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#porting-to-the-bufferfrombufferalloc-api" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#overview" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Overview">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#finding-problematic-bits-of-code-using-grep" class="md-nav__link">
    Finding problematic bits of code using grep
          ...
          <li class="md-nav__item">
  <a href="#finding-problematic-bits-of-code-using-nodejs-8" class="md-nav__link">
    Finding problematic bits of code using Node.js 8
          ...
          <li class="md-nav__item">
  <a href="#finding-problematic-bits-of-code-using-linters" class="md-nav__link">
    Finding problematic bits of code using linters
        ...
        <li class="md-nav__item">
  <a href="#variant-1-drop-support-for-nodejs-44x-and-500-59x" class="md-nav__link">
    Variant 1: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.
        ...
        <li class="md-nav__item">
  <a href="#variant-2-use-a-polyfill" class="md-nav__link">
    Variant 2: Use a polyfill
        ...
        <li class="md-nav__item">
  <a href="#variant-3-manual-detection-with-safeguards" class="md-nav__link">
    Variant 3 — manual detection, with safeguards
  </a>
  
    <nav class="md-nav" aria-label="Variant 3 — manual detection, with safeguards">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#buffer0" class="md-nav__link">
    Buffer(0)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#buffernotnumber" class="md-nav__link">
    Buffer(notNumber)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#buffernumber" class="md-nav__link">
    Buffer(number)
  </a>
        ...
        <li class="md-nav__item">
  <a href="#regarding-bufferallocunsafe" class="md-nav__link">
  ...
  <a href="#faq" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="FAQ">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#what-is-wrong-with-the-buffer-constructor" class="md-nav__link">
    What is wrong with the Buffer constructor?
          ...
          <li class="md-nav__item">
  <a href="#the-buffer-constructor-has-been-deprecated-for-a-while-is-this-really-an-issue" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/safer-buffer/Porting-Buffer.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="porting-to-the-bufferfrombufferalloc-api">Porting to the Buffer.from/Buffer.alloc API<a class="headerlink" href="#porting-to-the-bufferfrombufferalloc-api" title="Permanent link">&para;</a></h1>
<p><a id="overview"></a></p>
...
<h3 id="finding-problematic-bits-of-code-using-grep">Finding problematic bits of code using grep<a class="headerlink" href="#finding-problematic-bits-of-code-using-grep" title="Permanent link">&para;</a></h3>
...
exceptions).</p>
<h3 id="finding-problematic-bits-of-code-using-nodejs-8">Finding problematic bits of code using Node.js 8<a class="headerlink" href="#finding-problematic-bits-of-code-using-nodejs-8" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="gp">$ </span><span class="nb">export</span><span class="w"> </span><span class="nv">NODE_OPTIONS</span><span class="o">=</span><span class="s1">&#39;--trace-warnings --pending-deprecation&#39;</span>
<span class="gp">$ </span>cat<span class="w"> </span>example.js
<span class="go">&#39;use strict&#39;;</span>
<span class="go">const foo = new Buffer(&#39;foo&#39;);</span>
<span class="gp">$ </span>node<span class="w"> </span>example.js
...
<h3 id="finding-problematic-bits-of-code-using-linters">Finding problematic bits of code using linters<a class="headerlink" href="#finding-problematic-bits-of-code-using-linters" title="Permanent link">&para;</a></h3>
...
<h2 id="variant-1-drop-support-for-nodejs-44x-and-500-59x">Variant 1: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.<a class="headerlink" href="#variant-1-drop-support-for-nodejs-44x-and-500-59x" title="Permanent link">&para;</a></h2>
...
<h2 id="variant-2-use-a-polyfill">Variant 2: Use a polyfill<a class="headerlink" href="#variant-2-use-a-polyfill" title="Permanent link">&para;</a></h2>
...
<h2 id="variant-3-manual-detection-with-safeguards">Variant 3 — manual detection, with safeguards<a class="headerlink" href="#variant-3-manual-detection-with-safeguards" title="Permanent link">&para;</a></h2>
<p>This is useful if you create Buffer instances in only a few places (e.g. one), or you have your own
wrapper around them.</p>
<h3 id="buffer0">Buffer(0)<a class="headerlink" href="#buffer0" title="Permanent link">&para;</a></h3>
...
<h3 id="buffernotnumber">Buffer(notNumber)<a class="headerlink" href="#buffernotnumber" title="Permanent link">&para;</a></h3>
<p>Before:</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">(</span><span class="nx">notNumber</span><span class="p">,</span><span class="w"> </span><span class="nx">encoding</span><span class="p">);</span>
</code></pre></div>
<p>After:</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">buf</span><span class="p">;</span>
<span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="w"> </span><span class="o">&amp;&amp;</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="w"> </span><span class="o">!==</span><span class="w"> </span><span class="nb">Uint8Array</span><span class="p">.</span><span class="kr">from</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="nx">notNumber</span><span class="p">,</span><span class="w"> </span><span class="nx">encoding</span><span class="p">);</span>
<span class="p">}</span><span class="w"> </span><span class="k">else</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="ow">typeof</span><span class="w"> </span><span class="nx">notNumber</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="s1">&#39;number&#39;</span><span class="p">)</span>
<span class="w">    </span><span class="k">throw</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="ne">Error</span><span class="p">(</span><span class="s1">&#39;The &quot;size&quot; argument must be of type number.&#39;</span><span class="p">);</span>
<span class="w">  </span><span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">(</span><span class="nx">notNumber</span><span class="p">,</span><span class="w"> </span><span class="nx">encoding</span><span class="p">);</span>
<span class="p">}</span>
</code></pre></div>
...
compiles to.</p>
<h3 id="buffernumber">Buffer(number)<a class="headerlink" href="#buffernumber" title="Permanent link">&para;</a></h3>
<p>For Node.js 0.10.x (and below) support:</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">buf</span><span class="p">;</span>
<span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="p">(</span><span class="nx">number</span><span class="p">);</span>
<span class="p">}</span><span class="w"> </span><span class="k">else</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">(</span><span class="nx">number</span><span class="p">);</span>
<span class="w">  </span><span class="nx">buf</span><span class="p">.</span><span class="nx">fill</span><span class="p">(</span><span class="mf">0</span><span class="p">);</span>
<span class="p">}</span>
</code></pre></div>
<p>Otherwise (Node.js ≥ 0.12.x):</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="w"> </span><span class="o">?</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="p">(</span><span class="nx">number</span><span class="p">)</span><span class="w"> </span><span class="o">:</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">(</span><span class="nx">number</span><span class="p">).</span><span class="nx">fill</span><span class="p">(</span><span class="mf">0</span><span class="p">);</span>
</code></pre></div>
<h2 id="regarding-bufferallocunsafe">Regarding Buffer.allocUnsafe<a class="headerlink" href="#regarding-bufferallocunsafe" title="Permanent link">&para;</a></h2>
<p>Be extra cautious when using <code>Buffer.allocUnsafe</code>:
 * Don't use it if you don't have a good reason to
   * e.g. you probably won't ever see a performance difference for small buffers, in fact, those
     might be even faster with <code>Buffer.alloc()</code>,
   * if your code is not in the hot code path — you also probably won't notice a difference,
   * keep in mind that zero-filling minimizes the potential risks.
 * If you use it, make sure that you never return the buffer in a partially-filled state,
   * if you are writing to it sequentially — always truncate it to the actuall written length</p>
...
<h3 id="what-is-wrong-with-the-buffer-constructor">What is wrong with the <code>Buffer</code> constructor?<a class="headerlink" href="#what-is-wrong-with-the-buffer-constructor" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code>function stringToBase64(req, res) {
...
<li>If <code>req.body.string</code> is the <em>number</em> <code>50</code>, the <code>rawBytes</code> would be 50 bytes:</li>
...
<h3 id="the-buffer-constructor-has-been-deprecated-for-a-while-is-this-really-an-issue">The <code>Buffer()</code> constructor has been deprecated for a while. Is this really an issue?<a class="headerlink" href="#the-buffer-constructor-has-been-deprecated-for-a-while-is-this-really-an-issue" title="Permanent link">&para;</a></h3>
