...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/uri-js/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>URI.js - Kubernetes 进阶训练营</title>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#resolving" class="md-nav__link">
    Resolving
          ...
          <li class="md-nav__item">
  <a href="#normalizing" class="md-nav__link">
    Normalizing
  </a>
  ...
  <a href="#comparison" class="md-nav__link">
    Comparison
          ...
          <li class="md-nav__item">
  <a href="#ip-support" class="md-nav__link">
    IP Support
  </a>
          ...
          <li class="md-nav__item">
  <a href="#iri-support" class="md-nav__link">
    IRI Support
  </a>
  ...
  <a href="#options" class="md-nav__link">
    Options
        ...
        <li class="md-nav__item">
  <a href="#scheme-extendable" class="md-nav__link">
    Scheme Extendable
  </a>
  
    <nav class="md-nav" aria-label="Scheme Extendable">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#httphttps-support" class="md-nav__link">
    HTTP/HTTPS Support
  </a>
          ...
          <li class="md-nav__item">
  <a href="#wswss-support" class="md-nav__link">
    WS/WSS Support
  </a>
          ...
          <li class="md-nav__item">
  <a href="#mailto-support" class="md-nav__link">
    Mailto Support
  </a>
          ...
          <li class="md-nav__item">
  <a href="#urn-support" class="md-nav__link">
    URN Support
  </a>
  
    <nav class="md-nav" aria-label="URN Support">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#urn-uuid-support" class="md-nav__link">
    URN UUID Support
  </a>
  ...
  <a href="#breaking-changes" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Breaking changes">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#breaking-changes-from-3x" class="md-nav__link">
    Breaking changes from 3.x
          ...
          <li class="md-nav__item">
  <a href="#breaking-changes-from-2x" class="md-nav__link">
    Breaking changes from 2.x
          ...
          <li class="md-nav__item">
  <a href="#breaking-changes-from-1x" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/uri-js/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="urijs">URI.js<a class="headerlink" href="#urijs" title="Permanent link">&para;</a></h1>
<p>URI.js is an <a href="http://www.ietf.org/rfc/rfc3986.txt">RFC 3986</a> compliant, scheme extendable URI parsing/validating/resolving library for all JavaScript environments (browsers, Node.js, etc).
It is also compliant with the IRI (<a href="http://www.ietf.org/rfc/rfc3987.txt">RFC 3987</a>), IDNA (<a href="http://www.ietf.org/rfc/rfc5890.txt">RFC 5890</a>), IPv6 Address (<a href="http://www.ietf.org/rfc/rfc5952.txt">RFC 5952</a>), IPv6 Zone Identifier (<a href="http://www.ietf.org/rfc/rfc6874.txt">RFC 6874</a>) specifications.</p>
...
<div class="highlight"><pre><span></span><code>URI.parse(&quot;uri://user:pass@example.com:123/one/two.three?q1=a1&amp;q2=a2#body&quot;);
//returns:
//{
//  scheme : &quot;uri&quot;,
//  userinfo : &quot;user:pass&quot;,
...
<h3 id="serializing">Serializing<a class="headerlink" href="#serializing" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>URI.serialize({scheme : &quot;http&quot;, host : &quot;example.com&quot;, fragment : &quot;footer&quot;}) === &quot;http://example.com/#footer&quot;
</code></pre></div>
<h3 id="resolving">Resolving<a class="headerlink" href="#resolving" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>URI.resolve(&quot;uri://a/b/c/d?q&quot;, &quot;../../g&quot;) === &quot;uri://a/g&quot;
</code></pre></div>
<h3 id="normalizing">Normalizing<a class="headerlink" href="#normalizing" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>URI.normalize(&quot;HTTP://ABC.com:80/%7Esmith/home.html&quot;) === &quot;http://abc.com/~smith/home.html&quot;
</code></pre></div>
<h3 id="comparison">Comparison<a class="headerlink" href="#comparison" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>URI.equal(&quot;example://a/b/c/%7Bfoo%7D&quot;, &quot;eXAMPLE://a/./b/../b/%63/%7bfoo%7d&quot;) === true
</code></pre></div>
<h3 id="ip-support">IP Support<a class="headerlink" href="#ip-support" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>//IPv4 normalization
...
<h3 id="iri-support">IRI Support<a class="headerlink" href="#iri-support" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>//convert IRI to URI
...
<ul>
<li>
<p><code>scheme</code> (string)</p>
<p>Indicates the scheme that the URI should be treated as, overriding the URI's normal scheme parsing behavior.</p>
</li>
<li>
<p><code>reference</code> (string)</p>
<p>If set to <code>"suffix"</code>, it indicates that the URI is in the suffix format, and the validator will use the option's <code>scheme</code> property to determine the URI's scheme.</p>
</li>
<li>
<p><code>tolerant</code> (boolean, false)</p>
<p>If set to <code>true</code>, the parser will relax URI resolving rules.</p>
</li>
<li>
<p><code>absolutePath</code> (boolean, false)</p>
<p>If set to <code>true</code>, the serializer will not resolve a relative <code>path</code> component.</p>
</li>
<li>
<p><code>iri</code> (boolean, false)</p>
<p>If set to <code>true</code>, the serializer will unescape non-ASCII characters as per <a href="http://www.ietf.org/rfc/rfc3987.txt">RFC 3987</a>.</p>
</li>
<li>
<p><code>unicodeSupport</code> (boolean, false)</p>
<p>If set to <code>true</code>, the parser will unescape non-ASCII characters in the parsed output as per <a href="http://www.ietf.org/rfc/rfc3987.txt">RFC 3987</a>.</p>
</li>
<li>
<p><code>domainHost</code> (boolean, false)</p>
<p>If set to <code>true</code>, the library will treat the <code>host</code> component as a domain name, and convert IDNs (International Domain Names) as per <a href="http://www.ietf.org/rfc/rfc5891.txt">RFC 5891</a>.</p>
</li>
</ul>
<h2 id="scheme-extendable">Scheme Extendable<a class="headerlink" href="#scheme-extendable" title="Permanent link">&para;</a></h2>
...
<h3 id="httphttps-support">HTTP/HTTPS Support<a class="headerlink" href="#httphttps-support" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>URI.equal(&quot;HTTP://ABC.COM:80&quot;, &quot;http://abc.com/&quot;) === true
URI.equal(&quot;https://abc.com&quot;, &quot;HTTPS://ABC.COM:443/&quot;) === true
</code></pre></div>
<h3 id="wswss-support">WS/WSS Support<a class="headerlink" href="#wswss-support" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>URI.parse(&quot;wss://example.com/foo?bar=baz&quot;);
//returns:
//{
//  scheme : &quot;wss&quot;,
//  host: &quot;example.com&quot;,
...
<h3 id="mailto-support">Mailto Support<a class="headerlink" href="#mailto-support" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>URI.parse(&quot;mailto:alpha@example.com,bravo@example.com?subject=SUBSCRIBE&amp;body=Sign%20me%20up!&quot;);
//returns:
//{
//  scheme : &quot;mailto&quot;,
...
<h3 id="urn-support">URN Support<a class="headerlink" href="#urn-support" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>URI.parse(&quot;urn:example:foo&quot;);
//returns:
//{
//  scheme : &quot;urn&quot;,
//  nid : &quot;example&quot;,
...
<h4 id="urn-uuid-support">URN UUID Support<a class="headerlink" href="#urn-uuid-support" title="Permanent link">&para;</a></h4>
<div class="highlight"><pre><span></span><code>URI.parse(&quot;urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6&quot;);
//returns:
//{
//  scheme : &quot;urn&quot;,
//  nid : &quot;uuid&quot;,
...
<p>To load in a browser, use the following tag:</p>
<div class="highlight"><pre><span></span><code>&lt;script type=&quot;text/javascript&quot; src=&quot;uri-js/dist/es5/uri.all.min.js&quot;&gt;&lt;/script&gt;
</code></pre></div>
<p>To load in a CommonJS/Module environment, first install with npm/yarn by running on the command line:</p>
<div class="highlight"><pre><span></span><code>npm install uri-js
# OR
yarn add uri-js
</code></pre></div>
<p>Then, in your code, load it using:</p>
<div class="highlight"><pre><span></span><code>const URI = require(&quot;uri-js&quot;);
</code></pre></div>
<p>If you are writing your code in ES6+ (ESNEXT) or TypeScript, you would load it using:</p>
<div class="highlight"><pre><span></span><code>import * as URI from &quot;uri-js&quot;;
</code></pre></div>
<p>Or you can load just what you need using named exports:</p>
<div class="highlight"><pre><span></span><code>import { parse, serialize, resolve, resolveComponents, normalize, equal, removeDotSegments, pctEncChar, pctDecChars, escapeComponent, unescapeComponent } from &quot;uri-js&quot;;
</code></pre></div>
<h2 id="breaking-changes">Breaking changes<a class="headerlink" href="#breaking-changes" title="Permanent link">&para;</a></h2>
<h3 id="breaking-changes-from-3x">Breaking changes from 3.x<a class="headerlink" href="#breaking-changes-from-3x" title="Permanent link">&para;</a></h3>
...
<h3 id="breaking-changes-from-2x">Breaking changes from 2.x<a class="headerlink" href="#breaking-changes-from-2x" title="Permanent link">&para;</a></h3>
<p>URI validation has been removed as it was slow, exposed a vulnerabilty, and was generally not useful.</p>
<h3 id="breaking-changes-from-1x">Breaking changes from 1.x<a class="headerlink" href="#breaking-changes-from-1x" title="Permanent link">&para;</a></h3>
