...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/mime/">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#mimegettypepathorextension" class="md-nav__link">
    mime.getType(pathOrExtension)
          ...
          <li class="md-nav__item">
  <a href="#mimegetextensiontype" class="md-nav__link">
    mime.getExtension(type)
          ...
          <li class="md-nav__item">
  <a href="#mimegetallextensionstype" class="md-nav__link">
    mime.getAllExtensions(type)
          ...
          <li class="md-nav__item">
  <a href="#mimedefinetype-map-force-false" class="md-nav__link">
  ...
  <a href="#command-line" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Command Line">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#extension-type" class="md-nav__link">
    Extension -&gt; type
  </a>
          ...
          <li class="md-nav__item">
  <a href="#type-extension" class="md-nav__link">
    Type -&gt; extension
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/mime/README.md" title="编辑此页" class="md-content__button md-icon">
...
<!--
  ...
  -->
<h1 id="mime">Mime<a class="headerlink" href="#mime" title="Permanent link">&para;</a></h1>
<p><a href="https://www.npmjs.com/package/mime"><img alt="NPM downloads" src="https://img.shields.io/npm/dm/mime" /></a>
<a href="https://github.com/broofa/mime/actions/workflows/ci.yml?query=branch%3Amain"><img alt="Mime CI" src="https://github.com/broofa/mime/actions/workflows/ci.yml/badge.svg?branch=main" /></a></p>
<p>An API for MIME type information.</p>
<ul>
<li>All <code>mime-db</code> types</li>
<li>Compact and dependency-free <a href="https://bundlejs.com/?q=mime"><img alt="mime's badge" src="https://deno.bundlejs.com/?q=mime&amp;badge" /></a></li>
<li>Full TS support</li>
</ul>
<blockquote>
<p>[!Note]
<code>mime@4</code> is now <code>latest</code>.  If you're upgrading from <code>mime@3</code>, note the following:
* <code>mime@4</code> is API-compatible with <code>mime@3</code>, with <del>one</del> two exceptions:
  * Direct imports of <code>mime</code> properties <a href="https://github.com/broofa/mime/issues/295">no longer supported</a>
  * <code>mime.define()</code> cannot be called on the default <code>mime</code> object
* ESM module support is required.   <a href="https://gist.github.com/sindresorhus/a39789f98801d908bbc7ff3ecc99d99c">ESM Module FAQ</a>.
* Requires an <a href="https://caniuse.com/?search=es2020">ES2020</a> or newer runtime
* Built-in Typescript types (<code>@types/mime</code> no longer needed)</p>
</blockquote>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>mime
</code></pre></div>
<h2 id="quick-start">Quick Start<a class="headerlink" href="#quick-start" title="Permanent link">&para;</a></h2>
<p>For the full version (800+ MIME types, 1,000+ extensions):</p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">mime</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;mime&#39;</span><span class="p">;</span>

<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;txt&#39;</span><span class="p">);</span><span class="w">                    </span><span class="c1">// ⇨ &#39;text/plain&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getExtension</span><span class="p">(</span><span class="s1">&#39;text/plain&#39;</span><span class="p">);</span><span class="w">        </span><span class="c1">// ⇨ &#39;txt&#39;</span>
</code></pre></div>
<h3 id="lite-version">Lite Version <a href="https://bundlejs.com/?q=mime/lite"><img alt="mime/lite's badge" src="https://deno.bundlejs.com/?q=mime/lite&amp;badge" /></a><a class="headerlink" href="#lite-version" title="Permanent link">&para;</a></h3>
<p><code>mime/lite</code> is a drop-in <code>mime</code> replacement, stripped of unofficial ("<code>prs.*</code>", "<code>x-*</code>", "<code>vnd.*</code>") types:</p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">mime</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;mime/lite&#39;</span><span class="p">;</span>
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<h3 id="mimegettypepathorextension"><code>mime.getType(pathOrExtension)</code><a class="headerlink" href="#mimegettypepathorextension" title="Permanent link">&para;</a></h3>
<p>Get mime type for the given file path or extension. E.g.</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;js&#39;</span><span class="p">);</span><span class="w">             </span><span class="c1">// ⇨ &#39;text/javascript&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;json&#39;</span><span class="p">);</span><span class="w">           </span><span class="c1">// ⇨ &#39;application/json&#39;</span>

<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;txt&#39;</span><span class="p">);</span><span class="w">            </span><span class="c1">// ⇨ &#39;text/plain&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;dir/text.txt&#39;</span><span class="p">);</span><span class="w">   </span><span class="c1">// ⇨ &#39;text/plain&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;dir\\text.txt&#39;</span><span class="p">);</span><span class="w">  </span><span class="c1">// ⇨ &#39;text/plain&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;.text.txt&#39;</span><span class="p">);</span><span class="w">      </span><span class="c1">// ⇨ &#39;text/plain&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;.txt&#39;</span><span class="p">);</span><span class="w">           </span><span class="c1">// ⇨ &#39;text/plain&#39;</span>
</code></pre></div>
<p><code>null</code> is returned in cases where an extension is not detected or recognized</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;foo/txt&#39;</span><span class="p">);</span><span class="w">        </span><span class="c1">// ⇨ null</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;bogus_type&#39;</span><span class="p">);</span><span class="w">     </span><span class="c1">// ⇨ null</span>
</code></pre></div>
<h3 id="mimegetextensiontype"><code>mime.getExtension(type)</code><a class="headerlink" href="#mimegetextensiontype" title="Permanent link">&para;</a></h3>
<p>Get file extension for the given mime type. Charset options (often included in Content-Type headers) are ignored.</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">getExtension</span><span class="p">(</span><span class="s1">&#39;text/plain&#39;</span><span class="p">);</span><span class="w">               </span><span class="c1">// ⇨ &#39;txt&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getExtension</span><span class="p">(</span><span class="s1">&#39;application/json&#39;</span><span class="p">);</span><span class="w">         </span><span class="c1">// ⇨ &#39;json&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getExtension</span><span class="p">(</span><span class="s1">&#39;text/html; charset=utf8&#39;</span><span class="p">);</span><span class="w">  </span><span class="c1">// ⇨ &#39;html&#39;</span>
</code></pre></div>
<h3 id="mimegetallextensionstype"><code>mime.getAllExtensions(type)</code><a class="headerlink" href="#mimegetallextensionstype" title="Permanent link">&para;</a></h3>
<blockquote>
<p>[!Note]
New in <code>mime@4</code></p>
</blockquote>
<p>Get all file extensions for the given mime type.</p>
<p>```javascript --run default
mime.getAllExtensions('image/jpeg'); // ⇨ Set(3) { 'jpeg', 'jpg', 'jpe' }
<div class="highlight"><pre><span></span><code>## Custom `Mime` instances
...
<p>Each argument is passed to the <code>define()</code> method, below. For example <code>new Mime(standardTypes, otherTypes)</code> is synonomous with <code>new Mime().define(standardTypes).define(otherTypes)</code></p>
<h3 id="mimedefinetype-map-force-false"><code>mime.define(type map [, force = false])</code><a class="headerlink" href="#mimedefinetype-map-force-false" title="Permanent link">&para;</a></h3>
<blockquote>
<p>[!Note]
Only available on custom <code>Mime</code> instances</p>
</blockquote>
<p>Define MIME type -&gt; extensions.</p>
<p>Attempting to map a type to an already-defined extension will <code>throw</code> unless the <code>force</code> argument is set to <code>true</code>.</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">define</span><span class="p">({</span><span class="s1">&#39;text/x-abc&#39;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;abc&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;abcd&#39;</span><span class="p">]});</span>

<span class="nx">mime</span><span class="p">.</span><span class="nx">getType</span><span class="p">(</span><span class="s1">&#39;abcd&#39;</span><span class="p">);</span><span class="w">            </span><span class="c1">// ⇨ &#39;text/x-abc&#39;</span>
<span class="nx">mime</span><span class="p">.</span><span class="nx">getExtension</span><span class="p">(</span><span class="s1">&#39;text/x-abc&#39;</span><span class="p">)</span><span class="w">  </span><span class="c1">// ⇨ &#39;abc&#39;</span>
</code></pre></div>
<h2 id="command-line">Command Line<a class="headerlink" href="#command-line" title="Permanent link">&para;</a></h2>
<h3 id="extension-type">Extension -&gt; type<a class="headerlink" href="#extension-type" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>mime<span class="w"> </span>scripts/jquery.js
text/javascript
</code></pre></div>
<h3 id="type-extension">Type -&gt; extension<a class="headerlink" href="#type-extension" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>mime<span class="w"> </span>-r<span class="w"> </span>image/jpeg
jpeg
</code></pre></div>
