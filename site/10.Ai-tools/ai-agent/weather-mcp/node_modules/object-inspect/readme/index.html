...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/object-inspect/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>object-inspect Version Badge - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#object-inspect" class="md-skip">
          跳转至
        </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/object-inspect/readme.markdown" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="object-inspect">object-inspect <sup><a href="https://npmjs.org/package/object-inspect"><img alt="Version Badge" src="https://versionbadg.es/inspect-js/object-inspect.svg" /></a></sup><a class="headerlink" href="#object-inspect" title="Permanent link">&para;</a></h1>
<p>string representations of objects in node and the browser</p>
<p><a href="https://github.com/inspect-js/object-inspect/actions"><img alt="github actions" src="https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/inspect-js/object-inspect" /></a>
<a href="https://app.codecov.io/gh/inspect-js/object-inspect/"><img alt="coverage" src="https://codecov.io/gh/inspect-js/object-inspect/branch/main/graphs/badge.svg" /></a>
<a href="../LICENSE"><img alt="License" src="https://img.shields.io/npm/l/object-inspect.svg" /></a>
<a href="https://npm-stat.com/charts.html?package=object-inspect"><img alt="Downloads" src="https://img.shields.io/npm/dm/object-inspect.svg" /></a></p>
<p><a href="https://npmjs.org/package/object-inspect"><img alt="npm badge" src="https://nodei.co/npm/object-inspect.png?downloads=true&amp;stars=true" /></a></p>
<h1 id="example">example<a class="headerlink" href="#example" title="Permanent link">&para;</a></h1>
<h2 id="circular">circular<a class="headerlink" href="#circular" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">inspect</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;object-inspect&#39;</span><span class="p">);</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">obj</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">a</span><span class="o">:</span><span class="w"> </span><span class="mf">1</span><span class="p">,</span><span class="w"> </span><span class="nx">b</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="mf">3</span><span class="p">,</span><span class="mf">4</span><span class="p">]</span><span class="w"> </span><span class="p">};</span>
<span class="nx">obj</span><span class="p">.</span><span class="nx">c</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">obj</span><span class="p">;</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">inspect</span><span class="p">(</span><span class="nx">obj</span><span class="p">));</span>
</code></pre></div>
<h2 id="dom-element">dom element<a class="headerlink" href="#dom-element" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">inspect</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;object-inspect&#39;</span><span class="p">);</span>

<span class="kd">var</span><span class="w"> </span><span class="nx">d</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nb">document</span><span class="p">.</span><span class="nx">createElement</span><span class="p">(</span><span class="s1">&#39;div&#39;</span><span class="p">);</span>
<span class="nx">d</span><span class="p">.</span><span class="nx">setAttribute</span><span class="p">(</span><span class="s1">&#39;id&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;beep&#39;</span><span class="p">);</span>
<span class="nx">d</span><span class="p">.</span><span class="nx">innerHTML</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;&lt;b&gt;wooo&lt;/b&gt;&lt;i&gt;iiiii&lt;/i&gt;&#39;</span><span class="p">;</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">inspect</span><span class="p">([</span><span class="w"> </span><span class="nx">d</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">a</span><span class="o">:</span><span class="w"> </span><span class="mf">3</span><span class="p">,</span><span class="w"> </span><span class="nx">b</span><span class="w"> </span><span class="o">:</span><span class="w"> </span><span class="mf">4</span><span class="p">,</span><span class="w"> </span><span class="nx">c</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="mf">5</span><span class="p">,</span><span class="mf">6</span><span class="p">,[</span><span class="mf">7</span><span class="p">,[</span><span class="mf">8</span><span class="p">,[</span><span class="mf">9</span><span class="p">]]]]</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="p">]));</span>
</code></pre></div>
<p>output:</p>
<div class="highlight"><pre><span></span><code>[ &lt;div id=&quot;beep&quot;&gt;...&lt;/div&gt;, { a: 3, b: 4, c: [ 5, 6, [ 7, [ 8, [ ... ] ] ] ] } ]
</code></pre></div>
<h1 id="methods">methods<a class="headerlink" href="#methods" title="Permanent link">&para;</a></h1>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">inspect</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;object-inspect&#39;</span><span class="p">)</span>
</code></pre></div>
<h2 id="var-s-inspectobj-opts">var s = inspect(obj, opts={})<a class="headerlink" href="#var-s-inspectobj-opts" title="Permanent link">&para;</a></h2>
<p>Return a string <code>s</code> with the string representation of <code>obj</code> up to a depth of <code>opts.depth</code>.</p>
<p>Additional options:
  - <code>quoteStyle</code>: must be "single" or "double", if present. Default <code>'single'</code> for strings, <code>'double'</code> for HTML elements.
  - <code>maxStringLength</code>: must be <code>0</code>, a positive integer, <code>Infinity</code>, or <code>null</code>, if present. Default <code>Infinity</code>.
  - <code>customInspect</code>: When <code>true</code>, a custom inspect method function will be invoked (either undere the <code>util.inspect.custom</code> symbol, or the <code>inspect</code> property). When the string <code>'symbol'</code>, only the symbol method will be invoked. Default <code>true</code>.
  - <code>indent</code>: must be "\t", <code>null</code>, or a positive integer. Default <code>null</code>.
  - <code>numericSeparator</code>: must be a boolean, if present. Default <code>false</code>. If <code>true</code>, all numbers will be printed with numeric separators (eg, <code>1234.5678</code> will be printed as <code>'1_234.567_8'</code>)</p>
...
<div class="highlight"><pre><span></span><code>npm install object-inspect
</code></pre></div>
