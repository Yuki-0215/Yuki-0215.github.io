...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/proxy-addr/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>proxy-addr - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#proxy-addr" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#proxyaddrreq-trust" class="md-nav__link">
    proxyaddr(req, trust)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#proxyaddrallreq-trust" class="md-nav__link">
    proxyaddr.all(req, [trust])
          ...
          <li class="md-nav__item">
  <a href="#proxyaddrcompileval" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/proxy-addr/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="proxy-addr">proxy-addr<a class="headerlink" href="#proxy-addr" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/proxy-addr"><img alt="NPM Version" src="https://badgen.net/npm/v/proxy-addr" /></a>
<a href="https://npmjs.org/package/proxy-addr"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/proxy-addr" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/proxy-addr" /></a>
<a href="https://github.com/jshttp/proxy-addr/actions?query=workflow%3Aci"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/proxy-addr/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/proxy-addr?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/jshttp/proxy-addr/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>proxy-addr
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">proxyaddr</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;proxy-addr&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="proxyaddrreq-trust">proxyaddr(req, trust)<a class="headerlink" href="#proxyaddrreq-trust" title="Permanent link">&para;</a></h3>
...
returned.</p>
<div class="highlight"><pre><span></span><code><span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">addr</span><span class="p">)</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="k">return</span><span class="w"> </span><span class="nx">addr</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="s1">&#39;127.0.0.1&#39;</span><span class="w"> </span><span class="p">})</span>
<span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">addr</span><span class="p">,</span><span class="w"> </span><span class="nx">i</span><span class="p">)</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="k">return</span><span class="w"> </span><span class="nx">i</span><span class="w"> </span><span class="o">&lt;</span><span class="w"> </span><span class="mf">1</span><span class="w"> </span><span class="p">})</span>
</code></pre></div>
<p>The <code>trust</code> arugment may also be a single IP address string or an
array of trusted addresses, as plain IP addresses, CIDR-formatted
strings, or IP/netmask strings.</p>
<div class="highlight"><pre><span></span><code><span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;127.0.0.1&#39;</span><span class="p">)</span>
<span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;127.0.0.0/8&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;10.0.0.0/8&#39;</span><span class="p">])</span>
<span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;127.0.0.0/255.0.0.0&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;192.168.0.0/255.255.0.0&#39;</span><span class="p">])</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;::1&#39;</span><span class="p">)</span>
<span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;::1/128&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;fe80::/10&#39;</span><span class="p">])</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;loopback&#39;</span><span class="p">)</span>
<span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;loopback&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;fc00:ac:1ab5:fff::1/64&#39;</span><span class="p">])</span>
</code></pre></div>
<ul>
...
<h3 id="proxyaddrallreq-trust">proxyaddr.all(req, [trust])<a class="headerlink" href="#proxyaddrallreq-trust" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="nx">proxyaddr</span><span class="p">.</span><span class="nx">all</span><span class="p">(</span><span class="nx">req</span><span class="p">)</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">proxyaddr</span><span class="p">.</span><span class="nx">all</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;loopback&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="proxyaddrcompileval">proxyaddr.compile(val)<a class="headerlink" href="#proxyaddrcompileval" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">trust</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">proxyaddr</span><span class="p">.</span><span class="nx">compile</span><span class="p">(</span><span class="s1">&#39;loopback&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">addr</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">proxyaddr</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">trust</span><span class="p">)</span>
</code></pre></div>
