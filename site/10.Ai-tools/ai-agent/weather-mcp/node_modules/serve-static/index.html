...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/serve-static/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>serve-static - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#serve-static" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#servestaticroot-options" class="md-nav__link">
    serveStatic(root, options)
  </a>
  
    <nav class="md-nav" aria-label="serveStatic(root, options)">
      <ul class="md-nav__list">
  ...
  <a href="#extensions" class="md-nav__link">
    extensions
          ...
          <li class="md-nav__item">
  <a href="#fallthrough" class="md-nav__link">
    fallthrough
  </a>
  ...
  <a href="#redirect" class="md-nav__link">
    redirect
          ...
          <li class="md-nav__item">
  <a href="#setheaders" class="md-nav__link">
    setHeaders
  </a>
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#serve-files-with-vanilla-nodejs-http-server" class="md-nav__link">
    Serve files with vanilla node.js http server
          ...
          <li class="md-nav__item">
  <a href="#serve-all-files-as-downloads" class="md-nav__link">
    Serve all files as downloads
          ...
          <li class="md-nav__item">
  <a href="#serving-using-express" class="md-nav__link">
    Serving using express
  </a>
  
    <nav class="md-nav" aria-label="Serving using express">
      <ul class="md-nav__list">
  ...
  <a href="#simple" class="md-nav__link">
    Simple
          ...
          <li class="md-nav__item">
  <a href="#multiple-roots" class="md-nav__link">
    Multiple roots
  </a>
          ...
          <li class="md-nav__item">
  <a href="#different-settings-for-paths" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/serve-static/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="serve-static">serve-static<a class="headerlink" href="#serve-static" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/serve-static"><img alt="NPM Version" src="https://badgen.net/npm/v/serve-static" /></a>
<a href="https://npmjs.org/package/serve-static"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/serve-static" /></a>
<a href="https://github.com/expressjs/serve-static/actions/workflows/ci.yml"><img alt="CI" src="https://badgen.net/github/checks/expressjs/serve-static/master?label=linux" /></a>
<a href="https://coveralls.io/r/expressjs/serve-static?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/expressjs/serve-static/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>serve-static
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">serveStatic</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;serve-static&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="servestaticroot-options">serveStatic(root, options)<a class="headerlink" href="#servestaticroot-options" title="Permanent link">&para;</a></h3>
...
<h5 id="fallthrough">fallthrough<a class="headerlink" href="#fallthrough" title="Permanent link">&para;</a></h5>
...
<h5 id="setheaders">setHeaders<a class="headerlink" href="#setheaders" title="Permanent link">&para;</a></h5>
...
<h3 id="serve-files-with-vanilla-nodejs-http-server">Serve files with vanilla node.js http server<a class="headerlink" href="#serve-files-with-vanilla-nodejs-http-server" title="Permanent link">&para;</a></h3>
...
<h3 id="serve-all-files-as-downloads">Serve all files as downloads<a class="headerlink" href="#serve-all-files-as-downloads" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">contentDisposition</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;content-disposition&#39;</span><span class="p">)</span>
...
<h3 id="serving-using-express">Serving using express<a class="headerlink" href="#serving-using-express" title="Permanent link">&para;</a></h3>
<h4 id="simple">Simple<a class="headerlink" href="#simple" title="Permanent link">&para;</a></h4>
...
<h4 id="multiple-roots">Multiple roots<a class="headerlink" href="#multiple-roots" title="Permanent link">&para;</a></h4>
<p>This example shows a simple way to search through multiple directories.
Files are searched for in <code>public-optimized/</code> first, then <code>public/</code> second
as a fallback.</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">express</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;express&#39;</span><span class="p">)</span>
...
<h4 id="different-settings-for-paths">Different settings for paths<a class="headerlink" href="#different-settings-for-paths" title="Permanent link">&para;</a></h4>
...
<span class="kd">function</span><span class="w"> </span><span class="nx">setCustomCacheControl</span><span class="w"> </span><span class="p">(</span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">file</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">path</span><span class="p">.</span><span class="nx">extname</span><span class="p">(</span><span class="nx">file</span><span class="p">)</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="s1">&#39;.html&#39;</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
