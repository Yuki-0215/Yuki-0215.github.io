...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/statuses/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>statuses - Kubernetes 进阶训练营</title>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#statuscode" class="md-nav__link">
    status(code)
          ...
          <li class="md-nav__item">
  <a href="#statusmsg" class="md-nav__link">
    status(msg)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#statuscodes" class="md-nav__link">
    status.codes
  </a>
          ...
          <li class="md-nav__item">
  <a href="#statuscodemsg" class="md-nav__link">
    status.code[msg]
  </a>
          ...
          <li class="md-nav__item">
  <a href="#statusemptycode" class="md-nav__link">
    status.empty[code]
  </a>
          ...
          <li class="md-nav__item">
  <a href="#statusmessagecode" class="md-nav__link">
    status.message[code]
  </a>
          ...
          <li class="md-nav__item">
  <a href="#statusredirectcode" class="md-nav__link">
    status.redirect[code]
          ...
          <li class="md-nav__item">
  <a href="#statusretrycode" class="md-nav__link">
    status.retry[code]
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/statuses/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="statuses">statuses<a class="headerlink" href="#statuses" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/statuses"><img alt="NPM Version" src="https://badgen.net/npm/v/statuses" /></a>
<a href="https://npmjs.org/package/statuses"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/statuses" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/statuses" /></a>
<a href="https://github.com/jshttp/statuses/actions?query=workflow%3Aci"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/statuses/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/statuses?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/jshttp/statuses/master" /></a>
<a href="https://kooltheba.github.io/openssf-scorecard-api-visualizer/#/projects/github.com/jshttp/statuses"><img alt="OpenSSF Scorecard Badge" src="https://api.securityscorecards.dev/projects/github.com/jshttp/statuses/badge" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>statuses
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<!-- eslint-disable no-unused-vars -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">status</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;statuses&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="statuscode">status(code)<a class="headerlink" href="#statuscode" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="nx">status</span><span class="p">(</span><span class="mf">403</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; &#39;Forbidden&#39;</span>
...
<h3 id="statusmsg">status(msg)<a class="headerlink" href="#statusmsg" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="nx">status</span><span class="p">(</span><span class="s1">&#39;forbidden&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; 403</span>
...
<h3 id="statuscodes">status.codes<a class="headerlink" href="#statuscodes" title="Permanent link">&para;</a></h3>
<p>Returns an array of all the status codes as <code>Integer</code>s.</p>
<h3 id="statuscodemsg">status.code[msg]<a class="headerlink" href="#statuscodemsg" title="Permanent link">&para;</a></h3>
<p>Returns the numeric status code for a known status message (in lower-case),
otherwise <code>undefined</code>.</p>
<!-- eslint-disable no-undef, no-unused-expressions -->

<div class="highlight"><pre><span></span><code><span class="nx">status</span><span class="p">[</span><span class="s1">&#39;not found&#39;</span><span class="p">]</span><span class="w"> </span><span class="c1">// =&gt; 404</span>
</code></pre></div>
<h3 id="statusemptycode">status.empty[code]<a class="headerlink" href="#statusemptycode" title="Permanent link">&para;</a></h3>
<p>Returns <code>true</code> if a status code expects an empty body.</p>
<!-- eslint-disable no-undef, no-unused-expressions -->

<div class="highlight"><pre><span></span><code><span class="nx">status</span><span class="p">.</span><span class="nx">empty</span><span class="p">[</span><span class="mf">200</span><span class="p">]</span><span class="w"> </span><span class="c1">// =&gt; undefined</span>
...
<h3 id="statusmessagecode">status.message[code]<a class="headerlink" href="#statusmessagecode" title="Permanent link">&para;</a></h3>
<p>Returns the string message for a known numeric status code, otherwise
<code>undefined</code>. This object is the same format as the
<a href="https://nodejs.org/dist/latest/docs/api/http.html#http_http_status_codes">Node.js http module <code>http.STATUS_CODES</code></a>.</p>
<!-- eslint-disable no-undef, no-unused-expressions -->

<div class="highlight"><pre><span></span><code><span class="nx">status</span><span class="p">.</span><span class="nx">message</span><span class="p">[</span><span class="mf">404</span><span class="p">]</span><span class="w"> </span><span class="c1">// =&gt; &#39;Not Found&#39;</span>
</code></pre></div>
<h3 id="statusredirectcode">status.redirect[code]<a class="headerlink" href="#statusredirectcode" title="Permanent link">&para;</a></h3>
<p>Returns <code>true</code> if a status code is a valid redirect status.</p>
<!-- eslint-disable no-undef, no-unused-expressions -->

<div class="highlight"><pre><span></span><code><span class="nx">status</span><span class="p">.</span><span class="nx">redirect</span><span class="p">[</span><span class="mf">200</span><span class="p">]</span><span class="w"> </span><span class="c1">// =&gt; undefined</span>
...
<h3 id="statusretrycode">status.retry[code]<a class="headerlink" href="#statusretrycode" title="Permanent link">&para;</a></h3>
<p>Returns <code>true</code> if you should retry the rest.</p>
<!-- eslint-disable no-undef, no-unused-expressions -->

<div class="highlight"><pre><span></span><code><span class="nx">status</span><span class="p">.</span><span class="nx">retry</span><span class="p">[</span><span class="mf">501</span><span class="p">]</span><span class="w"> </span><span class="c1">// =&gt; undefined</span>
