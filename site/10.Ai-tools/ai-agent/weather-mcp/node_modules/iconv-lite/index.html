...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/iconv-lite/">
    ...
    <div data-md-component="skip">
        ...
        <a href="#iconv-lite-pure-js-character-encoding-conversion" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#iconv-lite-pure-js-character-encoding-conversion" class="md-nav__link">
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Usage">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#basic-api" class="md-nav__link">
    Basic API
  </a>
  ...
  <a href="#streaming-api" class="md-nav__link">
    Streaming API
        ...
        <li class="md-nav__item">
  <a href="#supported-encodings" class="md-nav__link">
    Supported encodings
  </a>
        ...
        <li class="md-nav__item">
  <a href="#encodingdecoding-speed" class="md-nav__link">
    Encoding/decoding speed
        ...
        <li class="md-nav__item">
  <a href="#bom-handling" class="md-nav__link">
    BOM handling
  </a>
        ...
        <li class="md-nav__item">
  <a href="#utf-16-encodings" class="md-nav__link">
    UTF-16 Encodings
  </a>
        ...
        <li class="md-nav__item">
  <a href="#utf-32-encodings" class="md-nav__link">
    UTF-32 Encodings
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/iconv-lite/README.md" title="编辑此页" class="md-content__button md-icon">
...
<h2 id="iconv-lite-pure-js-character-encoding-conversion">iconv-lite: Pure JS character encoding conversion<a class="headerlink" href="#iconv-lite-pure-js-character-encoding-conversion" title="Permanent link">&para;</a></h2>
<ul>
<li>No need for native code compilation. Quick to install, works on Windows and in sandboxed environments like <a href="http://c9.io">Cloud9</a>.</li>
...
<li>Intuitive encode/decode API, including Streaming support.</li>
<li>In-browser usage via <a href="https://github.com/substack/node-browserify">browserify</a> or <a href="https://webpack.js.org/">webpack</a> (~180kb gzip compressed with Buffer shim included).</li>
...
<li>React Native is supported (need to install <code>stream</code> module to enable Streaming API).</li>
<li>License: MIT.</li>
</ul>
<p><a href="https://npmjs.org/package/iconv-lite/"><img alt="NPM Stats" src="https://nodei.co/npm/iconv-lite.png" /></a><br />
<a href="https://travis-ci.org/ashtuchkin/iconv-lite"><img alt="Build Status" src="https://travis-ci.org/ashtuchkin/iconv-lite.svg?branch=master" /></a>
<a href="https://npmjs.org/package/iconv-lite/"><img alt="npm" src="https://img.shields.io/npm/v/iconv-lite.svg" /></a>
<a href="https://npmjs.org/package/iconv-lite/"><img alt="npm downloads" src="https://img.shields.io/npm/dm/iconv-lite.svg" /></a>
<a href="https://npmjs.org/package/iconv-lite/"><img alt="npm bundle size" src="https://img.shields.io/bundlephobia/min/iconv-lite.svg" /></a></p>
<h2 id="usage">Usage<a class="headerlink" href="#usage" title="Permanent link">&para;</a></h2>
<h3 id="basic-api">Basic API<a class="headerlink" href="#basic-api" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">iconv</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;iconv-lite&#39;</span><span class="p">);</span>

<span class="c1">// Convert from an encoded buffer to a js string.</span>
<span class="nx">str</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">iconv</span><span class="p">.</span><span class="nx">decode</span><span class="p">(</span><span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">([</span><span class="mh">0x68</span><span class="p">,</span><span class="w"> </span><span class="mh">0x65</span><span class="p">,</span><span class="w"> </span><span class="mh">0x6c</span><span class="p">,</span><span class="w"> </span><span class="mh">0x6c</span><span class="p">,</span><span class="w"> </span><span class="mh">0x6f</span><span class="p">]),</span><span class="w"> </span><span class="s1">&#39;win1251&#39;</span><span class="p">);</span>

<span class="c1">// Convert from a js string to an encoded buffer.</span>
<span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">iconv</span><span class="p">.</span><span class="nx">encode</span><span class="p">(</span><span class="s2">&quot;Sample input string&quot;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;win1251&#39;</span><span class="p">);</span>
...
<h3 id="streaming-api">Streaming API<a class="headerlink" href="#streaming-api" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="c1">// Decode stream (from binary data stream to js strings)</span>
<span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="kd">var</span><span class="w"> </span><span class="nx">converterStream</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">iconv</span><span class="p">.</span><span class="nx">decodeStream</span><span class="p">(</span><span class="s1">&#39;win1251&#39;</span><span class="p">);</span>
<span class="w">    </span><span class="nx">req</span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">converterStream</span><span class="p">);</span>

<span class="w">    </span><span class="nx">converterStream</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;data&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="p">(</span><span class="nx">str</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">str</span><span class="p">);</span><span class="w"> </span><span class="c1">// Do something with decoded strings, chunk-by-chunk.</span>
...
<span class="w">    </span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">iconv</span><span class="p">.</span><span class="nx">decodeStream</span><span class="p">(</span><span class="s1">&#39;win1251&#39;</span><span class="p">))</span>
<span class="w">    </span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">iconv</span><span class="p">.</span><span class="nx">encodeStream</span><span class="p">(</span><span class="s1">&#39;ucs2&#39;</span><span class="p">))</span>
<span class="w">    </span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">fs</span><span class="p">.</span><span class="nx">createWriteStream</span><span class="p">(</span><span class="s1">&#39;file-in-ucs2.txt&#39;</span><span class="p">));</span>

<span class="c1">// Sugar: all encode/decode streams have .collect(cb) method to accumulate data.</span>
<span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="kd">function</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">req</span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">iconv</span><span class="p">.</span><span class="nx">decodeStream</span><span class="p">(</span><span class="s1">&#39;win1251&#39;</span><span class="p">)).</span><span class="nx">collect</span><span class="p">(</span><span class="kd">function</span><span class="p">(</span><span class="nx">err</span><span class="p">,</span><span class="w"> </span><span class="nx">body</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="nx">assert</span><span class="p">(</span><span class="ow">typeof</span><span class="w"> </span><span class="nx">body</span><span class="w"> </span><span class="o">==</span><span class="w"> </span><span class="s1">&#39;string&#39;</span><span class="p">);</span>
<span class="w">        </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">body</span><span class="p">);</span><span class="w"> </span><span class="c1">// full request body string</span>
<span class="w">    </span><span class="p">});</span>
<span class="p">});</span>
</code></pre></div>
<h2 id="supported-encodings">Supported encodings<a class="headerlink" href="#supported-encodings" title="Permanent link">&para;</a></h2>
<ul>
<li>All node.js native encodings: utf8, ucs2 / utf16-le, ascii, binary, base64, hex.</li>
<li>Additional unicode encodings: utf16, utf16-be, utf-7, utf-7-imap, utf32, utf32-le, and utf32-be.</li>
...
<h2 id="encodingdecoding-speed">Encoding/decoding speed<a class="headerlink" href="#encodingdecoding-speed" title="Permanent link">&para;</a></h2>
...
<div class="highlight"><pre><span></span><code>operation             iconv@2.1.4   iconv-lite@0.4.7
----------------------------------------------------------
encode(&#39;win1251&#39;)     ~96 Mb/s      ~320 Mb/s
decode(&#39;win1251&#39;)     ~95 Mb/s      ~246 Mb/s
</code></pre></div>
<h2 id="bom-handling">BOM handling<a class="headerlink" href="#bom-handling" title="Permanent link">&para;</a></h2>
<ul>
...
<h2 id="utf-16-encodings">UTF-16 Encodings<a class="headerlink" href="#utf-16-encodings" title="Permanent link">&para;</a></h2>
 ...
 * Decoding: uses BOM and 'spaces heuristic' to determine input endianness. Default is UTF-16LE, but can be 
   overridden with <code>defaultEncoding: 'utf-16be'</code> option. Strips BOM unless <code>stripBOM: false</code>.
 * Encoding: uses UTF-16LE and writes BOM by default. Use <code>addBOM: false</code> to override.</p>
<h2 id="utf-32-encodings">UTF-32 Encodings<a class="headerlink" href="#utf-32-encodings" title="Permanent link">&para;</a></h2>
<p>This library supports UTF-32LE, UTF-32BE and UTF-32 encodings. Like the UTF-16 encoding above, UTF-32 defaults to UTF-32LE, but uses BOM and 'spaces heuristics' to determine input endianness. 
 * The default of UTF-32LE can be overridden with the <code>defaultEncoding: 'utf-32be'</code> option. Strips BOM unless <code>stripBOM: false</code>.
 * Encoding: uses UTF-32LE and writes BOM by default. Use <code>addBOM: false</code> to override. (<code>defaultEncoding: 'utf-32be'</code> can also be used here to change encoding.)</p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>git<span class="w"> </span>clone<span class="w"> </span>git@github.com:ashtuchkin/iconv-lite.git
$<span class="w"> </span><span class="nb">cd</span><span class="w"> </span>iconv-lite
$<span class="w"> </span>npm<span class="w"> </span>install
$<span class="w"> </span>npm<span class="w"> </span><span class="nb">test</span>

$<span class="w"> </span><span class="c1"># To view performance:</span>
$<span class="w"> </span>node<span class="w"> </span>test/performance.js

$<span class="w"> </span><span class="c1"># To view test coverage:</span>
$<span class="w"> </span>npm<span class="w"> </span>run<span class="w"> </span>coverage
$<span class="w"> </span>open<span class="w"> </span>coverage/lcov-report/index.html
</code></pre></div>
