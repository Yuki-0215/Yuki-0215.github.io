...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/router/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>router - Kubernetes 进阶训练营</title>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#api" class="md-nav__link">
    API
        ...
        <li class="md-nav__item">
  <a href="#routeroptions" class="md-nav__link">
    Router(options)
  </a>
  
    <nav class="md-nav" aria-label="Router(options)">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#routerusepath-middleware" class="md-nav__link">
    router.use([path], ...middleware)
          ...
          <li class="md-nav__item">
  <a href="#routermethodpath-middleware-handler" class="md-nav__link">
    router[method](path, ...[middleware], handler)
          ...
          <li class="md-nav__item">
  <a href="#routerparamname-param_middleware" class="md-nav__link">
    router.param(name, param_middleware)
          ...
          <li class="md-nav__item">
  <a href="#routerroutepath" class="md-nav__link">
    router.route(path)
  </a>
        ...
        <li class="md-nav__item">
  <a href="#routerroutepath_1" class="md-nav__link">
    Router.Route(path)
  </a>
  
    <nav class="md-nav" aria-label="Router.Route(path)">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#routemethodhandler" class="md-nav__link">
    route[method](handler)
          ...
          <li class="md-nav__item">
  <a href="#routeallhandler" class="md-nav__link">
    route.all(handler)
  </a>
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#example-using-mergeparams" class="md-nav__link">
    Example using mergeParams
          ...
          <li class="md-nav__item">
  <a href="#example-of-advanced-route-usage" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/router/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="router">router<a class="headerlink" href="#router" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/router"><img alt="NPM Version" src="https://img.shields.io/npm/v/router.svg" /></a>
<a href="https://npmjs.org/package/router"><img alt="NPM Downloads" src="https://img.shields.io/npm/dm/router.svg" /></a>
<a href="http://nodejs.org/download/"><img alt="Node.js Version" src="https://img.shields.io/node/v/router.svg" /></a>
<a href="https://github.com/pillarjs/router/actions/workflows/ci.yml"><img alt="Build Status" src="https://badgen.net/github/checks/pillarjs/router/master?label=ci" /></a>
<a href="https://coveralls.io/r/pillarjs/router?branch=master"><img alt="Test Coverage" src="https://img.shields.io/coveralls/pillarjs/router/master.svg" /></a></p>
<p>Simple middleware-style router</p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>router
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">finalhandler</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;finalhandler&#39;</span><span class="p">)</span>
...
<span class="kd">var</span><span class="w"> </span><span class="nx">Router</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;router&#39;</span><span class="p">)</span>

<span class="kd">var</span><span class="w"> </span><span class="nx">router</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Router</span><span class="p">()</span>
<span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;/&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">  </span><span class="nx">router</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">finalhandler</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">))</span>
<span class="p">})</span>
...
<p>This module is currently an extracted version from the Express project,
but with the main change being it can be used with a plain <code>http.createServer</code>
object or other web frameworks by removing Express-specific API calls.</p>
<h2 id="routeroptions">Router(options)<a class="headerlink" href="#routeroptions" title="Permanent link">&para;</a></h2>
<p>Options</p>
<ul>
<li><code>strict</code>        - When <code>false</code> trailing slashes are optional (default: <code>false</code>)</li>
<li><code>caseSensitive</code> - When <code>true</code> the routing will be case sensitive. (default: <code>false</code>)</li>
<li><code>mergeParams</code>   - When <code>true</code> any <code>req.params</code> passed to the router will be
  merged into the router's <code>req.params</code>. (default: <code>false</code>) (<a href="#example-using-mergeparams">example</a>)</li>
</ul>
<p>Returns a function with the signature <code>router(req, res, callback)</code> where
<code>callback([err])</code> must be provided to handle errors and fall-through from
not handling requests.</p>
<h3 id="routerusepath-middleware">router.use([path], ...middleware)<a class="headerlink" href="#routerusepath-middleware" title="Permanent link">&para;</a></h3>
<p>Use the given <a href="#middleware">middleware function</a> for all http methods on the
given <code>path</code>, defaulting to the root path.</p>
<p><code>router</code> does not automatically see <code>use</code> as a handler. As such, it will not
consider it one for handling <code>OPTIONS</code> requests.</p>
<ul>
<li>Note: If a <code>path</code> is specified, that <code>path</code> is stripped from the start of
  <code>req.url</code>.</li>
</ul>
<!-- eslint-disable no-undef -->

<div class="highlight"><pre><span></span><code><span class="nx">router</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">next</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="c1">// do your things</span>

<span class="w">  </span><span class="c1">// continue to the next middleware</span>
<span class="w">  </span><span class="c1">// the request will stall if this is not called</span>
<span class="w">  </span><span class="nx">next</span><span class="p">()</span>

<span class="w">  </span><span class="c1">// note: you should NOT call `next` if you have begun writing to the response</span>
<span class="p">})</span>
</code></pre></div>
<p><a href="#middleware">Middleware</a> can themselves use <code>next('router')</code> at any time to
exit the current router instance completely, invoking the top-level callback.</p>
<h3 id="routermethodpath-middleware-handler">router[method](path, ...[middleware], handler)<a class="headerlink" href="#routermethodpath-middleware-handler" title="Permanent link">&para;</a></h3>
<p>The <a href="https://github.com/jshttp/methods/blob/master/index.js">http methods</a> provide
the routing functionality in <code>router</code>.</p>
<p>Method middleware and handlers follow usual <a href="#middleware">middleware</a> behavior,
except they will only be called when the method and path match the request.</p>
<!-- eslint-disable no-undef -->

<div class="highlight"><pre><span></span><code><span class="c1">// handle a `GET` request</span>
<span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;/&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/plain; charset=utf-8&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="s1">&#39;Hello World!&#39;</span><span class="p">)</span>
<span class="p">})</span>
</code></pre></div>
<p><a href="#middleware">Middleware</a> given before the handler have one additional trick,
they may invoke <code>next('route')</code>. Calling <code>next('route')</code> bypasses the remaining
middleware and the handler mounted for this route, passing the request to the
next route suitable for handling this request.</p>
<p>Route handlers and middleware can themselves use <code>next('router')</code> at any time
to exit the current router instance completely, invoking the top-level callback.</p>
<h3 id="routerparamname-param_middleware">router.param(name, param_middleware)<a class="headerlink" href="#routerparamname-param_middleware" title="Permanent link">&para;</a></h3>
<p>Maps the specified path parameter <code>name</code> to a specialized param-capturing middleware.</p>
<p>This function positions the middleware in the same stack as <code>.use</code>.</p>
<p>The function can optionally return a <code>Promise</code> object. If a <code>Promise</code> object
is returned from the function, the router will attach an <code>onRejected</code> callback
using <code>.then</code>. If the promise is rejected, <code>next</code> will be called with the
rejected value, or an error if the value is falsy.</p>
...
<div class="highlight"><pre><span></span><code><span class="nx">router</span><span class="p">.</span><span class="nx">param</span><span class="p">(</span><span class="s1">&#39;user_id&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">next</span><span class="p">,</span><span class="w"> </span><span class="nx">id</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">User</span><span class="p">.</span><span class="nx">find</span><span class="p">(</span><span class="nx">id</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">err</span><span class="p">,</span><span class="w"> </span><span class="nx">user</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">    </span><span class="p">}</span><span class="w"> </span><span class="k">else</span><span class="w"> </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="o">!</span><span class="nx">user</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="k">return</span><span class="w"> </span><span class="nx">next</span><span class="p">(</span><span class="ow">new</span><span class="w"> </span><span class="ne">Error</span><span class="p">(</span><span class="s1">&#39;failed to load user&#39;</span><span class="p">))</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">    </span><span class="nx">req</span><span class="p">.</span><span class="nx">user</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">user</span>

<span class="w">    </span><span class="c1">// continue processing the request</span>
<span class="w">    </span><span class="nx">next</span><span class="p">()</span>
<span class="w">  </span><span class="p">})</span>
<span class="p">})</span>
</code></pre></div>
<h3 id="routerroutepath">router.route(path)<a class="headerlink" href="#routerroutepath" title="Permanent link">&para;</a></h3>
<p>Creates an instance of a single <code>Route</code> for the given <code>path</code>.
(See <code>Router.Route</code> below)</p>
<p>Routes can be used to handle http <code>methods</code> with their own, optional middleware.</p>
<p>Using <code>router.route(path)</code> is a recommended approach to avoiding duplicate
route naming and thus typo errors.</p>
<!-- eslint-disable no-undef, no-unused-vars -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">api</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">router</span><span class="p">.</span><span class="nx">route</span><span class="p">(</span><span class="s1">&#39;/api/&#39;</span><span class="p">)</span>
</code></pre></div>
<h2 id="routerroutepath_1">Router.Route(path)<a class="headerlink" href="#routerroutepath_1" title="Permanent link">&para;</a></h2>
<p>Represents a single route as an instance that can be used to handle http
<code>methods</code> with it's own, optional middleware.</p>
<h3 id="routemethodhandler">route[method](handler)<a class="headerlink" href="#routemethodhandler" title="Permanent link">&para;</a></h3>
<p>These are functions which you can directly call on a route to register a new
<code>handler</code> for the <code>method</code> on the route.</p>
<!-- eslint-disable no-undef -->

<div class="highlight"><pre><span></span><code><span class="c1">// handle a `GET` request</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">status</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">router</span><span class="p">.</span><span class="nx">route</span><span class="p">(</span><span class="s1">&#39;/status&#39;</span><span class="p">)</span>

<span class="nx">status</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/plain; charset=utf-8&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="s1">&#39;All Systems Green!&#39;</span><span class="p">)</span>
<span class="p">})</span>
</code></pre></div>
<h3 id="routeallhandler">route.all(handler)<a class="headerlink" href="#routeallhandler" title="Permanent link">&para;</a></h3>
<p>Adds a handler for all HTTP methods to this route.</p>
<p>The handler can behave like middleware and call <code>next</code> to continue processing
rather than responding.</p>
<!-- eslint-disable no-undef -->

<div class="highlight"><pre><span></span><code><span class="nx">router</span><span class="p">.</span><span class="nx">route</span><span class="p">(</span><span class="s1">&#39;/&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="p">.</span><span class="nx">all</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">next</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">next</span><span class="p">()</span>
<span class="w">  </span><span class="p">})</span>
<span class="w">  </span><span class="p">.</span><span class="nx">all</span><span class="p">(</span><span class="nx">checkSomething</span><span class="p">)</span>
<span class="w">  </span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/plain; charset=utf-8&#39;</span><span class="p">)</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="s1">&#39;Hello World!&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="p">})</span>
</code></pre></div>
<h2 id="middleware">Middleware<a class="headerlink" href="#middleware" title="Permanent link">&para;</a></h2>
<p>Middleware (and method handlers) are functions that follow specific function
parameters and have defined behavior when used with <code>router</code>. The most common
format is with three parameters - "req", "res" and "next".</p>
<ul>
<li><code>req</code>  - This is a <a href="https://nodejs.org/api/http.html#http_http_incomingmessage">HTTP incoming message</a> instance.</li>
<li><code>res</code>  - This is a <a href="https://nodejs.org/api/http.html#http_class_http_serverresponse">HTTP server response</a> instance.</li>
<li><code>next</code> - Calling this function that tells <code>router</code> to proceed to the next matching middleware or method handler. It accepts an error as the first argument.</li>
</ul>
<p>The function can optionally return a <code>Promise</code> object. If a <code>Promise</code> object
is returned from the function, the router will attach an <code>onRejected</code> callback
using <code>.then</code>. If the promise is rejected, <code>next</code> will be called with the
rejected value, or an error if the value is falsy.</p>
<p>Middleware and method handlers can also be defined with four arguments. When
...
errors that occurred in previous handlers (E.g. from calling <code>next(err)</code>).
This is most used when you want to define arbitrary rendering of errors.</p>
<!-- eslint-disable no-undef -->

<div class="highlight"><pre><span></span><code><span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;/error_route&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">next</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">return</span><span class="w"> </span><span class="nx">next</span><span class="p">(</span><span class="ow">new</span><span class="w"> </span><span class="ne">Error</span><span class="p">(</span><span class="s1">&#39;Bad Request&#39;</span><span class="p">))</span>
<span class="p">})</span>

<span class="nx">router</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">err</span><span class="p">,</span><span class="w"> </span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">next</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nx">err</span><span class="p">.</span><span class="nx">message</span><span class="p">)</span><span class="w"> </span><span class="c1">//= &gt; &quot;Bad Request&quot;</span>
<span class="p">})</span>
</code></pre></div>
<p>Error handling middleware will <strong>only</strong> be invoked when an error was given. As
long as the error is in the pipeline, normal middleware and handlers will be
bypassed - only error handling middleware will be invoked with an error.</p>
<h2 id="examples">Examples<a class="headerlink" href="#examples" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="c1">// import our modules</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">http</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;http&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">Router</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;router&#39;</span><span class="p">)</span>
...
<span class="kd">var</span><span class="w"> </span><span class="nx">compression</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;compression&#39;</span><span class="p">)</span>
...
<span class="c1">// store our message to display</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">message</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;Hello World!&#39;</span>

<span class="c1">// initialize the router &amp; server and add a final callback.</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">router</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Router</span><span class="p">()</span>
...
<span class="c1">// use some middleware and compress all outgoing responses</span>
<span class="nx">router</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">compression</span><span class="p">())</span>

<span class="c1">// handle `GET` requests to `/message`</span>
<span class="nx">router</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;/message&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/plain; charset=utf-8&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nx">message</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s1">&#39;\n&#39;</span><span class="p">)</span>
<span class="p">})</span>

<span class="c1">// create and mount a new router for our API</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">api</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Router</span><span class="p">()</span>
<span class="nx">router</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="s1">&#39;/api/&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">api</span><span class="p">)</span>

<span class="c1">// add a body parsing middleware to our API</span>
<span class="nx">api</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">bodyParser</span><span class="p">.</span><span class="nx">json</span><span class="p">())</span>

<span class="c1">// handle `PATCH` requests to `/api/set-message`</span>
<span class="nx">api</span><span class="p">.</span><span class="nx">patch</span><span class="p">(</span><span class="s1">&#39;/set-message&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">body</span><span class="p">.</span><span class="nx">value</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">message</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">req</span><span class="p">.</span><span class="nx">body</span><span class="p">.</span><span class="nx">value</span>

<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">statusCode</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mf">200</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/plain; charset=utf-8&#39;</span><span class="p">)</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nx">message</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s1">&#39;\n&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="p">}</span><span class="w"> </span><span class="k">else</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">statusCode</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mf">400</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/plain; charset=utf-8&#39;</span><span class="p">)</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="s1">&#39;Invalid API Syntax\n&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">})</span>

<span class="c1">// make our http server listen to connections</span>
...
<p>You can get the message by running this command in your terminal,
 or navigating to <code>127.0.0.1:8080</code> in a web browser.
<div class="highlight"><pre><span></span><code>curl<span class="w"> </span>http://127.0.0.1:8080
</code></pre></div></p>
<p>You can set the message by sending it a <code>PATCH</code> request via this command:
<div class="highlight"><pre><span></span><code>curl<span class="w"> </span>http://127.0.0.1:8080/api/set-message<span class="w"> </span>-X<span class="w"> </span>PATCH<span class="w"> </span>-H<span class="w"> </span><span class="s2">&quot;Content-Type: application/json&quot;</span><span class="w"> </span>-d<span class="w"> </span><span class="s1">&#39;{&quot;value&quot;:&quot;Cats!&quot;}&#39;</span>
</code></pre></div></p>
<h3 id="example-using-mergeparams">Example using mergeParams<a class="headerlink" href="#example-using-mergeparams" title="Permanent link">&para;</a></h3>
...
<span class="c1">// this example is about the mergeParams option</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">opts</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">mergeParams</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="w"> </span><span class="p">}</span>

<span class="c1">// make a router with out special options</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">router</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Router</span><span class="p">(</span><span class="nx">opts</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">server</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="nx">onRequest</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="c1">// set something to be passed into the router</span>
<span class="w">  </span><span class="nx">req</span><span class="p">.</span><span class="nx">params</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;kitten&#39;</span><span class="w"> </span><span class="p">}</span>
...
<span class="w">  </span><span class="c1">// with respond with the the params that were passed in</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">params</span><span class="p">.</span><span class="nx">type</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s1">&#39;\n&#39;</span><span class="p">)</span>
<span class="p">})</span>

<span class="c1">// make another router with our options</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">handler</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Router</span><span class="p">(</span><span class="nx">opts</span><span class="p">)</span>

<span class="c1">// mount our new router to a route that accepts a param</span>
<span class="nx">router</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="s1">&#39;/:path&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">handler</span><span class="p">)</span>

<span class="nx">handler</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;/&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">statusCode</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mf">200</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/plain; charset=utf-8&#39;</span><span class="p">)</span>

<span class="w">  </span><span class="c1">// will respond with the param of the router&#39;s parent route</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nx">req</span><span class="p">.</span><span class="nx">params</span><span class="p">.</span><span class="nx">path</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s1">&#39;\n&#39;</span><span class="p">)</span>
<span class="p">})</span>

<span class="c1">// make our http server listen to connections</span>
<span class="nx">server</span><span class="p">.</span><span class="nx">listen</span><span class="p">(</span><span class="mf">8080</span><span class="p">)</span>
</code></pre></div>
<p>Now you can get the type, or what path you are requesting:
<div class="highlight"><pre><span></span><code>curl<span class="w"> </span>http://127.0.0.1:8080
&gt;<span class="w"> </span>kitten
curl<span class="w"> </span>http://127.0.0.1:8080/such_path
&gt;<span class="w"> </span>such_path
</code></pre></div></p>
<h3 id="example-of-advanced-route-usage">Example of advanced <code>.route()</code> usage<a class="headerlink" href="#example-of-advanced-route-usage" title="Permanent link">&para;</a></h3>
<p>This example shows how to implement routes where there is a custom
...
generic non-match by <code>router</code> (which typically results in a 404),
but with a custom handler, a <code>405 Method Not Allowed</code> can be sent.</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">http</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;http&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">finalhandler</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;finalhandler&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">Router</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;router&#39;</span><span class="p">)</span>

<span class="c1">// create the router and server</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">router</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">Router</span><span class="p">()</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">server</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="nx">onRequest</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">router</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">finalhandler</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">))</span>
<span class="p">})</span>

<span class="c1">// register a route and add all methods</span>
<span class="nx">router</span><span class="p">.</span><span class="nx">route</span><span class="p">(</span><span class="s1">&#39;/pet/:id&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// this is GET /pet/:id</span>
...
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nb">JSON</span><span class="p">.</span><span class="nx">stringify</span><span class="p">({</span><span class="w"> </span><span class="nx">name</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;tobi&#39;</span><span class="w"> </span><span class="p">}))</span>
<span class="w">  </span><span class="p">})</span>
<span class="w">  </span><span class="p">.</span><span class="ow">delete</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// this is DELETE /pet/:id</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">()</span>
<span class="w">  </span><span class="p">})</span>
<span class="w">  </span><span class="p">.</span><span class="nx">all</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// this is called for all other methods not</span>
<span class="w">    </span><span class="c1">// defined above for /pet/:id</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">statusCode</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mf">405</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">()</span>
<span class="w">  </span><span class="p">})</span>
