...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/zod-to-json-schema/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Zod to Json Schema - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#zod-to-json-schema" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#options" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#schema-name" class="md-nav__link">
    Schema name
  </a>
          ...
          <li class="md-nav__item">
  <a href="#options-object" class="md-nav__link">
    Options object
  </a>
  ...
  <a href="#result_1" class="md-nav__link">
    Result
          ...
          <li class="md-nav__item">
  <a href="#custom-error-message-support" class="md-nav__link">
  ...
  <a href="#additional-properties" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Additional properties">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#removing-the-additionalproperties-keyword-using-the-allowedadditionalproperties-andor-rejectedadditionalproperties-options" class="md-nav__link">
  ...
  <a href="#postprocess" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="postProcess">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#using-postprocess-for-including-examples-and-other-meta" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/zod-to-json-schema/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="zod-to-json-schema">Zod to Json Schema<a class="headerlink" href="#zod-to-json-schema" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/zod-to-json-schema"><img alt="NPM Version" src="https://img.shields.io/npm/v/zod-to-json-schema.svg" /></a>
<a href="https://npmjs.org/package/zod-to-json-schema"><img alt="NPM Downloads" src="https://img.shields.io/npm/dw/zod-to-json-schema.svg" /></a></p>
...
<span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;zod-to-json-schema&quot;</span><span class="p">;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">mySchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">z</span>
<span class="w">  </span><span class="p">.</span><span class="nx">object</span><span class="p">({</span>
<span class="w">    </span><span class="nx">myString</span><span class="o">:</span><span class="w"> </span><span class="kt">z.string</span><span class="p">().</span><span class="nx">min</span><span class="p">(</span><span class="mf">5</span><span class="p">),</span>
<span class="w">    </span><span class="nx">myUnion</span><span class="o">:</span><span class="w"> </span><span class="kt">z.union</span><span class="p">([</span><span class="nx">z</span><span class="p">.</span><span class="kt">number</span><span class="p">(),</span><span class="w"> </span><span class="nx">z</span><span class="p">.</span><span class="kt">boolean</span><span class="p">()]),</span>
<span class="w">  </span><span class="p">})</span>
<span class="w">  </span><span class="p">.</span><span class="nx">describe</span><span class="p">(</span><span class="s2">&quot;My neat object schema&quot;</span><span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">jsonSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="p">(</span><span class="nx">mySchema</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;mySchema&quot;</span><span class="p">);</span>
</code></pre></div>
<h4 id="expected-output">Expected output<a class="headerlink" href="#expected-output" title="Permanent link">&para;</a></h4>
...
<span class="w">  </span><span class="nt">&quot;$ref&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;#/definitions/mySchema&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;definitions&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nt">&quot;mySchema&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nt">&quot;description&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;My neat object schema&quot;</span><span class="p">,</span>
<span class="w">      </span><span class="nt">&quot;type&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;object&quot;</span><span class="p">,</span>
<span class="w">      </span><span class="nt">&quot;properties&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="nt">&quot;myString&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">          </span><span class="nt">&quot;type&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;string&quot;</span><span class="p">,</span>
<span class="w">          </span><span class="nt">&quot;minLength&quot;</span><span class="p">:</span><span class="w"> </span><span class="mi">5</span>
<span class="w">        </span><span class="p">},</span>
<span class="w">        </span><span class="nt">&quot;myUnion&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">          </span><span class="nt">&quot;type&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;number&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;boolean&quot;</span><span class="p">]</span>
<span class="w">        </span><span class="p">}</span>
<span class="w">      </span><span class="p">},</span>
...
<span class="w">      </span><span class="nt">&quot;required&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;myString&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;myUnion&quot;</span><span class="p">]</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
<h2 id="options">Options<a class="headerlink" href="#options" title="Permanent link">&para;</a></h2>
<h3 id="schema-name">Schema name<a class="headerlink" href="#schema-name" title="Permanent link">&para;</a></h3>
...
<h3 id="options-object">Options object<a class="headerlink" href="#options-object" title="Permanent link">&para;</a></h3>
...
<tbody>
<tr>
<td><strong>name</strong>?: <em>string</em></td>
<td>As described above.</td>
</tr>
<tr>
<td><strong>nameStrategy</strong>?: "ref" | "title"</td>
<td>Adds name as "title" meta instead of as a ref as described above</td>
</tr>
<tr>
<td><strong>basePath</strong>?: string[]</td>
<td>The base path of the root reference builder. Defaults to ["#"].</td>
</tr>
<tr>
<td><strong>$refStrategy</strong>?: "root" | "relative" | "seen" | "none"</td>
<td>The reference builder strategy; <ul><li><strong>"root"</strong> resolves $refs from the root up, ie: "#/definitions/mySchema".</li><li><strong>"relative"</strong> uses <a href="https://tools.ietf.org/id/draft-handrews-relative-json-pointer-00.html">relative JSON pointers</a>. <em>See known issues!</em></li><li><strong>"seen"</strong> reuses the output of any "seen" Zod schema. In theory it's a more performant version of "none", but in practice this behaviour can cause issues with nested schemas and has now gotten its own option.</li> <li><strong>"none"</strong> ignores referencing all together, creating a new schema branch even on "seen" schemas. Recursive references defaults to "any", ie <code>{}</code>.</li></ul> Defaults to "root".</td>
</tr>
<tr>
<td><strong>effectStrategy</strong>?: "input" | "any"</td>
<td>The effects output strategy. Defaults to "input". <em>See known issues!</em></td>
</tr>
<tr>
<td><strong>dateStrategy</strong>?: "format:date" | "format:date-time" | "string" | "integer"</td>
<td>Date strategy, integer allow to specify in unix-time min and max values. "format:date" creates a string schema with format: "date". "format:date-time" creates a string schema with format: "date-time". "string" is intepreted as "format:date-time". "integer" creates an integer schema with format "unix-time" (unless target "openApi3" is used min max checks are also respected)</td>
</tr>
<tr>
<td></td>
<td></td>
...
<tr>
<td><strong>emailStrategy</strong>?: "format:email" | "format:idn-email" | "pattern:zod"</td>
<td>Choose how to handle the email string check. Defaults to "format:email".</td>
</tr>
<tr>
<td><strong>base64Strategy</strong>?: "format:binary" | "contentEnconding:base64" | "pattern:zod"</td>
<td>Choose how to handle the base64 string check. Defaults to "contentEncoding:base64" as described <a href="https://json-schema.org/understanding-json-schema/reference/non_json_data#contentencoding">here</a>. Note that "format:binary" is not represented in the output type as it's not part of the JSON Schema spec and only intended to be used when targeting OpenAPI 3.0. Later versions of OpenAPI support contentEncoding.</td>
</tr>
<tr>
<td><strong>definitionPath</strong>?: "definitions" | "$defs"</td>
<td>The name of the definitions property when name is passed. Defaults to "definitions".</td>
</tr>
<tr>
<td><strong>target</strong>?: "jsonSchema7" | "jsonSchema2019-09" | "openApi3" | "openAi"</td>
<td>Which spec to target. Defaults to "jsonSchema7"</td>
</tr>
<tr>
<td><strong>strictUnions</strong>?: boolean</td>
<td>Scrubs unions of any-like json schemas, like <code>{}</code> or <code>true</code>. Multiple zod types may result in these out of necessity, such as z.instanceof()</td>
</tr>
<tr>
<td><strong>definitions</strong>?: Record<string, ZodSchema></td>
<td>See separate section below</td>
</tr>
<tr>
<td><strong>errorMessages</strong>?: boolean</td>
<td>Include custom error messages created via chained function checks for supported zod types. See section below</td>
</tr>
<tr>
<td><strong>markdownDescription</strong>?: boolean</td>
<td>Copies the <code>description</code> meta to <code>markdownDescription</code></td>
</tr>
<tr>
<td><strong>patternStrategy</strong>?: "escape" | "preserve"</td>
<td>The Zod string validations <code>.includes()</code>, <code>.startsWith()</code>, and <code>.endsWith()</code> must be converted to regex to be compatible with JSON Schema's <code>pattern</code>. For safety, all non-alphanumeric characters are <code>escape</code>d by default (consider <code>z.string().includes(".")</code>), but this can occasionally cause problems with Unicode-flagged regex parsers. Use <code>preserve</code> to prevent this escaping behaviour and preserve the exact string written, even if it results in an inaccurate regex.</td>
</tr>
<tr>
<td><strong>applyRegexFlags</strong>?: boolean</td>
<td>JSON Schema's <code>pattern</code> doesn't support RegExp flags, but Zod's <code>z.string().regex()</code> does. When this option is true (default false), a best-effort is made to transform regexes into a flag-independent form (e.g. <code>/x/i =&gt; /[xX]/</code> ). Supported flags: <code>i</code> (basic Latin only), <code>m</code>, <code>s</code>.</td>
</tr>
<tr>
<td><strong>pipeStrategy</strong>?: "all" | "input" | "output"</td>
<td>Decide which types should be included when using <code>z.pipe</code>, for example <code>z.string().pipe(z.number())</code> would return both <code>string</code> and <code>number</code> by default, only <code>string</code> for "input" and only <code>number</code> for "output".</td>
</tr>
<tr>
<td><strong>removeAdditionalStrategy</strong>?: "passthrough" | "strict"</td>
<td>Decide when <code>additionalProperties</code> should be allowed. See the section on additional properties for details.</td>
</tr>
<tr>
<td><strong>allowedAdditionalProperties</strong>?: <code>true</code> | <code>undefined</code></td>
<td>What value to give <code>additionalProperties</code> when allowed. See the section on additional properties for details.</td>
</tr>
<tr>
<td><strong>rejectedAdditionalProperties</strong>?: <code>false</code> | <code>undefined</code></td>
<td>What value to give <code>additionalProperties</code> when rejected. See the section on additional properties for details.</td>
</tr>
<tr>
<td><strong>override</strong>?: callback</td>
<td>See section</td>
</tr>
<tr>
<td><strong>postProcess</strong>?: callback</td>
<td>See section</td>
</tr>
</tbody>
</table>
...
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">myRecurringSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">z</span><span class="p">.</span><span class="kt">string</span><span class="p">();</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">myObjectSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">z</span><span class="p">.</span><span class="nx">object</span><span class="p">({</span><span class="w"> </span><span class="nx">a</span><span class="o">:</span><span class="w"> </span><span class="kt">myRecurringSchema</span><span class="p">,</span><span class="w"> </span><span class="nx">b</span><span class="o">:</span><span class="w"> </span><span class="kt">myRecurringSchema</span><span class="w"> </span><span class="p">});</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">myJsonSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="p">(</span><span class="nx">myObjectSchema</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">definitions</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">myRecurringSchema</span><span class="w"> </span><span class="p">},</span>
<span class="p">});</span>
</code></pre></div>
...
<span class="w">      </span><span class="nt">&quot;$ref&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;#/definitions/myRecurringSchema&quot;</span>
<span class="w">    </span><span class="p">},</span>
...
<span class="w">  </span><span class="p">},</span>
<span class="w">  </span><span class="nt">&quot;definitions&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nt">&quot;myRecurringSchema&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
...
<div class="highlight"><pre><span></span><code><span class="c1">// string schema with additional chained function call checks</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">EmailSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">z</span><span class="p">.</span><span class="kt">string</span><span class="p">().</span><span class="nx">email</span><span class="p">(</span><span class="s2">&quot;Invalid email&quot;</span><span class="p">).</span><span class="nx">min</span><span class="p">(</span><span class="mf">5</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;Too short&quot;</span><span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">jsonSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="p">(</span><span class="nx">EmailSchema</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">errorMessages</span><span class="o">:</span><span class="w"> </span><span class="kt">true</span><span class="w"> </span><span class="p">});</span>
</code></pre></div>
...
<span class="w">  </span><span class="nt">&quot;minLength&quot;</span><span class="p">:</span><span class="w"> </span><span class="mi">5</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;errorMessage&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nt">&quot;format&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;Invalid email&quot;</span><span class="p">,</span>
<span class="w">    </span><span class="nt">&quot;minLength&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;Too short&quot;</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
<p>This allows for field specific, validation step specific error messages which can be useful for building forms and such. This format is accepted by <code>react-hook-form</code>'s ajv resolver (and therefor <code>ajv-errors</code> which it uses under the hood). Note that if using AJV with this format will require <a href="https://ajv.js.org/packages/ajv-errors.html#usage">enabling <code>ajv-errors</code></a> as vanilla AJV does not accept this format by default.</p>
<h4 id="custom-error-message-support">Custom Error Message Support<a class="headerlink" href="#custom-error-message-support" title="Permanent link">&para;</a></h4>
<ul>
<li>ZodString</li>
<li>regex</li>
<li>min, max</li>
...
<h3 id="additional-properties">Additional properties<a class="headerlink" href="#additional-properties" title="Permanent link">&para;</a></h3>
...
<h4 id="removing-the-additionalproperties-keyword-using-the-allowedadditionalproperties-andor-rejectedadditionalproperties-options">Removing the <code>additionalProperties</code> keyword using the <code>allowedAdditionalProperties</code> and/or <code>rejectedAdditionalProperties</code> options.<a class="headerlink" href="#removing-the-additionalproperties-keyword-using-the-allowedadditionalproperties-andor-rejectedadditionalproperties-options" title="Permanent link">&para;</a></h4>
...
<h4 id="expected-outputs">Expected outputs<a class="headerlink" href="#expected-outputs" title="Permanent link">&para;</a></h4>
<table>
<thead>
<tr>
<th><code>z.object({})</code> + option</th>
<th><code>"additionalProperties"</code> value</th>
</tr>
</thead>
<tbody>
<tr>
<td><code>.strip()</code> (default)</td>
<td><code>false</code> if strategy is <code>"passtrough"</code>, <code>true</code> if <code>"strict"</code></td>
</tr>
<tr>
<td><code>.passtrough()</code></td>
...
<tr>
<td><code>.catchall(z.string())</code></td>
<td><code>{ "type": "string" }</code></td>
</tr>
<tr>
<td><code>.catchall(z.function())</code></td>
<td><code>undefined</code> (function schemas are not currently parseable)</td>
</tr>
</tbody>
</table>
...
<h3 id="override"><code>override</code><a class="headerlink" href="#override" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">ignoreOverride</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;zod-to-json-schema&quot;</span><span class="p">;</span>

<span class="nx">zodToJsonSchema</span><span class="p">(</span>
<span class="w">  </span><span class="nx">z</span><span class="p">.</span><span class="nx">object</span><span class="p">({</span>
<span class="w">    </span><span class="nx">ignoreThis</span><span class="o">:</span><span class="w"> </span><span class="kt">z.string</span><span class="p">(),</span>
<span class="w">    </span><span class="nx">overrideThis</span><span class="o">:</span><span class="w"> </span><span class="kt">z.string</span><span class="p">(),</span>
<span class="w">    </span><span class="nx">removeThis</span><span class="o">:</span><span class="w"> </span><span class="kt">z.string</span><span class="p">(),</span>
<span class="w">  </span><span class="p">}),</span>
<span class="w">  </span><span class="p">{</span>
<span class="w">    </span><span class="kd">override</span><span class="o">:</span><span class="w"> </span><span class="p">(</span><span class="nx">def</span><span class="p">,</span><span class="w"> </span><span class="nx">refs</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="kd">const</span><span class="w"> </span><span class="nx">path</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">refs</span><span class="p">.</span><span class="nx">currentPath</span><span class="p">.</span><span class="nx">join</span><span class="p">(</span><span class="s2">&quot;/&quot;</span><span class="p">);</span>

<span class="w">      </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">path</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="s2">&quot;#/properties/overrideThis&quot;</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="k">return</span><span class="w"> </span><span class="p">{</span>
<span class="w">          </span><span class="kr">type</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;integer&quot;</span><span class="p">,</span>
<span class="w">        </span><span class="p">};</span>
<span class="w">      </span><span class="p">}</span>

<span class="w">      </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">path</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="s2">&quot;#/properties/removeThis&quot;</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="k">return</span><span class="w"> </span><span class="kc">undefined</span><span class="p">;</span>
<span class="w">      </span><span class="p">}</span>

<span class="w">      </span><span class="c1">// Important! Do not return `undefined` or void unless you want to remove the property from the resulting schema completely.</span>
<span class="w">      </span><span class="k">return</span><span class="w"> </span><span class="nx">ignoreOverride</span><span class="p">;</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">},</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="nt">&quot;type&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;object&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;required&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;ignoreThis&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;overrideThis&quot;</span><span class="p">],</span>
<span class="w">  </span><span class="nt">&quot;properties&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nt">&quot;ignoreThis&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nt">&quot;type&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;string&quot;</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">    </span><span class="nt">&quot;overrideThis&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
...
<h3 id="postprocess"><code>postProcess</code><a class="headerlink" href="#postprocess" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">PostProcessCallback</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;zod-to-json-schema&quot;</span><span class="p">;</span>

<span class="c1">// Define the callback to be used to process the output using the PostProcessCallback type:</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">postProcess</span><span class="o">:</span><span class="w"> </span><span class="kt">PostProcessCallback</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">(</span>
<span class="w">  </span><span class="c1">// The original output produced by the package itself:</span>
<span class="w">  </span><span class="nx">jsonSchema</span><span class="p">,</span>
<span class="w">  </span><span class="c1">// The ZodSchema def used to produce the original schema:</span>
<span class="w">  </span><span class="nx">def</span><span class="p">,</span>
<span class="w">  </span><span class="c1">// The refs object containing the current path, passed options, etc.</span>
<span class="w">  </span><span class="nx">refs</span><span class="p">,</span>
<span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="o">!</span><span class="nx">jsonSchema</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="k">return</span><span class="w"> </span><span class="nx">jsonSchema</span><span class="p">;</span>
<span class="w">  </span><span class="p">}</span>

<span class="w">  </span><span class="c1">// Try to expand description as JSON meta:</span>
<span class="w">  </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">jsonSchema</span><span class="p">.</span><span class="nx">description</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="k">try</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">jsonSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="p">...</span><span class="nx">jsonSchema</span><span class="p">,</span>
<span class="w">        </span><span class="p">...</span><span class="nb">JSON</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">jsonSchema</span><span class="p">.</span><span class="nx">description</span><span class="p">),</span>
<span class="w">      </span><span class="p">};</span>
<span class="w">    </span><span class="p">}</span><span class="w"> </span><span class="k">catch</span><span class="w"> </span><span class="p">{}</span>
<span class="w">  </span><span class="p">}</span>

<span class="w">  </span><span class="c1">// Make all numbers nullable:</span>
<span class="w">  </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="s2">&quot;type&quot;</span><span class="w"> </span><span class="ow">in</span><span class="w"> </span><span class="nx">jsonSchema</span><span class="o">!</span><span class="w"> </span><span class="o">&amp;&amp;</span><span class="w"> </span><span class="nx">jsonSchema</span><span class="p">.</span><span class="kr">type</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="s2">&quot;number&quot;</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">jsonSchema</span><span class="p">.</span><span class="kr">type</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;number&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;null&quot;</span><span class="p">];</span>
<span class="w">  </span><span class="p">}</span>

<span class="w">  </span><span class="c1">// Add the refs path, just because</span>
<span class="w">  </span><span class="p">(</span><span class="nx">jsonSchema</span><span class="w"> </span><span class="kr">as</span><span class="w"> </span><span class="nx">any</span><span class="p">).</span><span class="nx">path</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">refs</span><span class="p">.</span><span class="nx">currentPath</span><span class="p">;</span>

<span class="w">  </span><span class="k">return</span><span class="w"> </span><span class="nx">jsonSchema</span><span class="p">;</span>
<span class="p">};</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">jsonSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="p">(</span><span class="nx">zodSchema</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">postProcess</span><span class="w"> </span><span class="p">});</span>
</code></pre></div>
<h4 id="using-postprocess-for-including-examples-and-other-meta">Using <code>postProcess</code> for including examples and other meta<a class="headerlink" href="#using-postprocess-for-including-examples-and-other-meta" title="Permanent link">&para;</a></h4>
...
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">jsonDescription</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;zod-to-json-schema&quot;</span><span class="p">;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">zodSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">z</span><span class="p">.</span><span class="kt">string</span><span class="p">().</span><span class="nx">describe</span><span class="p">(</span>
<span class="w">  </span><span class="nb">JSON</span><span class="p">.</span><span class="nx">stringify</span><span class="p">({</span>
<span class="w">    </span><span class="nx">title</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;My string&quot;</span><span class="p">,</span>
<span class="w">    </span><span class="nx">description</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;My description&quot;</span><span class="p">,</span>
<span class="w">    </span><span class="nx">examples</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;Foo&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;Bar&quot;</span><span class="p">],</span>
<span class="w">    </span><span class="nx">whatever</span><span class="o">:</span><span class="w"> </span><span class="kt">123</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">jsonSchema</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">zodToJsonSchema</span><span class="p">(</span><span class="nx">zodSchema</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">postProcess</span><span class="o">:</span><span class="w"> </span><span class="kt">jsonDescription</span><span class="p">,</span>
<span class="p">});</span>
</code></pre></div>
<p>Expected output:</p>
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="nt">&quot;$schema&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;http://json-schema.org/draft-07/schema#&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;type&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;string&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;title&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;My string&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;description&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;My description&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;examples&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;Foo&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;Bar&quot;</span><span class="p">],</span>
<span class="w">  </span><span class="nt">&quot;whatever&quot;</span><span class="p">:</span><span class="w"> </span><span class="mi">123</span>
<span class="p">}</span>
</code></pre></div>
...
<p>https://github.com/StefanTerdell/zod-to-json-schema/blob/master/changelog.md</p>
