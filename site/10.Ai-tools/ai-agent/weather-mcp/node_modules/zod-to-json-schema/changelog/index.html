...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/zod-to-json-schema/changelog/">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/zod-to-json-schema/changelog.md" title="编辑此页" class="md-content__button md-icon">
...
<tr>
<td>3.21.3</td>
<td>Fixes issue #77 (Reference path to nullable schemas in Open-API mode)</td>
</tr>
<tr>
<td>3.21.2</td>
...
<tr>
<td>3.20.0</td>
<td>Adds support for Zod 3.20 with catch and pipe parser as well as new string validations. Refactored Ref handling; adding definitions no longer considered experimental. Main API function refactored and simplified; output type less defined but a lot easier to maintain. Doubt anyone will miss it. <br/><quote><i>Narrator: Someone did in fact miss it</i></quote></td>
</tr>
<tr>
<td>3.19.4</td>
...
<tr>
<td>3.14.0</td>
<td>Moves Zod into peerDependencies. Supports checks for sets, NaN-type (sort of), discriminated union type and standalone optional properties (as unions with undefined)</td>
</tr>
<tr>
<td>3.12.x - 3.13.x</td>
<td>Skipped</td>
...
<tr>
<td>3.11.3</td>
<td>Joins unions of enums into single enum and allows enums as keys of records</td>
</tr>
<tr>
<td>3.11.2</td>
<td>Adds option to target Open API 3 spec (paths) instead of Json Schema 7.</td>
</tr>
<tr>
<td>3.11.1</td>
<td>Performance boost when using $refStrategy <code>none</code> and internal improvements.</td>
</tr>
<tr>
<td>3.11.0</td>
<td>Added description support introduced in Zod 3.11.5</td>
</tr>
<tr>
<td>3.10.x</td>
<td>Skipped: Minor 10 did not change the Zod API</td>
</tr>
<tr>
<td>3.9.5</td>
<td>Type bug fix: used dev dependency types in package</td>
</tr>
<tr>
<td>3.9.4</td>
<td>Path bug fix and test case when using optional definitions path</td>
</tr>
<tr>
<td>3.9.3</td>
<td>Added option to change definition property name to $defs</td>
</tr>
<tr>
<td>3.9.2</td>
<td>Added option to handle transform results as any instead of relying on their input schema.</td>
</tr>
<tr>
<td>3.9.1</td>
<td>Refactored the way reference pointers are passed around and added options pattern to main function without braking backwards compatibility! You can now add a base path, change the reference strategy (or opt out), and still set the schema name inside the options object or outside as before.</td>
</tr>
<tr>
<td>3.9.0</td>
<td>Added support for multipleOf number validaion, .rest() schemas for tuples and key validation for records (only compatible with string keys due to JSON Schema limitation).</td>
</tr>
<tr>
<td>3.7.x - 3.8.x</td>
<td>Skipped to reach functional parity with Zod versioning.</td>
</tr>
<tr>
<td>3.6.1</td>
<td>Realised intersection had another potential ref pathing bug. Fixed.</td>
</tr>
<tr>
<td>3.6.0</td>
<td>Added support for default &amp; effects (refine). Broke out changelog.md</td>
</tr>
<tr>
<td>3.5.0</td>
<td>Added support for CUID string validation</td>
</tr>
<tr>
<td>3.4.3</td>
<td>Fixed $ref pathing for catchall and intersection. Additional tests and code structure fixes.</td>
</tr>
<tr>
<td>3.4.2</td>
<td>Fixed broken intersection parser (Thanks <a href="https://github.com/Noah2610">Noah2610</a>!)</td>
</tr>
<tr>
<td>3.4.1</td>
<td>Fixed pathing bug for nullable items.</td>
</tr>
<tr>
<td>3.4.0</td>
<td>Added support for z.lazy()</td>
</tr>
<tr>
<td>3.3.0</td>
<td>Added support for catchall (additionalProperties schema on objects). Rebuilt object parser.</td>
</tr>
<tr>
<td>3.2.0</td>
<td>Added support for Map and Set as seen by their most common JSON definitions. Beware no standardized definition seem to exist and JSON.parse doesn't handle either natively. Their implementations here are based on the spread approach. Also further simplified intersection definition to just allOf.</td>
</tr>
<tr>
<td>3.1.0</td>
<td>String patterns finally supported! Fixed bugs include broken external type, unsafe nullable parsing, bad intersection implementation, and missing support for passthrough keys in objects.</td>
</tr>
<tr>
<td>3.0.3</td>
<td>Fixed array deep pathing bug (path contained <code>array</code> instead of <code>items</code>)</td>
</tr>
<tr>
<td>3.0.2</td>
<td>Fixed broken type usage (NonEmptyArrayDefinition was removed from Zod)</td>
</tr>
<tr>
<td>3.0.1</td>
<td>Fixed a typo in the readme</td>
</tr>
<tr>
<td>3.0.0</td>
<td>Compatible with Zod 3.2.0. Huge props to <a href="https://github.com/mrhammadasif">Mr Hammad Asif</a> for his work on this.</td>
</tr>
<tr>
<td>0.6.2</td>
<td>Hotfix for undefined object properties. Could crash the parser when using Pick</td>
</tr>
<tr>
<td>0.6.1</td>
<td>Fixed bug in union pathing. <code>$Ref</code> was missing <code>/anyOf</code></td>
</tr>
<tr>
<td>0.6.0</td>
<td>Moved <code>@types/json-schema</code> and <code>typescript</code> to dev dependencies. <code>@types/json-schema</code> is now only used for the test suites. Using <code>strict: true</code> in ts config.</td>
</tr>
<tr>
<td>0.5.1</td>
<td>First working release with all relevant Zod types present with most validations (except for string patterns due to Zod not exposing the source regexp pattern for those).</td>
</tr>
<tr>
<td>&lt; 0.5.1</td>
<td>Deprecated due to broken package structure. Please be patient, I eat crayons.</td>
</tr>
</tbody>
</table>
