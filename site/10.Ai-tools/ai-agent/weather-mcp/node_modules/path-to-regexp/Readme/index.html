...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/path-to-regexp/Readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Path-to-RegExp - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#path-to-regexp" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#match" class="md-nav__link">
    Match
        ...
        <li class="md-nav__item">
  <a href="#pathtoregexp" class="md-nav__link">
    PathToRegexp
  </a>
        ...
        <li class="md-nav__item">
  <a href="#compile-reverse-path-to-regexp" class="md-nav__link">
  ...
  <a href="#developers" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Developers">
      <ul class="md-nav__list">
  ...
  <a href="#tokens" class="md-nav__link">
    Tokens
          ...
          <li class="md-nav__item">
  <a href="#custom-path" class="md-nav__link">
    Custom path
  </a>
  ...
  <a href="#errors" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Errors">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#unexpected-or" class="md-nav__link">
    Unexpected ? or +
  </a>
          ...
          <li class="md-nav__item">
  <a href="#unexpected-etc" class="md-nav__link">
    Unexpected (, ), [, ], etc.
  </a>
          ...
          <li class="md-nav__item">
  <a href="#missing-parameter-name" class="md-nav__link">
    Missing parameter name
          ...
          <li class="md-nav__item">
  <a href="#unterminated-quote" class="md-nav__link">
    Unterminated quote
  </a>
          ...
          <li class="md-nav__item">
  <a href="#express-4x" class="md-nav__link">
    Express &lt;= 4.x
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/path-to-regexp/Readme.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="path-to-regexp">Path-to-RegExp<a class="headerlink" href="#path-to-regexp" title="Permanent link">&para;</a></h1>
<blockquote>
<p>Turn a path string such as <code>/user/:name</code> into a regular expression.</p>
</blockquote>
<p><a href="https://npmjs.org/package/path-to-regexp"><img alt="NPM version" src="https://img.shields.io/npm/v/path-to-regexp" /></a>
<a href="https://npmjs.org/package/path-to-regexp"><img alt="NPM downloads" src="https://img.shields.io/npm/dm/path-to-regexp" /></a>
<a href="https://github.com/pillarjs/path-to-regexp/actions/workflows/ci.yml?query=branch%3Amaster"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/pillarjs/path-to-regexp/ci.yml?branch=master" /></a>
<a href="https://codecov.io/gh/pillarjs/path-to-regexp"><img alt="Build coverage" src="https://img.shields.io/codecov/c/gh/pillarjs/path-to-regexp" /></a>
<a href="LICENSE.md"><img alt="License" src="http://img.shields.io/npm/l/path-to-regexp.svg?style=flat" /></a></p>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>npm install path-to-regexp --save
</code></pre></div>
...
<span class="w">  </span><span class="nx">pathToRegexp</span><span class="p">,</span>
<span class="w">  </span><span class="nx">compile</span><span class="p">,</span>
<span class="w">  </span><span class="nx">parse</span><span class="p">,</span>
<span class="w">  </span><span class="nx">stringify</span><span class="p">,</span>
<span class="p">}</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;path-to-regexp&quot;</span><span class="p">);</span>
</code></pre></div>
<h3 id="parameters">Parameters<a class="headerlink" href="#parameters" title="Permanent link">&para;</a></h3>
<p>Parameters match arbitrary strings in a path by matching up to the end of the segment, or up to any proceeding tokens. They are defined by prefixing a colon to the parameter name (<code>:foo</code>). Parameter names can use any valid JavaScript identifier, or be double quoted to use other characters (<code>:"param-name"</code>).</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">fn</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">match</span><span class="p">(</span><span class="s2">&quot;/:foo/:bar&quot;</span><span class="p">);</span>

<span class="nx">fn</span><span class="p">(</span><span class="s2">&quot;/test/route&quot;</span><span class="p">);</span>
<span class="c1">//=&gt; { path: &#39;/test/route&#39;, params: { foo: &#39;test&#39;, bar: &#39;route&#39; } }</span>
</code></pre></div>
<h3 id="wildcard">Wildcard<a class="headerlink" href="#wildcard" title="Permanent link">&para;</a></h3>
<p>Wildcard parameters match one or more characters across multiple segments. They are defined the same way as regular parameters, but are prefixed with an asterisk (<code>*foo</code>).</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">fn</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">match</span><span class="p">(</span><span class="s2">&quot;/*splat&quot;</span><span class="p">);</span>

<span class="nx">fn</span><span class="p">(</span><span class="s2">&quot;/bar/baz&quot;</span><span class="p">);</span>
<span class="c1">//=&gt; { path: &#39;/bar/baz&#39;, params: { splat: [ &#39;bar&#39;, &#39;baz&#39; ] } }</span>
</code></pre></div>
<h3 id="optional">Optional<a class="headerlink" href="#optional" title="Permanent link">&para;</a></h3>
<p>Braces can be used to define parts of the path that are optional.</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">fn</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">match</span><span class="p">(</span><span class="s2">&quot;/users{/:id}/delete&quot;</span><span class="p">);</span>

<span class="nx">fn</span><span class="p">(</span><span class="s2">&quot;/users/delete&quot;</span><span class="p">);</span>
<span class="c1">//=&gt; { path: &#39;/users/delete&#39;, params: {} }</span>

<span class="nx">fn</span><span class="p">(</span><span class="s2">&quot;/users/123/delete&quot;</span><span class="p">);</span>
<span class="c1">//=&gt; { path: &#39;/users/123/delete&#39;, params: { id: &#39;123&#39; } }</span>
</code></pre></div>
<h2 id="match">Match<a class="headerlink" href="#match" title="Permanent link">&para;</a></h2>
<p>The <code>match</code> function returns a function for matching strings against a path:</p>
<ul>
<li><strong>path</strong> String or array of strings.</li>
<li><strong>options</strong> <em>(optional)</em> (Extends <a href="#pathToRegexp">pathToRegexp</a> options)</li>
<li><strong>decode</strong> Function for decoding strings to params, or <code>false</code> to disable all processing. (default: <code>decodeURIComponent</code>)</li>
</ul>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">fn</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">match</span><span class="p">(</span><span class="s2">&quot;/foo/:bar&quot;</span><span class="p">);</span>
</code></pre></div>
<p><strong>Please note:</strong> <code>path-to-regexp</code> is intended for ordered data (e.g. paths, hosts). It can not handle arbitrarily ordered data (e.g. query strings, URL fragments, JSON, etc).</p>
<h2 id="pathtoregexp">PathToRegexp<a class="headerlink" href="#pathtoregexp" title="Permanent link">&para;</a></h2>
<p>The <code>pathToRegexp</code> function returns a regular expression for matching strings against paths. It</p>
<ul>
<li><strong>path</strong> String or array of strings.</li>
<li><strong>options</strong> <em>(optional)</em> (See <a href="#parse">parse</a> for more options)</li>
<li><strong>sensitive</strong> Regexp will be case sensitive. (default: <code>false</code>)</li>
<li><strong>end</strong> Validate the match reaches the end of the string. (default: <code>true</code>)</li>
<li><strong>delimiter</strong> The default delimiter for segments, e.g. <code>[^/]</code> for <code>:named</code> parameters. (default: <code>'/'</code>)</li>
<li><strong>trailing</strong> Allows optional trailing delimiter to match. (default: <code>true</code>)</li>
</ul>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">regexp</span><span class="p">,</span><span class="w"> </span><span class="nx">keys</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">pathToRegexp</span><span class="p">(</span><span class="s2">&quot;/foo/:bar&quot;</span><span class="p">);</span>
</code></pre></div>
<h2 id="compile-reverse-path-to-regexp">Compile ("Reverse" Path-To-RegExp)<a class="headerlink" href="#compile-reverse-path-to-regexp" title="Permanent link">&para;</a></h2>
<p>The <code>compile</code> function will return a function for transforming parameters into a valid path:</p>
<ul>
<li><strong>path</strong> A string.</li>
<li><strong>options</strong> (See <a href="#parse">parse</a> for more options)</li>
<li><strong>delimiter</strong> The default delimiter for segments, e.g. <code>[^/]</code> for <code>:named</code> parameters. (default: <code>'/'</code>)</li>
<li><strong>encode</strong> Function for encoding input strings for output into the path, or <code>false</code> to disable entirely. (default: <code>encodeURIComponent</code>)</li>
</ul>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">toPath</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">compile</span><span class="p">(</span><span class="s2">&quot;/user/:id&quot;</span><span class="p">);</span>

<span class="nx">toPath</span><span class="p">({</span><span class="w"> </span><span class="nx">id</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;name&quot;</span><span class="w"> </span><span class="p">});</span><span class="w"> </span><span class="c1">//=&gt; &quot;/user/name&quot;</span>
<span class="nx">toPath</span><span class="p">({</span><span class="w"> </span><span class="nx">id</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;café&quot;</span><span class="w"> </span><span class="p">});</span><span class="w"> </span><span class="c1">//=&gt; &quot;/user/caf%C3%A9&quot;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">toPathRepeated</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">compile</span><span class="p">(</span><span class="s2">&quot;/*segment&quot;</span><span class="p">);</span>

<span class="nx">toPathRepeated</span><span class="p">({</span><span class="w"> </span><span class="nx">segment</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;foo&quot;</span><span class="p">]</span><span class="w"> </span><span class="p">});</span><span class="w"> </span><span class="c1">//=&gt; &quot;/foo&quot;</span>
<span class="nx">toPathRepeated</span><span class="p">({</span><span class="w"> </span><span class="nx">segment</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;a&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;b&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;c&quot;</span><span class="p">]</span><span class="w"> </span><span class="p">});</span><span class="w"> </span><span class="c1">//=&gt; &quot;/a/b/c&quot;</span>

<span class="c1">// When disabling `encode`, you need to make sure inputs are encoded correctly. No arrays are accepted.</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">toPathRaw</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">compile</span><span class="p">(</span><span class="s2">&quot;/user/:id&quot;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">encode</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="w"> </span><span class="p">});</span>

<span class="nx">toPathRaw</span><span class="p">({</span><span class="w"> </span><span class="nx">id</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;%3A%2F&quot;</span><span class="w"> </span><span class="p">});</span><span class="w"> </span><span class="c1">//=&gt; &quot;/user/%3A%2F&quot;</span>
</code></pre></div>
<h2 id="stringify">Stringify<a class="headerlink" href="#stringify" title="Permanent link">&para;</a></h2>
<p>Transform <code>TokenData</code> (a sequence of tokens) back into a Path-to-RegExp string.</p>
<ul>
<li><strong>data</strong> A <code>TokenData</code> instance</li>
</ul>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">data</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">TokenData</span><span class="p">([</span>
<span class="w">  </span><span class="p">{</span><span class="w"> </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;text&quot;</span><span class="p">,</span><span class="w"> </span><span class="nx">value</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;/&quot;</span><span class="w"> </span><span class="p">},</span>
<span class="w">  </span><span class="p">{</span><span class="w"> </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;param&quot;</span><span class="p">,</span><span class="w"> </span><span class="nx">name</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;foo&quot;</span><span class="w"> </span><span class="p">},</span>
<span class="p">]);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">path</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">stringify</span><span class="p">(</span><span class="nx">data</span><span class="p">);</span><span class="w"> </span><span class="c1">//=&gt; &quot;/:foo&quot;</span>
</code></pre></div>
<h2 id="developers">Developers<a class="headerlink" href="#developers" title="Permanent link">&para;</a></h2>
<ul>
<li>If you are rewriting paths with match and compile, consider using <code>encode: false</code> and <code>decode: false</code> to keep raw paths passed around.</li>
<li>To ensure matches work on paths containing characters usually encoded, such as emoji, consider using <a href="https://github.com/pillarjs/encodeurl">encodeurl</a> for <code>encodePath</code>.</li>
</ul>
<h3 id="parse">Parse<a class="headerlink" href="#parse" title="Permanent link">&para;</a></h3>
<p>The <code>parse</code> function accepts a string and returns <code>TokenData</code>, the set of tokens and other metadata parsed from the input string. <code>TokenData</code> is can used with <code>match</code> and <code>compile</code>.</p>
<ul>
<li><strong>path</strong> A string.</li>
<li><strong>options</strong> <em>(optional)</em></li>
<li><strong>encodePath</strong> A function for encoding input strings. (default: <code>x =&gt; x</code>, recommended: <a href="https://github.com/pillarjs/encodeurl"><code>encodeurl</code></a>)</li>
</ul>
<h3 id="tokens">Tokens<a class="headerlink" href="#tokens" title="Permanent link">&para;</a></h3>
<p><code>TokenData</code> is a sequence of tokens, currently of types <code>text</code>, <code>parameter</code>, <code>wildcard</code>, or <code>group</code>.</p>
<h3 id="custom-path">Custom path<a class="headerlink" href="#custom-path" title="Permanent link">&para;</a></h3>
<p>In some applications, you may not be able to use the <code>path-to-regexp</code> syntax, but still want to use this library for <code>match</code> and <code>compile</code>. For example:</p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">TokenData</span><span class="p">,</span><span class="w"> </span><span class="nx">match</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;path-to-regexp&quot;</span><span class="p">;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">tokens</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">[</span>
<span class="w">  </span><span class="p">{</span><span class="w"> </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;text&quot;</span><span class="p">,</span><span class="w"> </span><span class="nx">value</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;/&quot;</span><span class="w"> </span><span class="p">},</span>
<span class="w">  </span><span class="p">{</span><span class="w"> </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;parameter&quot;</span><span class="p">,</span><span class="w"> </span><span class="nx">name</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;foo&quot;</span><span class="w"> </span><span class="p">},</span>
<span class="p">];</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">path</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">TokenData</span><span class="p">(</span><span class="nx">tokens</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">fn</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">match</span><span class="p">(</span><span class="nx">path</span><span class="p">);</span>

<span class="nx">fn</span><span class="p">(</span><span class="s2">&quot;/test&quot;</span><span class="p">);</span><span class="w"> </span><span class="c1">//=&gt; { path: &#39;/test&#39;, index: 0, params: { foo: &#39;test&#39; } }</span>
</code></pre></div>
<h2 id="errors">Errors<a class="headerlink" href="#errors" title="Permanent link">&para;</a></h2>
<p>An effort has been made to ensure ambiguous paths from previous releases throw an error. This means you might be seeing an error when things worked before.</p>
<h3 id="unexpected-or">Unexpected <code>?</code> or <code>+</code><a class="headerlink" href="#unexpected-or" title="Permanent link">&para;</a></h3>
<p>In past releases, <code>?</code>, <code>*</code>, and <code>+</code> were used to denote optional or repeating parameters. As an alternative, try these:</p>
<ul>
<li>For optional (<code>?</code>), use an empty segment in a group such as <code>/:file{.:ext}</code>.</li>
<li>For repeating (<code>+</code>), only wildcard matching is supported, such as <code>/*path</code>.</li>
<li>For optional repeating (<code>*</code>), use a group and a wildcard parameter such as <code>/files{/*path}</code>.</li>
</ul>
<h3 id="unexpected-etc">Unexpected <code>(</code>, <code>)</code>, <code>[</code>, <code>]</code>, etc.<a class="headerlink" href="#unexpected-etc" title="Permanent link">&para;</a></h3>
<p>Previous versions of Path-to-RegExp used these for RegExp features. This version no longer supports them so they've been reserved to avoid ambiguity. To use these characters literally, escape them with a backslash, e.g. <code>"\\("</code>.</p>
<h3 id="missing-parameter-name">Missing parameter name<a class="headerlink" href="#missing-parameter-name" title="Permanent link">&para;</a></h3>
<p>Parameter names must be provided after <code>:</code> or <code>*</code>, and they must be a valid JavaScript identifier. If you want an parameter name that isn't a JavaScript identifier, such as starting with a number, you can wrap the name in quotes like <code>:"my-name"</code>.</p>
<h3 id="unterminated-quote">Unterminated quote<a class="headerlink" href="#unterminated-quote" title="Permanent link">&para;</a></h3>
<p>Parameter names can be wrapped in double quote characters, and this error means you forgot to close the quote character.</p>
<h3 id="express-4x">Express &lt;= 4.x<a class="headerlink" href="#express-4x" title="Permanent link">&para;</a></h3>
<p>Path-To-RegExp breaks compatibility with Express &lt;= <code>4.x</code> in the following ways:</p>
<ul>
<li>The wildcard <code>*</code> must have a name, matching the behavior of parameters <code>:</code>.</li>
<li>The optional character <code>?</code> is no longer supported, use braces instead: <code>/:file{.:ext}</code>.</li>
<li>Regexp characters are not supported.</li>
<li>Some characters have been reserved to avoid confusion during upgrade (<code>()[]?+!</code>).</li>
