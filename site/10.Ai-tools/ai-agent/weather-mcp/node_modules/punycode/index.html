...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/punycode/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Punycode.js punycode on npm - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#punycodejs" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#punycodedecodestring" class="md-nav__link">
    punycode.decode(string)
          ...
          <li class="md-nav__item">
  <a href="#punycodeencodestring" class="md-nav__link">
    punycode.encode(string)
          ...
          <li class="md-nav__item">
  <a href="#punycodetounicodeinput" class="md-nav__link">
    punycode.toUnicode(input)
          ...
          <li class="md-nav__item">
  <a href="#punycodetoasciiinput" class="md-nav__link">
    punycode.toASCII(input)
          ...
          <li class="md-nav__item">
  <a href="#punycodeucs2" class="md-nav__link">
    punycode.ucs2
  </a>
  
    <nav class="md-nav" aria-label="punycode.ucs2">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#punycodeucs2decodestring" class="md-nav__link">
    punycode.ucs2.decode(string)
          ...
          <li class="md-nav__item">
  <a href="#punycodeucs2encodecodepoints" class="md-nav__link">
    punycode.ucs2.encode(codePoints)
          ...
          <li class="md-nav__item">
  <a href="#punycodeversion" class="md-nav__link">
    punycode.version
  </a>
  ...
  <a href="#for-maintainers" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="For maintainers">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#how-to-publish-a-new-release" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/punycode/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="punycodejs">Punycode.js <a href="https://www.npmjs.com/package/punycode"><img alt="punycode on npm" src="https://img.shields.io/npm/v/punycode" /></a> <a href="https://www.jsdelivr.com/package/npm/punycode"><img alt="" src="https://data.jsdelivr.com/v1/package/npm/punycode/badge" /></a><a class="headerlink" href="#punycodejs" title="Permanent link">&para;</a></h1>
<p>Punycode.js is a robust Punycode converter that fully complies to <a href="https://tools.ietf.org/html/rfc3492">RFC 3492</a> and <a href="https://tools.ietf.org/html/rfc5891">RFC 5891</a>.</p>
...
<p>This project was <a href="https://github.com/joyent/node/blob/master/lib/punycode.js">bundled</a> with Node.js from <a href="https://github.com/joyent/node/compare/975f1930b1...61e796decc">v0.6.2+</a> until <a href="https://github.com/nodejs/node/pull/7941">v7</a> (soft-deprecated).</p>
<p>This project provides a CommonJS module that uses ES2015+ features and JavaScript module, which work in modern Node.js versions and browsers. For the old Punycode.js version that offers the same functionality in a UMD build with support for older pre-ES2015 runtimes, including Rhino, Ringo, and Narwhal, see <a href="https://github.com/mathiasbynens/punycode.js/releases/tag/v1.4.1">v1.4.1</a>.</p>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<p>Via <a href="https://www.npmjs.com/">npm</a>:</p>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>punycode<span class="w"> </span>--save
</code></pre></div>
<p>In <a href="https://nodejs.org/">Node.js</a>:</p>
<blockquote>
<p>⚠️ Note that userland modules don't hide core modules.
For example, <code>require('punycode')</code> still imports the deprecated core module even if you executed <code>npm install punycode</code>.
Use <code>require('punycode/')</code> to import userland modules rather than core modules.</p>
</blockquote>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">punycode</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;punycode/&#39;</span><span class="p">);</span>
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<h3 id="punycodedecodestring"><code>punycode.decode(string)</code><a class="headerlink" href="#punycodedecodestring" title="Permanent link">&para;</a></h3>
<p>Converts a Punycode string of ASCII symbols to a string of Unicode symbols.</p>
<div class="highlight"><pre><span></span><code><span class="c1">// decode domain name parts</span>
<span class="nx">punycode</span><span class="p">.</span><span class="nx">decode</span><span class="p">(</span><span class="s1">&#39;maana-pta&#39;</span><span class="p">);</span><span class="w"> </span><span class="c1">// &#39;mañana&#39;</span>
<span class="nx">punycode</span><span class="p">.</span><span class="nx">decode</span><span class="p">(</span><span class="s1">&#39;--dqo34k&#39;</span><span class="p">);</span><span class="w"> </span><span class="c1">// &#39;☃-⌘&#39;</span>
</code></pre></div>
<h3 id="punycodeencodestring"><code>punycode.encode(string)</code><a class="headerlink" href="#punycodeencodestring" title="Permanent link">&para;</a></h3>
<p>Converts a string of Unicode symbols to a Punycode string of ASCII symbols.</p>
<div class="highlight"><pre><span></span><code><span class="c1">// encode domain name parts</span>
<span class="nx">punycode</span><span class="p">.</span><span class="nx">encode</span><span class="p">(</span><span class="s1">&#39;mañana&#39;</span><span class="p">);</span><span class="w"> </span><span class="c1">// &#39;maana-pta&#39;</span>
<span class="nx">punycode</span><span class="p">.</span><span class="nx">encode</span><span class="p">(</span><span class="s1">&#39;☃-⌘&#39;</span><span class="p">);</span><span class="w"> </span><span class="c1">// &#39;--dqo34k&#39;</span>
</code></pre></div>
<h3 id="punycodetounicodeinput"><code>punycode.toUnicode(input)</code><a class="headerlink" href="#punycodetounicodeinput" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="c1">// decode domain names</span>
...
<h3 id="punycodetoasciiinput"><code>punycode.toASCII(input)</code><a class="headerlink" href="#punycodetoasciiinput" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="c1">// encode domain names</span>
...
<h3 id="punycodeucs2"><code>punycode.ucs2</code><a class="headerlink" href="#punycodeucs2" title="Permanent link">&para;</a></h3>
<h4 id="punycodeucs2decodestring"><code>punycode.ucs2.decode(string)</code><a class="headerlink" href="#punycodeucs2decodestring" title="Permanent link">&para;</a></h4>
...
<div class="highlight"><pre><span></span><code><span class="nx">punycode</span><span class="p">.</span><span class="nx">ucs2</span><span class="p">.</span><span class="nx">decode</span><span class="p">(</span><span class="s1">&#39;abc&#39;</span><span class="p">);</span>
...
<h4 id="punycodeucs2encodecodepoints"><code>punycode.ucs2.encode(codePoints)</code><a class="headerlink" href="#punycodeucs2encodecodepoints" title="Permanent link">&para;</a></h4>
<p>Creates a string based on an array of numeric code point values.</p>
<div class="highlight"><pre><span></span><code><span class="nx">punycode</span><span class="p">.</span><span class="nx">ucs2</span><span class="p">.</span><span class="nx">encode</span><span class="p">([</span><span class="mh">0x61</span><span class="p">,</span><span class="w"> </span><span class="mh">0x62</span><span class="p">,</span><span class="w"> </span><span class="mh">0x63</span><span class="p">]);</span>
...
<h3 id="punycodeversion"><code>punycode.version</code><a class="headerlink" href="#punycodeversion" title="Permanent link">&para;</a></h3>
<p>A string representing the current Punycode.js version number.</p>
<h2 id="for-maintainers">For maintainers<a class="headerlink" href="#for-maintainers" title="Permanent link">&para;</a></h2>
<h3 id="how-to-publish-a-new-release">How to publish a new release<a class="headerlink" href="#how-to-publish-a-new-release" title="Permanent link">&para;</a></h3>
<ol>
<li>
<p>On the <code>main</code> branch, bump the version number in <code>package.json</code>:</p>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>version<span class="w"> </span>patch<span class="w"> </span>-m<span class="w"> </span><span class="s1">&#39;Release v%s&#39;</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>git<span class="w"> </span>push<span class="w"> </span><span class="o">&amp;&amp;</span><span class="w"> </span>git<span class="w"> </span>push<span class="w"> </span>--tags
</code></pre></div>
<p>Our CI then automatically publishes the new release to npm, under both the <a href="https://www.npmjs.com/package/punycode"><code>punycode</code></a> and <a href="https://www.npmjs.com/package/punycode.js"><code>punycode.js</code></a> names.</p>
</li>
</ol>
...
<p>Punycode.js is available under the <a href="https://mths.be/mit">MIT</a> license.</p>
