...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/raw-body/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>raw-body - Kubernetes 进阶训练营</title>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#getrawbodystream-options-callback" class="md-nav__link">
  ...
  <a href="#types" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Types">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#encodingunsupported" class="md-nav__link">
    encoding.unsupported
          ...
          <li class="md-nav__item">
  <a href="#entitytoolarge" class="md-nav__link">
    entity.too.large
  </a>
          ...
          <li class="md-nav__item">
  <a href="#requestaborted" class="md-nav__link">
    request.aborted
  </a>
          ...
          <li class="md-nav__item">
  <a href="#requestsizeinvalid" class="md-nav__link">
    request.size.invalid
          ...
          <li class="md-nav__item">
  <a href="#streamencodingset" class="md-nav__link">
    stream.encoding.set
  </a>
          ...
          <li class="md-nav__item">
  <a href="#streamnotreadable" class="md-nav__link">
    stream.not.readable
  </a>
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#simple-express-example" class="md-nav__link">
    Simple Express example
          ...
          <li class="md-nav__item">
  <a href="#simple-koa-example" class="md-nav__link">
    Simple Koa example
  </a>
          ...
          <li class="md-nav__item">
  <a href="#using-as-a-promise" class="md-nav__link">
    Using as a promise
  </a>
          ...
          <li class="md-nav__item">
  <a href="#using-with-typescript" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/raw-body/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="raw-body">raw-body<a class="headerlink" href="#raw-body" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/raw-body"><img alt="NPM Version" src="https://img.shields.io/npm/v/raw-body.svg" /></a>
<a href="https://npmjs.org/package/raw-body"><img alt="NPM Downloads" src="https://img.shields.io/npm/dm/raw-body.svg" /></a>
<a href="https://nodejs.org/en/download/"><img alt="Node.js Version" src="https://img.shields.io/node/v/raw-body.svg" /></a>
<a href="https://github.com/jshttp/stream-utils/raw-body?query=workflow%3Aci"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/stream-utils/raw-body/ci.yml?branch=master&amp;label=ci" /></a>
<a href="https://coveralls.io/r/stream-utils/raw-body?branch=master"><img alt="Test coverage" src="https://img.shields.io/coveralls/stream-utils/raw-body/master.svg" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>raw-body
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>@types/node
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">getRawBody</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;raw-body&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="getrawbodystream-options-callback">getRawBody(stream, [options], [callback])<a class="headerlink" href="#getrawbodystream-options-callback" title="Permanent link">&para;</a></h3>
...
that use file descriptors, you should <code>stream.destroy()</code> or
<code>stream.close()</code> to prevent leaks.</p>
...
<p>The errors from this module have a <code>type</code> property which allows for the programmatic
determination of the type of error returned.</p>
<h4 id="encodingunsupported">encoding.unsupported<a class="headerlink" href="#encodingunsupported" title="Permanent link">&para;</a></h4>
...
module.</p>
<h4 id="entitytoolarge">entity.too.large<a class="headerlink" href="#entitytoolarge" title="Permanent link">&para;</a></h4>
<p>This error will occur when the <code>limit</code> option is specified, but the stream has
an entity that is larger.</p>
<h4 id="requestaborted">request.aborted<a class="headerlink" href="#requestaborted" title="Permanent link">&para;</a></h4>
<p>This error will occur when the request stream is aborted by the client before
reading the body has finished.</p>
<h4 id="requestsizeinvalid">request.size.invalid<a class="headerlink" href="#requestsizeinvalid" title="Permanent link">&para;</a></h4>
<p>This error will occur when the <code>length</code> option is specified, but the stream has
emitted more bytes.</p>
<h4 id="streamencodingset">stream.encoding.set<a class="headerlink" href="#streamencodingset" title="Permanent link">&para;</a></h4>
...
<h4 id="streamnotreadable">stream.not.readable<a class="headerlink" href="#streamnotreadable" title="Permanent link">&para;</a></h4>
<p>This error will occur when the given stream is not readable.</p>
<h2 id="examples">Examples<a class="headerlink" href="#examples" title="Permanent link">&para;</a></h2>
<h3 id="simple-express-example">Simple Express example<a class="headerlink" href="#simple-express-example" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">contentType</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;content-type&#39;</span><span class="p">)</span>
...
<span class="kd">var</span><span class="w"> </span><span class="nx">getRawBody</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;raw-body&#39;</span><span class="p">)</span>
...
<h3 id="simple-koa-example">Simple Koa example<a class="headerlink" href="#simple-koa-example" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">contentType</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;content-type&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">getRawBody</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;raw-body&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">koa</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;koa&#39;</span><span class="p">)</span>

<span class="kd">var</span><span class="w"> </span><span class="nx">app</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">koa</span><span class="p">()</span>

<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="p">(</span><span class="nx">next</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">this</span><span class="p">.</span><span class="nx">text</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="k">yield</span><span class="w"> </span><span class="nx">getRawBody</span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">length</span><span class="o">:</span><span class="w"> </span><span class="k">this</span><span class="p">.</span><span class="nx">req</span><span class="p">.</span><span class="nx">headers</span><span class="p">[</span><span class="s1">&#39;content-length&#39;</span><span class="p">],</span>
<span class="w">    </span><span class="nx">limit</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;1mb&#39;</span><span class="p">,</span>
<span class="w">    </span><span class="nx">encoding</span><span class="o">:</span><span class="w"> </span><span class="nx">contentType</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="k">this</span><span class="p">.</span><span class="nx">req</span><span class="p">).</span><span class="nx">parameters</span><span class="p">.</span><span class="nx">charset</span>
<span class="w">  </span><span class="p">})</span>
<span class="w">  </span><span class="k">yield</span><span class="w"> </span><span class="nx">next</span>
<span class="p">})</span>

<span class="c1">// now access this.text</span>
</code></pre></div>
<h3 id="using-as-a-promise">Using as a promise<a class="headerlink" href="#using-as-a-promise" title="Permanent link">&para;</a></h3>
...
<span class="w">  </span><span class="nx">getRawBody</span><span class="p">(</span><span class="nx">req</span><span class="p">)</span>
<span class="w">    </span><span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">buf</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">      </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nx">buf</span><span class="p">.</span><span class="nx">length</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s1">&#39; bytes submitted&#39;</span><span class="p">)</span>
<span class="w">    </span><span class="p">})</span>
...
<h3 id="using-with-typescript">Using with TypeScript<a class="headerlink" href="#using-with-typescript" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="kr">as</span><span class="w"> </span><span class="nx">getRawBody</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;raw-body&#39;</span><span class="p">;</span>
<span class="k">import</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="kr">as</span><span class="w"> </span><span class="nx">http</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;http&#39;</span><span class="p">;</span>
...
<span class="w">  </span><span class="nx">getRawBody</span><span class="p">(</span><span class="nx">req</span><span class="p">)</span>
<span class="w">  </span><span class="p">.</span><span class="nx">then</span><span class="p">((</span><span class="nx">buf</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">statusCode</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">err</span><span class="p">.</span><span class="nx">statusCode</span><span class="p">;</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="nx">err</span><span class="p">.</span><span class="nx">message</span><span class="p">);</span>
<span class="w">  </span><span class="p">});</span>
<span class="p">});</span>
