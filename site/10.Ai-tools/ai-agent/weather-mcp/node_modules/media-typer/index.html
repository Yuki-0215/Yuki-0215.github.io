...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/media-typer/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>media-typer - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#media-typer" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#typerparsestring" class="md-nav__link">
    typer.parse(string)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#typerformatobj" class="md-nav__link">
    typer.format(obj)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#typerteststring" class="md-nav__link">
    typer.test(string)
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/media-typer/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="media-typer">media-typer<a class="headerlink" href="#media-typer" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/media-typer"><img alt="NPM Version" src="https://badgen.net/npm/v/media-typer" /></a>
<a href="https://npmjs.org/package/media-typer"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/media-typer" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/media-typer" /></a>
<a href="https://travis-ci.org/jshttp/media-typer"><img alt="Build Status" src="https://badgen.net/travis/jshttp/media-typer/master" /></a>
<a href="https://coveralls.io/r/jshttp/media-typer?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/jshttp/media-typer/master" /></a></p>
<p>Simple RFC 6838 media type parser.</p>
<p>This module will parse a given media type into it's component parts, like type,
subtype, and suffix. A formatter is also provided to put them back together and
the two can be combined to normalize media types into a canonical form.</p>
<p>If you are looking to parse the string that represents a media type and it's
parameters in HTTP (for example, the <code>Content-Type</code> header), use the
<a href="https://www.npmjs.com/package/content-type">content-type module</a>.</p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>media-typer
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<!-- eslint-disable no-unused-vars -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">typer</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;media-typer&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="typerparsestring">typer.parse(string)<a class="headerlink" href="#typerparsestring" title="Permanent link">&para;</a></h3>
<!-- eslint-disable no-undef, no-unused-vars -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">obj</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">typer</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">&#39;image/svg+xml&#39;</span><span class="p">)</span>
</code></pre></div>
...
<p>If the given type string is invalid, then a <code>TypeError</code> is thrown.</p>
<h3 id="typerformatobj">typer.format(obj)<a class="headerlink" href="#typerformatobj" title="Permanent link">&para;</a></h3>
<!-- eslint-disable no-undef, no-unused-vars -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">obj</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">typer</span><span class="p">.</span><span class="nx">format</span><span class="p">({</span><span class="w"> </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;image&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">subtype</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;svg&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">suffix</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;xml&#39;</span><span class="w"> </span><span class="p">})</span>
</code></pre></div>
...
<p>If any of the given object values are invalid, then a <code>TypeError</code> is thrown.</p>
<h3 id="typerteststring">typer.test(string)<a class="headerlink" href="#typerteststring" title="Permanent link">&para;</a></h3>
<!-- eslint-disable no-undef, no-unused-vars -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">valid</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">typer</span><span class="p">.</span><span class="nx">test</span><span class="p">(</span><span class="s1">&#39;image/svg+xml&#39;</span><span class="p">)</span>
</code></pre></div>
<p>Validate a media type string. This will return <code>true</code> is the string is a well-
formatted media type, or <code>false</code> otherwise.</p>
