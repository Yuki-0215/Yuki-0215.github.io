...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/media-typer/HISTORY/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>1.1.0 / 2019-04-24 - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#110-2019-04-24" class="md-skip">
          跳转至
        </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/media-typer/HISTORY.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="110-2019-04-24">1.1.0 / 2019-04-24<a class="headerlink" href="#110-2019-04-24" title="Permanent link">&para;</a></h1>
<ul>
<li>Add <code>test(string)</code> function</li>
</ul>
<h1 id="102-2019-04-19">1.0.2 / 2019-04-19<a class="headerlink" href="#102-2019-04-19" title="Permanent link">&para;</a></h1>
<ul>
<li>Fix JSDoc comment for <code>parse</code> function</li>
</ul>
<h1 id="101-2018-10-20">1.0.1 / 2018-10-20<a class="headerlink" href="#101-2018-10-20" title="Permanent link">&para;</a></h1>
<ul>
<li>Remove left over <code>parameters</code> property from class</li>
</ul>
<h1 id="100-2018-10-20">1.0.0 / 2018-10-20<a class="headerlink" href="#100-2018-10-20" title="Permanent link">&para;</a></h1>
<p>This major release brings the module back to it's RFC 6838 roots. If you want
a module to parse the <code>Content-Type</code> or similar HTTP headers, use the
<code>content-type</code> module instead.</p>
<ul>
<li>Drop support for Node.js below 0.8</li>
<li>Remove parameter handling, which is outside RFC 6838 scope</li>
<li>Remove <code>parse(req)</code> and <code>parse(res)</code> signatures</li>
<li>perf: enable strict mode</li>
<li>perf: use a class for object creation</li>
</ul>
<h1 id="030-2014-09-07">0.3.0 / 2014-09-07<a class="headerlink" href="#030-2014-09-07" title="Permanent link">&para;</a></h1>
<ul>
<li>Support Node.js 0.6</li>
<li>Throw error when parameter format invalid on parse</li>
</ul>
<h1 id="020-2014-06-18">0.2.0 / 2014-06-18<a class="headerlink" href="#020-2014-06-18" title="Permanent link">&para;</a></h1>
<ul>
<li>Add <code>typer.format()</code> to format media types</li>
</ul>
<h1 id="010-2014-06-17">0.1.0 / 2014-06-17<a class="headerlink" href="#010-2014-06-17" title="Permanent link">&para;</a></h1>
<ul>
...
<h1 id="000-2014-06-13">0.0.0 / 2014-06-13<a class="headerlink" href="#000-2014-06-13" title="Permanent link">&para;</a></h1>
<ul>
