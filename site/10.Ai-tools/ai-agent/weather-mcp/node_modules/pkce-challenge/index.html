...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/pkce-challenge/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>pkce-challenge - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#pkce-challenge" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Usage">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#specify-a-verifier-length" class="md-nav__link">
    Specify a verifier length
          ...
          <li class="md-nav__item">
  <a href="#challenge-verification" class="md-nav__link">
    Challenge verification
          ...
          <li class="md-nav__item">
  <a href="#challenge-generation-from-existing-code-verifier" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/pkce-challenge/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="pkce-challenge">pkce-challenge<a class="headerlink" href="#pkce-challenge" title="Permanent link">&para;</a></h1>
<p>Generate or verify a Proof Key for Code Exchange (PKCE) challenge pair.</p>
<p>Read more about <a href="https://www.oauth.com/oauth2-servers/pkce/authorization-request/">PKCE</a>.</p>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>pkce-challenge
</code></pre></div>
<h2 id="usage">Usage<a class="headerlink" href="#usage" title="Permanent link">&para;</a></h2>
<p>Default length for the verifier is 43</p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">pkceChallenge</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;pkce-challenge&quot;</span><span class="p">;</span>

<span class="k">await</span><span class="w"> </span><span class="nx">pkceChallenge</span><span class="p">();</span>
</code></pre></div>
<p>gives something like:</p>
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">    </span><span class="nx">code_verifier</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;u1ta-MQ0e7TcpHjgz33M2DcBnOQu~aMGxuiZt0QMD1C&#39;</span><span class="p">,</span>
<span class="w">    </span><span class="nx">code_challenge</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;CUZX5qE8Wvye6kS_SasIsa8MMxacJftmWdsIA_iKp3I&#39;</span>
<span class="p">}</span>
</code></pre></div>
<h3 id="specify-a-verifier-length">Specify a verifier length<a class="headerlink" href="#specify-a-verifier-length" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">challenge</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="k">await</span><span class="w"> </span><span class="nx">pkceChallenge</span><span class="p">(</span><span class="mf">128</span><span class="p">);</span>

<span class="nx">challenge</span><span class="p">.</span><span class="nx">code_verifier</span><span class="p">.</span><span class="nx">length</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="mf">128</span><span class="p">;</span><span class="w"> </span><span class="c1">// true</span>
</code></pre></div>
<h3 id="challenge-verification">Challenge verification<a class="headerlink" href="#challenge-verification" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">verifyChallenge</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;pkce-challenge&quot;</span><span class="p">;</span>

<span class="p">(</span><span class="k">await</span><span class="w"> </span><span class="nx">verifyChallenge</span><span class="p">(</span><span class="nx">challenge</span><span class="p">.</span><span class="nx">code_verifier</span><span class="p">,</span><span class="w"> </span><span class="nx">challenge</span><span class="p">.</span><span class="nx">code_challenge</span><span class="p">))</span><span class="w"> </span><span class="o">===</span>
<span class="w">  </span><span class="kc">true</span><span class="p">;</span><span class="w"> </span><span class="c1">// true</span>
</code></pre></div>
<h3 id="challenge-generation-from-existing-code-verifier">Challenge generation from existing code verifier<a class="headerlink" href="#challenge-generation-from-existing-code-verifier" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">generateChallenge</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;pkce-challenge&quot;</span><span class="p">;</span>

<span class="p">(</span><span class="k">await</span><span class="w"> </span><span class="nx">generateChallenge</span><span class="p">(</span><span class="nx">challenge</span><span class="p">.</span><span class="nx">code_verifier</span><span class="p">))</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="nx">challenge</span><span class="p">.</span><span class="nx">code_challenge</span><span class="p">;</span><span class="w"> </span><span class="c1">// true</span>
</code></pre></div>
