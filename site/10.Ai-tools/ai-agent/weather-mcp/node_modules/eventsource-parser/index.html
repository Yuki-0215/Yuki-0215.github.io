...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/eventsource-parser/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>eventsource-parser - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#eventsource-parser" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Usage">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#retry-intervals" class="md-nav__link">
    Retry intervals
  </a>
          ...
          <li class="md-nav__item">
  <a href="#parse-errors" class="md-nav__link">
    Parse errors
  </a>
  ...
  <a href="#comments" class="md-nav__link">
    Comments
        ...
        <li class="md-nav__item">
  <a href="#stream-usage" class="md-nav__link">
    Stream usage
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/eventsource-parser/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="eventsource-parser">eventsource-parser<a class="headerlink" href="#eventsource-parser" title="Permanent link">&para;</a></h1>
<p><a href="https://www.npmjs.com/package/eventsource-parser"><img alt="npm version" src="https://img.shields.io/npm/v/eventsource-parser.svg?style=flat-square" /></a><a href="https://bundlephobia.com/result?p=eventsource-parser"><img alt="npm bundle size" src="https://img.shields.io/bundlephobia/minzip/eventsource-parser?style=flat-square" /></a><a href="https://www.npmjs.com/package/eventsource-parser"><img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/eventsource-parser.svg?style=flat-square" /></a></p>
<p>A streaming parser for <a href="https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events">server-sent events/eventsource</a>, without any assumptions about how the actual stream of data is retrieved. It is intended to be a building block for <a href="https://github.com/rexxars/eventsource-client">clients</a> and polyfills in javascript environments such as browsers, node.js and deno.</p>
<p>If you are looking for a modern client implementation, see <a href="https://github.com/rexxars/eventsource-client">eventsource-client</a>.</p>
<p>You create an instance of the parser, and <em>feed</em> it chunks of data - partial or complete, and the parse emits parsed messages once it receives a complete message. A <a href="#stream-usage">TransformStream variant</a> is also available for environments that support it (modern browsers, Node 18 and higher).</p>
<p>Other modules in the EventSource family:</p>
<ul>
<li><a href="https://github.com/rexxars/eventsource-client">eventsource-client</a>: modern, feature rich eventsource client for browsers, node.js, bun, deno and other modern JavaScript environments.</li>
<li><a href="https://github.com/rexxars/eventsource-encoder">eventsource-encoder</a>: encodes messages in the EventSource/Server-Sent Events format.</li>
<li><a href="https://github.com/eventsource/eventsource">eventsource</a>: Node.js polyfill for the WhatWG EventSource API.</li>
</ul>
<blockquote>
<p>[!NOTE]
Migrating from eventsource-parser 1.x/2.x? See the <a href="./MIGRATE-v3.md">migration guide</a>.</p>
</blockquote>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>--save<span class="w"> </span>eventsource-parser
</code></pre></div>
<h2 id="usage">Usage<a class="headerlink" href="#usage" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="nx">createParser</span><span class="p">,</span><span class="w"> </span><span class="kr">type</span><span class="w"> </span><span class="nx">EventSourceMessage</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;eventsource-parser&#39;</span>

<span class="kd">function</span><span class="w"> </span><span class="nx">onEvent</span><span class="p">(</span><span class="nx">event</span><span class="o">:</span><span class="w"> </span><span class="kt">EventSourceMessage</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;Received event!&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;id: %s&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">event</span><span class="p">.</span><span class="nx">id</span><span class="w"> </span><span class="o">||</span><span class="w"> </span><span class="s1">&#39;&lt;none&gt;&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;name: %s&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">event</span><span class="p">.</span><span class="nx">name</span><span class="w"> </span><span class="o">||</span><span class="w"> </span><span class="s1">&#39;&lt;none&gt;&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;data: %s&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">event</span><span class="p">.</span><span class="nx">data</span><span class="p">)</span>
<span class="p">}</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">parser</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">createParser</span><span class="p">({</span><span class="nx">onEvent</span><span class="p">})</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">sseStream</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">getSomeReadableStream</span><span class="p">()</span>

<span class="k">for</span><span class="w"> </span><span class="k">await</span><span class="w"> </span><span class="p">(</span><span class="kd">const</span><span class="w"> </span><span class="nx">chunk</span><span class="w"> </span><span class="k">of</span><span class="w"> </span><span class="nx">sseStream</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">parser</span><span class="p">.</span><span class="nx">feed</span><span class="p">(</span><span class="nx">chunk</span><span class="p">)</span>
<span class="p">}</span>

<span class="c1">// If you want to re-use the parser for a new stream of events, make sure to reset it!</span>
...
<h3 id="retry-intervals">Retry intervals<a class="headerlink" href="#retry-intervals" title="Permanent link">&para;</a></h3>
<p>If the server sends a <code>retry</code> field in the event stream, the parser will call any <code>onRetry</code> callback specified to the <code>createParser</code> function:</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">parser</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">createParser</span><span class="p">({</span>
<span class="w">  </span><span class="nx">onRetry</span><span class="p">(</span><span class="nx">retryInterval</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;Server requested retry interval of %dms&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">retryInterval</span><span class="p">)</span>
<span class="w">  </span><span class="p">},</span>
<span class="w">  </span><span class="nx">onEvent</span><span class="p">(</span><span class="nx">event</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// …</span>
<span class="w">  </span><span class="p">},</span>
<span class="p">})</span>
</code></pre></div>
<h3 id="parse-errors">Parse errors<a class="headerlink" href="#parse-errors" title="Permanent link">&para;</a></h3>
<p>If the parser encounters an error while parsing, it will call any <code>onError</code> callback provided to the <code>createParser</code> function:</p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="kr">type</span><span class="w"> </span><span class="nx">ParseError</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;eventsource-parser&#39;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">parser</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">createParser</span><span class="p">({</span>
<span class="w">  </span><span class="nx">onError</span><span class="p">(</span><span class="nx">error</span><span class="o">:</span><span class="w"> </span><span class="kt">ParseError</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">console</span><span class="p">.</span><span class="nx">error</span><span class="p">(</span><span class="s1">&#39;Error parsing event:&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">error</span><span class="p">)</span>
<span class="w">    </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">error</span><span class="p">.</span><span class="kr">type</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="s1">&#39;invalid-field&#39;</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">console</span><span class="p">.</span><span class="nx">error</span><span class="p">(</span><span class="s1">&#39;Field name:&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">error</span><span class="p">.</span><span class="nx">field</span><span class="p">)</span>
<span class="w">      </span><span class="nx">console</span><span class="p">.</span><span class="nx">error</span><span class="p">(</span><span class="s1">&#39;Field value:&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">error</span><span class="p">.</span><span class="nx">value</span><span class="p">)</span>
<span class="w">      </span><span class="nx">console</span><span class="p">.</span><span class="nx">error</span><span class="p">(</span><span class="s1">&#39;Line:&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">error</span><span class="p">.</span><span class="nx">line</span><span class="p">)</span>
<span class="w">    </span><span class="p">}</span><span class="w"> </span><span class="k">else</span><span class="w"> </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">error</span><span class="p">.</span><span class="kr">type</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="s1">&#39;invalid-retry&#39;</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">console</span><span class="p">.</span><span class="nx">error</span><span class="p">(</span><span class="s1">&#39;Invalid retry interval:&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">error</span><span class="p">.</span><span class="nx">value</span><span class="p">)</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">},</span>
<span class="w">  </span><span class="nx">onEvent</span><span class="p">(</span><span class="nx">event</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// …</span>
...
<p>Note that <code>invalid-field</code> errors will usually be called for any invalid data - not only data shaped as <code>field: value</code>. This is because the EventSource specification says to treat anything prior to a <code>:</code> as the field name. Use the <code>error.line</code> property to get the full line that caused the error.</p>
<blockquote>
<p>[!NOTE]
When encountering the end of a stream, calling <code>.reset({consume: true})</code> on the parser to flush any remaining data and reset the parser state. This will trigger the <code>onError</code> callback if the pending data is not a valid event.</p>
</blockquote>
<h3 id="comments">Comments<a class="headerlink" href="#comments" title="Permanent link">&para;</a></h3>
<p>The parser will ignore comments (lines starting with <code>:</code>) by default. If you want to handle comments, you can provide an <code>onComment</code> callback to the <code>createParser</code> function:</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">parser</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">createParser</span><span class="p">({</span>
<span class="w">  </span><span class="nx">onComment</span><span class="p">(</span><span class="nx">comment</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;Received comment:&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">comment</span><span class="p">)</span>
<span class="w">  </span><span class="p">},</span>
<span class="w">  </span><span class="nx">onEvent</span><span class="p">(</span><span class="nx">event</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// …</span>
<span class="w">  </span><span class="p">},</span>
...
<blockquote>
<p>[!NOTE]
Leading whitespace is not stripped from comments, eg <code>: comment</code> will give <code>comment</code> as the comment value, not <code>comment</code> (note the leading space).</p>
</blockquote>
<h2 id="stream-usage">Stream usage<a class="headerlink" href="#stream-usage" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="nx">EventSourceParserStream</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;eventsource-parser/stream&#39;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">eventStream</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">response</span><span class="p">.</span><span class="nx">body</span>
<span class="w">  </span><span class="p">.</span><span class="nx">pipeThrough</span><span class="p">(</span><span class="ow">new</span><span class="w"> </span><span class="nx">TextDecoderStream</span><span class="p">())</span>
<span class="w">  </span><span class="p">.</span><span class="nx">pipeThrough</span><span class="p">(</span><span class="ow">new</span><span class="w"> </span><span class="nx">EventSourceParserStream</span><span class="p">())</span>
</code></pre></div>
<p>Note that the TransformStream is exposed under a separate export (<code>eventsource-parser/stream</code>), in order to maximize compatibility with environments that do not have the <code>TransformStream</code> constructor available.</p>
<h2 id="license">License<a class="headerlink" href="#license" title="Permanent link">&para;</a></h2>
<p>MIT © <a href="https://espen.codes/">Espen Hovlandsdal</a></p>
