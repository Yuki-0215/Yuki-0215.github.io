...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/type-is/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>type-is - Kubernetes 进阶训练营</title>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#typeisrequest-types" class="md-nav__link">
    typeis(request, types)
          ...
          <li class="md-nav__item">
  <a href="#typeishasbodyrequest" class="md-nav__link">
    typeis.hasBody(request)
          ...
          <li class="md-nav__item">
  <a href="#typeisismediatype-types" class="md-nav__link">
    typeis.is(mediaType, types)
          ...
          <li class="md-nav__item">
  <a href="#typeismatchexpected-actual" class="md-nav__link">
    typeis.match(expected, actual)
          ...
          <li class="md-nav__item">
  <a href="#typeisnormalizetype" class="md-nav__link">
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#example-body-parser" class="md-nav__link">
    Example body parser
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/type-is/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="type-is">type-is<a class="headerlink" href="#type-is" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/type-is"><img alt="NPM Version" src="https://badgen.net/npm/v/type-is" /></a>
<a href="https://npmjs.org/package/type-is"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/type-is" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/type-is" /></a>
<a href="https://github.com/jshttp/type-is/actions/workflows/ci.yml"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/type-is/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/type-is?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/jshttp/type-is/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>type-is
</code></pre></div>
...
<span class="kd">var</span><span class="w"> </span><span class="nx">typeis</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;type-is&#39;</span><span class="p">)</span>

<span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="kd">var</span><span class="w"> </span><span class="nx">istext</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">typeis</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;text/*&#39;</span><span class="p">])</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="s1">&#39;you &#39;</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="p">(</span><span class="nx">istext</span><span class="w"> </span><span class="o">?</span><span class="w"> </span><span class="s1">&#39;sent&#39;</span><span class="w"> </span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;did not send&#39;</span><span class="p">)</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s1">&#39; me text&#39;</span><span class="p">)</span>
<span class="p">})</span>
</code></pre></div>
<h3 id="typeisrequest-types">typeis(request, types)<a class="headerlink" href="#typeisrequest-types" title="Permanent link">&para;</a></h3>
<p>Checks if the <code>request</code> is one of the <code>types</code>. If the request has no body,
even if there is a <code>Content-Type</code> header, then <code>null</code> is returned. If the
<code>Content-Type</code> header is invalid or does not matches any of the <code>types</code>, then
<code>false</code> is returned. Otherwise, a string of the type that matched is returned.</p>
<p>The <code>request</code> argument is expected to be a Node.js HTTP request. The <code>types</code>
argument is an array of type strings.</p>
...
<li>A mime type with a wildcard such as <code>*/*</code> or <code>*/json</code> or <code>application/*</code>.
  The full mime type will be returned if matched.</li>
<li>A suffix such as <code>+json</code>. This can be combined with a wildcard such as
  <code>*/vnd+json</code> or <code>application/*+json</code>. The full mime type will be returned
  if matched.</li>
</ul>
<p>Some examples to illustrate the inputs and returned value:</p>
<div class="highlight"><pre><span></span><code><span class="c1">// req.headers.content-type = &#39;application/json&#39;</span>

<span class="nx">typeis</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;json&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; &#39;json&#39;</span>
<span class="nx">typeis</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;html&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;json&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; &#39;json&#39;</span>
<span class="nx">typeis</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;application/*&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; &#39;application/json&#39;</span>
<span class="nx">typeis</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;application/json&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; &#39;application/json&#39;</span>

<span class="nx">typeis</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;html&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; false</span>
</code></pre></div>
<h3 id="typeishasbodyrequest">typeis.hasBody(request)<a class="headerlink" href="#typeishasbodyrequest" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">typeis</span><span class="p">.</span><span class="nx">hasBody</span><span class="p">(</span><span class="nx">req</span><span class="p">))</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="c1">// read the body, since there is one</span>
...
<h3 id="typeisismediatype-types">typeis.is(mediaType, types)<a class="headerlink" href="#typeisismediatype-types" title="Permanent link">&para;</a></h3>
<p>Checks if the <code>mediaType</code> is one of the <code>types</code>. If the <code>mediaType</code> is invalid
or does not matches any of the <code>types</code>, then <code>false</code> is returned. Otherwise, a
string of the type that matched is returned.</p>
<p>The <code>mediaType</code> argument is expected to be a
<a href="https://tools.ietf.org/html/rfc6838">media type</a> string. The <code>types</code> argument
is an array of type strings.</p>
<p>Each type in the <code>types</code> array can be one of the following:</p>
<ul>
<li>A file extension name such as <code>json</code>. This name will be returned if matched.</li>
<li>A mime type such as <code>application/json</code>.</li>
...
<p>Some examples to illustrate the inputs and returned value:</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">mediaType</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;application/json&#39;</span>

<span class="nx">typeis</span><span class="p">.</span><span class="nx">is</span><span class="p">(</span><span class="nx">mediaType</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;json&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; &#39;json&#39;</span>
<span class="nx">typeis</span><span class="p">.</span><span class="nx">is</span><span class="p">(</span><span class="nx">mediaType</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;html&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;json&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; &#39;json&#39;</span>
<span class="nx">typeis</span><span class="p">.</span><span class="nx">is</span><span class="p">(</span><span class="nx">mediaType</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;application/*&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; &#39;application/json&#39;</span>
<span class="nx">typeis</span><span class="p">.</span><span class="nx">is</span><span class="p">(</span><span class="nx">mediaType</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;application/json&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; &#39;application/json&#39;</span>

<span class="nx">typeis</span><span class="p">.</span><span class="nx">is</span><span class="p">(</span><span class="nx">mediaType</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;html&#39;</span><span class="p">])</span><span class="w"> </span><span class="c1">// =&gt; false</span>
</code></pre></div>
<h3 id="typeismatchexpected-actual">typeis.match(expected, actual)<a class="headerlink" href="#typeismatchexpected-actual" title="Permanent link">&para;</a></h3>
<p>Match the type string <code>expected</code> with <code>actual</code>, taking in to account wildcards.
A wildcard can only be in the type of the subtype part of a media type and only
in the <code>expected</code> value (as <code>actual</code> should be the real media type to match). A
suffix can still be included even with a wildcard subtype. If an input is
malformed, <code>false</code> will be returned.</p>
<div class="highlight"><pre><span></span><code><span class="nx">typeis</span><span class="p">.</span><span class="nx">match</span><span class="p">(</span><span class="s1">&#39;text/html&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/html&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; true</span>
<span class="nx">typeis</span><span class="p">.</span><span class="nx">match</span><span class="p">(</span><span class="s1">&#39;*/html&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/html&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; true</span>
<span class="nx">typeis</span><span class="p">.</span><span class="nx">match</span><span class="p">(</span><span class="s1">&#39;text/*&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/html&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; true</span>
<span class="nx">typeis</span><span class="p">.</span><span class="nx">match</span><span class="p">(</span><span class="s1">&#39;*/*&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/html&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; true</span>
<span class="nx">typeis</span><span class="p">.</span><span class="nx">match</span><span class="p">(</span><span class="s1">&#39;*/*+json&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;application/x-custom+json&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; true</span>
</code></pre></div>
<h3 id="typeisnormalizetype">typeis.normalize(type)<a class="headerlink" href="#typeisnormalizetype" title="Permanent link">&para;</a></h3>
<p>Normalize a <code>type</code> string. This works by performing the following:</p>
<ul>
<li>If the <code>type</code> is not a string, <code>false</code> is returned.</li>
<li>If the string starts with <code>+</code> (so it is a <code>+suffix</code> shorthand like <code>+json</code>),
  then it is expanded to contain the complete wildcard notation of <code>*/*+suffix</code>.</li>
<li>If the string contains a <code>/</code>, then it is returned as the type.</li>
<li>Else the string is assumed to be a file extension and the mapped media type is
  returned, or <code>false</code> is there is no mapping.</li>
</ul>
<p>This includes two special mappings:</p>
<ul>
<li><code>'multipart'</code> -&gt; <code>'multipart/*'</code></li>
<li><code>'urlencoded'</code> -&gt; <code>'application/x-www-form-urlencoded'</code></li>
</ul>
<h2 id="examples">Examples<a class="headerlink" href="#examples" title="Permanent link">&para;</a></h2>
<h3 id="example-body-parser">Example body parser<a class="headerlink" href="#example-body-parser" title="Permanent link">&para;</a></h3>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="nx">bodyParser</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="nx">next</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="o">!</span><span class="nx">typeis</span><span class="p">.</span><span class="nx">hasBody</span><span class="p">(</span><span class="nx">req</span><span class="p">))</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="k">return</span><span class="w"> </span><span class="nx">next</span><span class="p">()</span>
<span class="w">  </span><span class="p">}</span>

<span class="w">  </span><span class="k">switch</span><span class="w"> </span><span class="p">(</span><span class="nx">typeis</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;urlencoded&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;json&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;multipart&#39;</span><span class="p">]))</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="k">case</span><span class="w"> </span><span class="s1">&#39;urlencoded&#39;</span><span class="o">:</span>
<span class="w">      </span><span class="c1">// parse urlencoded body</span>
<span class="w">      </span><span class="k">throw</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="ne">Error</span><span class="p">(</span><span class="s1">&#39;implement urlencoded body parsing&#39;</span><span class="p">)</span>
<span class="w">    </span><span class="k">case</span><span class="w"> </span><span class="s1">&#39;json&#39;</span><span class="o">:</span>
<span class="w">      </span><span class="c1">// parse json body</span>
<span class="w">      </span><span class="k">throw</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="ne">Error</span><span class="p">(</span><span class="s1">&#39;implement json body parsing&#39;</span><span class="p">)</span>
<span class="w">    </span><span class="k">case</span><span class="w"> </span><span class="s1">&#39;multipart&#39;</span><span class="o">:</span>
<span class="w">      </span><span class="c1">// parse multipart body</span>
<span class="w">      </span><span class="k">throw</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="ne">Error</span><span class="p">(</span><span class="s1">&#39;implement multipart body parsing&#39;</span><span class="p">)</span>
<span class="w">    </span><span class="k">default</span><span class="o">:</span>
<span class="w">      </span><span class="c1">// 415 error code</span>
<span class="w">      </span><span class="nx">res</span><span class="p">.</span><span class="nx">statusCode</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mf">415</span>
