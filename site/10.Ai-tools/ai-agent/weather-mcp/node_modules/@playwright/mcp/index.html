...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/%40playwright/mcp/">
    ...
    <div data-md-component="skip">
        ...
        <a href="#playwright-mcp" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#playwright-mcp" class="md-nav__link">
    Playwright MCP
  </a>
  
    <nav class="md-nav" aria-label="Playwright MCP">
  ...
  <a href="#configuration-file" class="md-nav__link">
    Configuration file
          ...
          <li class="md-nav__item">
  <a href="#standalone-mcp-server" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/@playwright/mcp/README.md" title="编辑此页" class="md-content__button md-icon">
...
<h2 id="playwright-mcp">Playwright MCP<a class="headerlink" href="#playwright-mcp" title="Permanent link">&para;</a></h2>
<p>A Model Context Protocol (MCP) server that provides browser automation capabilities using <a href="https://playwright.dev">Playwright</a>. This server enables LLMs to interact with web pages through structured accessibility snapshots, bypassing the need for screenshots or visually-tuned models.</p>
<h3 id="key-features">Key Features<a class="headerlink" href="#key-features" title="Permanent link">&para;</a></h3>
<ul>
<li><strong>Fast and lightweight</strong>. Uses Playwright's accessibility tree, not pixel-based input.</li>
<li><strong>LLM-friendly</strong>. No vision models needed, operates purely on structured data.</li>
<li><strong>Deterministic tool application</strong>. Avoids ambiguity common with screenshot-based approaches.</li>
</ul>
<h3 id="requirements">Requirements<a class="headerlink" href="#requirements" title="Permanent link">&para;</a></h3>
<ul>
<li>Node.js 18 or newer</li>
<li>VS Code, Cursor, Windsurf, Claude Desktop or any other MCP client</li>
</ul>
<!--
// Generate using:
...
<p>First, install the Playwright MCP server with your client. A typical configuration looks like this:</p>
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="s2">&quot;mcpServers&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="s2">&quot;playwright&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="s2">&quot;command&quot;</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;npx&quot;</span><span class="p">,</span>
<span class="w">      </span><span class="s2">&quot;args&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span>
<span class="w">        </span><span class="s2">&quot;@playwright/mcp@latest&quot;</span>
<span class="w">      </span><span class="p">]</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
<p><a href="https://insiders.vscode.dev/redirect?url=vscode%3Amcp%2Finstall%3F%257B%2522name%2522%253A%2522playwright%2522%252C%2522command%2522%253A%2522npx%2522%252C%2522args%2522%253A%255B%2522%2540playwright%252Fmcp%2540latest%2522%255D%257D"><img src="https://img.shields.io/badge/VS_Code-VS_Code?style=flat-square&label=Install%20Server&color=0098FF" alt="Install in VS Code"></a> <a href="https://insiders.vscode.dev/redirect?url=vscode-insiders%3Amcp%2Finstall%3F%257B%2522name%2522%253A%2522playwright%2522%252C%2522command%2522%253A%2522npx%2522%252C%2522args%2522%253A%255B%2522%2540playwright%252Fmcp%2540latest%2522%255D%257D"><img alt="Install in VS Code Insiders" src="https://img.shields.io/badge/VS_Code_Insiders-VS_Code_Insiders?style=flat-square&label=Install%20Server&color=24bfa5"></a></p>
<details><summary><b>Install in VS Code</b></summary>

You can also install the Playwright MCP server using the VS Code CLI:

<div class="highlight"><pre><span></span><code><span class="c1"># For VS Code</span>
code<span class="w"> </span>--add-mcp<span class="w"> </span><span class="s1">&#39;{&quot;name&quot;:&quot;playwright&quot;,&quot;command&quot;:&quot;npx&quot;,&quot;args&quot;:[&quot;@playwright/mcp@latest&quot;]}&#39;</span>
</code></pre></div>
...
<p>Playwright MCP server supports following arguments. They can be provided in the JSON configuration above, as a part of the <code>"args"</code> list:</p>
<!--- Options generated by update-readme.js -->

<div class="highlight"><pre><span></span><code>&gt; npx @playwright/mcp@latest --help
...
<p>You can run Playwright MCP with persistent profile like a regular browser (default), or in the isolated contexts for the testing sessions.</p>
<p><strong>Persistent profile</strong></p>
<p>All the logged in information will be stored in the persistent profile, you can delete it between sessions if you'd like to clear the offline state.
Persistent profile is located at the following locations and you can override it with the <code>--user-data-dir</code> argument.</p>
<div class="highlight"><pre><span></span><code><span class="c1"># Windows</span>
%USERPROFILE%<span class="se">\A</span>ppData<span class="se">\L</span>ocal<span class="se">\m</span>s-playwright<span class="se">\m</span>cp-<span class="o">{</span>channel<span class="o">}</span>-profile

<span class="c1"># macOS</span>
-<span class="w"> </span>~/Library/Caches/ms-playwright/mcp-<span class="o">{</span>channel<span class="o">}</span>-profile

<span class="c1"># Linux</span>
-<span class="w"> </span>~/.cache/ms-playwright/mcp-<span class="o">{</span>channel<span class="o">}</span>-profile
</code></pre></div>
<p><strong>Isolated</strong></p>
<p>In the isolated mode, each session is started in the isolated profile. Every time you ask MCP to close the browser,
the session is closed and all the storage state for this session is lost. You can provide initial storage state
to the browser via the config's <code>contextOptions</code> or via the <code>--storage-state</code> argument. Learn more about the storage
state <a href="https://playwright.dev/docs/auth">here</a>.</p>
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="s2">&quot;mcpServers&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="s2">&quot;playwright&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="s2">&quot;command&quot;</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;npx&quot;</span><span class="p">,</span>
<span class="w">      </span><span class="s2">&quot;args&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span>
<span class="w">        </span><span class="s2">&quot;@playwright/mcp@latest&quot;</span><span class="p">,</span>
<span class="w">        </span><span class="s2">&quot;--isolated&quot;</span><span class="p">,</span>
<span class="w">        </span><span class="s2">&quot;--storage-state={path/to/storage.json}&quot;</span>
<span class="w">      </span><span class="p">]</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
...
<p>The Playwright MCP server can be configured using a JSON configuration file. You can specify the configuration file
using the <code>--config</code> command line option:</p>
<div class="highlight"><pre><span></span><code>npx<span class="w"> </span>@playwright/mcp@latest<span class="w"> </span>--config<span class="w"> </span>path/to/config.json
</code></pre></div>
<details>
<summary>Configuration file schema</summary>

<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="c1">// Browser configuration</span>
<span class="w">  </span><span class="nx">browser</span><span class="o">?:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// Browser type to use (chromium, firefox, or webkit)</span>
<span class="w">    </span><span class="nx">browserName</span><span class="o">?:</span><span class="w"> </span><span class="s1">&#39;chromium&#39;</span><span class="w"> </span><span class="o">|</span><span class="w"> </span><span class="s1">&#39;firefox&#39;</span><span class="w"> </span><span class="o">|</span><span class="w"> </span><span class="s1">&#39;webkit&#39;</span><span class="p">;</span>

<span class="w">    </span><span class="c1">// Keep the browser profile in memory, do not save it to disk.</span>
<span class="w">    </span><span class="nx">isolated?</span><span class="o">:</span><span class="w"> </span><span class="kt">boolean</span><span class="p">;</span>

<span class="w">    </span><span class="c1">// Path to user data directory for browser profile persistence</span>
<span class="w">    </span><span class="nx">userDataDir?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">;</span>

<span class="w">    </span><span class="c1">// Browser launch options (see Playwright docs)</span>
<span class="w">    </span><span class="c1">// @see https://playwright.dev/docs/api/class-browsertype#browser-type-launch</span>
<span class="w">    </span><span class="nx">launchOptions</span><span class="o">?:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">channel?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">;</span><span class="w">        </span><span class="c1">// Browser channel (e.g. &#39;chrome&#39;)</span>
<span class="w">      </span><span class="nx">headless?</span><span class="o">:</span><span class="w"> </span><span class="kt">boolean</span><span class="p">;</span><span class="w">      </span><span class="c1">// Run in headless mode</span>
<span class="w">      </span><span class="nx">executablePath?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">;</span><span class="w"> </span><span class="c1">// Path to browser executable</span>
<span class="w">      </span><span class="c1">// ... other Playwright launch options</span>
<span class="w">    </span><span class="p">};</span>

<span class="w">    </span><span class="c1">// Browser context options</span>
<span class="w">    </span><span class="c1">// @see https://playwright.dev/docs/api/class-browser#browser-new-context</span>
<span class="w">    </span><span class="nx">contextOptions</span><span class="o">?:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">viewport</span><span class="o">?:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">width</span><span class="o">:</span><span class="w"> </span><span class="kt">number</span><span class="p">,</span><span class="w"> </span><span class="nx">height</span><span class="o">:</span><span class="w"> </span><span class="kt">number</span><span class="w"> </span><span class="p">};</span>
<span class="w">      </span><span class="c1">// ... other Playwright context options</span>
<span class="w">    </span><span class="p">};</span>

<span class="w">    </span><span class="c1">// CDP endpoint for connecting to existing browser</span>
<span class="w">    </span><span class="nx">cdpEndpoint?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">;</span>

<span class="w">    </span><span class="c1">// Remote Playwright server endpoint</span>
<span class="w">    </span><span class="nx">remoteEndpoint?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">;</span>
<span class="w">  </span><span class="p">},</span>

<span class="w">  </span><span class="c1">// Server configuration</span>
<span class="w">  </span><span class="nx">server</span><span class="o">?:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">port?</span><span class="o">:</span><span class="w"> </span><span class="kt">number</span><span class="p">;</span><span class="w">  </span><span class="c1">// Port to listen on</span>
<span class="w">    </span><span class="nx">host?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">;</span><span class="w">  </span><span class="c1">// Host to bind to (default: localhost)</span>
<span class="w">  </span><span class="p">},</span>

<span class="w">  </span><span class="c1">// List of enabled capabilities</span>
<span class="w">  </span><span class="nx">capabilities?</span><span class="o">:</span><span class="w"> </span><span class="kt">Array</span><span class="o">&lt;</span>
<span class="w">    </span><span class="s1">&#39;core&#39;</span><span class="w"> </span><span class="o">|</span><span class="w">    </span><span class="c1">// Core browser automation</span>
<span class="w">    </span><span class="s1">&#39;tabs&#39;</span><span class="w"> </span><span class="o">|</span><span class="w">    </span><span class="c1">// Tab management</span>
<span class="w">    </span><span class="s1">&#39;pdf&#39;</span><span class="w"> </span><span class="o">|</span><span class="w">     </span><span class="c1">// PDF generation</span>
<span class="w">    </span><span class="s1">&#39;history&#39;</span><span class="w"> </span><span class="o">|</span><span class="w"> </span><span class="c1">// Browser history</span>
<span class="w">    </span><span class="s1">&#39;wait&#39;</span><span class="w"> </span><span class="o">|</span><span class="w">    </span><span class="c1">// Wait utilities</span>
<span class="w">    </span><span class="s1">&#39;files&#39;</span><span class="w"> </span><span class="o">|</span><span class="w">   </span><span class="c1">// File handling</span>
<span class="w">    </span><span class="s1">&#39;install&#39;</span><span class="w"> </span><span class="o">|</span><span class="w"> </span><span class="c1">// Browser installation</span>
<span class="w">    </span><span class="s1">&#39;testing&#39;</span><span class="w">   </span><span class="c1">// Testing</span>
<span class="w">  </span><span class="o">&gt;</span><span class="p">;</span>

<span class="w">  </span><span class="c1">// Enable vision mode (screenshots instead of accessibility snapshots)</span>
<span class="w">  </span><span class="nx">vision?</span><span class="o">:</span><span class="w"> </span><span class="kt">boolean</span><span class="p">;</span>

<span class="w">  </span><span class="c1">// Directory for output files</span>
<span class="w">  </span><span class="nx">outputDir?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">;</span>

<span class="w">  </span><span class="c1">// Network configuration</span>
<span class="w">  </span><span class="nx">network</span><span class="o">?:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// List of origins to allow the browser to request. Default is to allow all. Origins matching both `allowedOrigins` and `blockedOrigins` will be blocked.</span>
<span class="w">    </span><span class="nx">allowedOrigins?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">[];</span>

<span class="w">    </span><span class="c1">// List of origins to block the browser to request. Origins matching both `allowedOrigins` and `blockedOrigins` will be blocked.</span>
<span class="w">    </span><span class="nx">blockedOrigins?</span><span class="o">:</span><span class="w"> </span><span class="kt">string</span><span class="p">[];</span>
<span class="w">  </span><span class="p">};</span>

<span class="w">  </span><span class="cm">/**</span>
<span class="cm">   * Do not send image responses to the client.</span>
<span class="cm">   */</span>
<span class="w">  </span><span class="nx">noImageResponses?</span><span class="o">:</span><span class="w"> </span><span class="kt">boolean</span><span class="p">;</span>
<span class="p">}</span>
</code></pre></div>
</details>

<h3 id="standalone-mcp-server">Standalone MCP server<a class="headerlink" href="#standalone-mcp-server" title="Permanent link">&para;</a></h3>
<p>When running headed browser on system w/o display or from worker processes of the IDEs,
run the MCP server from environment with the DISPLAY and pass the <code>--port</code> flag to enable SSE transport.</p>
<div class="highlight"><pre><span></span><code>npx<span class="w"> </span>@playwright/mcp@latest<span class="w"> </span>--port<span class="w"> </span><span class="m">8931</span>
</code></pre></div>
<p>And then in MCP client config, set the <code>url</code> to the SSE endpoint:</p>
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="s2">&quot;mcpServers&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="s2">&quot;playwright&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="s2">&quot;url&quot;</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;http://localhost:8931/sse&quot;</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
...
<span class="w">  </span><span class="s2">&quot;mcpServers&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="s2">&quot;playwright&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="s2">&quot;command&quot;</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;docker&quot;</span><span class="p">,</span>
<span class="w">      </span><span class="s2">&quot;args&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;run&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;-i&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;--rm&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;--init&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;--pull=always&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;mcr.microsoft.com/playwright/mcp&quot;</span><span class="p">]</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>docker build -t mcr.microsoft.com/playwright/mcp .
</code></pre></div>
</details>
...
<span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">createConnection</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;@playwright/mcp&#39;</span><span class="p">;</span>
<span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">SSEServerTransport</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;@modelcontextprotocol/sdk/server/sse.js&#39;</span><span class="p">;</span>

<span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="k">async</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="c1">// ...</span>

<span class="w">  </span><span class="c1">// Creates a headless Playwright MCP server with SSE transport</span>
<span class="w">  </span><span class="kd">const</span><span class="w"> </span><span class="nx">connection</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="k">await</span><span class="w"> </span><span class="nx">createConnection</span><span class="p">({</span><span class="w"> </span><span class="nx">browser</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">launchOptions</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">headless</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="p">});</span>
...
<span class="w">  </span><span class="k">await</span><span class="w"> </span><span class="nx">connection</span><span class="p">.</span><span class="nx">sever</span><span class="p">.</span><span class="nx">connect</span><span class="p">(</span><span class="nx">transport</span><span class="p">);</span>
...
<p>The tools are available in two modes:</p>
<ol>
<li><strong>Snapshot Mode</strong> (default): Uses accessibility snapshots for better performance and reliability</li>
<li><strong>Vision Mode</strong>: Uses screenshots for visual-based interactions</li>
</ol>
<p>To use Vision Mode, add the <code>--vision</code> flag when starting the server:</p>
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="s2">&quot;mcpServers&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="s2">&quot;playwright&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="s2">&quot;command&quot;</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;npx&quot;</span><span class="p">,</span>
<span class="w">      </span><span class="s2">&quot;args&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span>
<span class="w">        </span><span class="s2">&quot;@playwright/mcp@latest&quot;</span><span class="p">,</span>
<span class="w">        </span><span class="s2">&quot;--vision&quot;</span>
<span class="w">      </span><span class="p">]</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
<p>Vision Mode works best with the computer use models that are able to interact with elements using
X Y coordinate space, based on the provided screenshot.</p>
