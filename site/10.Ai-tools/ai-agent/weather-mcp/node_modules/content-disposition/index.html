...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/content-disposition/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>content-disposition - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#content-disposition" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#contentdispositionfilename-options" class="md-nav__link">
    contentDisposition(filename, options)
  </a>
  
    <nav class="md-nav" aria-label="contentDisposition(filename, options)">
      <ul class="md-nav__list">
  ...
  <a href="#type" class="md-nav__link">
    type
          ...
          <li class="md-nav__item">
  <a href="#contentdispositionparsestring" class="md-nav__link">
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#send-a-file-for-download" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/content-disposition/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="content-disposition">content-disposition<a class="headerlink" href="#content-disposition" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/content-disposition"><img alt="NPM Version" src="https://img.shields.io/npm/v/content-disposition.svg" /></a>
<a href="https://npmjs.org/package/content-disposition"><img alt="NPM Downloads" src="https://img.shields.io/npm/dm/content-disposition.svg" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://img.shields.io/node/v/content-disposition.svg" /></a>
<a href="https://github.com/jshttp/content-disposition?query=workflow%3Aci"><img alt="Build Status" src="https://img.shields.io/github/workflow/status/jshttp/content-disposition/ci/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/content-disposition?branch=master"><img alt="Test Coverage" src="https://img.shields.io/coveralls/jshttp/content-disposition.svg" /></a></p>
<p>Create and parse HTTP <code>Content-Disposition</code> header</p>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>content-disposition
</code></pre></div>
...
<h3 id="contentdispositionfilename-options">contentDisposition(filename, options)<a class="headerlink" href="#contentdispositionfilename-options" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Disposition&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">contentDisposition</span><span class="p">(</span><span class="s1">&#39;∫ maths.pdf&#39;</span><span class="p">))</span>
</code></pre></div>
...
<h5 id="fallback">fallback<a class="headerlink" href="#fallback" title="Permanent link">&para;</a></h5>
...
<h3 id="contentdispositionparsestring">contentDisposition.parse(string)<a class="headerlink" href="#contentdispositionparsestring" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">disposition</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">contentDisposition</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">&#39;attachment; filename=&quot;EURO rates.txt&quot;; filename*=UTF-8\&#39;\&#39;%e2%82%ac%20rates.txt&#39;</span><span class="p">)</span>
</code></pre></div>
...
<h3 id="send-a-file-for-download">Send a file for download<a class="headerlink" href="#send-a-file-for-download" title="Permanent link">&para;</a></h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">contentDisposition</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;content-disposition&#39;</span><span class="p">)</span>
