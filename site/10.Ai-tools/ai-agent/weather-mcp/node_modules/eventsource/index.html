...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/eventsource/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>eventsource - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#eventsource" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#typescript" class="md-nav__link">
    TypeScript
        ...
        <li class="md-nav__item">
  <a href="#migrating-from-v1-v2" class="md-nav__link">
    Migrating from v1 / v2
        ...
        <li class="md-nav__item">
  <a href="#extensions-to-the-whatwgw3c-api" class="md-nav__link">
    Extensions to the WhatWG/W3C API
  </a>
  
    <nav class="md-nav" aria-label="Extensions to the WhatWG/W3C API">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#message-and-code-properties-on-errors" class="md-nav__link">
    Message and code properties on errors
          ...
          <li class="md-nav__item">
  <a href="#specify-fetch-implementation" class="md-nav__link">
    Specify fetch implementation
  </a>
  
    <nav class="md-nav" aria-label="Specify fetch implementation">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#setting-http-request-headers" class="md-nav__link">
    Setting HTTP request headers
          ...
          <li class="md-nav__item">
  <a href="#httphttps-proxy" class="md-nav__link">
    HTTP/HTTPS proxy
  </a>
          ...
          <li class="md-nav__item">
  <a href="#allow-unauthorized-https-requests" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/eventsource/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="eventsource">eventsource<a class="headerlink" href="#eventsource" title="Permanent link">&para;</a></h1>
<p><a href="https://www.npmjs.com/package/eventsource"><img alt="npm version" src="https://img.shields.io/npm/v/eventsource.svg?style=flat-square" /></a><a href="https://bundlephobia.com/result?p=eventsource"><img alt="npm bundle size" src="https://img.shields.io/bundlephobia/minzip/eventsource?style=flat-square" /></a><a href="https://www.npmjs.com/package/eventsource"><img alt="npm weekly downloads" src="https://img.shields.io/npm/dw/eventsource.svg?style=flat-square" /></a></p>
<p>WhatWG/W3C-compatible <a href="https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events">server-sent events/eventsource</a> client. The module attempts to implement an absolute minimal amount of features/changes beyond the specification.</p>
<p>If you're looking for a modern alternative with a less constrained API, check out the <a href="https://www.npmjs.com/package/eventsource-client"><code>eventsource-client</code> package</a>.</p>
<h2 id="installation">Installation<a class="headerlink" href="#installation" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>--save<span class="w"> </span>eventsource
</code></pre></div>
<h2 id="supported-engines">Supported engines<a class="headerlink" href="#supported-engines" title="Permanent link">&para;</a></h2>
<ul>
<li>Node.js &gt;= 18</li>
<li>Chrome &gt;= 63</li>
<li>Safari &gt;= 11.3</li>
...
<p>Basically, any environment that supports:</p>
<ul>
...
<li><a href="https://developer.mozilla.org/en-US/docs/Web/API/TextDecoderStream">TextDecoderStream</a></li>
<li><a href="https://developer.mozilla.org/en-US/docs/Web/API/URL">URL</a></li>
<li><a href="https://developer.mozilla.org/en-US/docs/Web/API/Event">Event</a>, <a href="https://developer.mozilla.org/en-US/docs/Web/API/MessageEvent">MessageEvent</a>, <a href="https://developer.mozilla.org/en-US/docs/Web/API/EventTarget">EventTarget</a></li>
</ul>
<p>If you need to support older runtimes, try the <code>2.x</code> branch/version range (note: 2.x branch is primarily targetted at Node.js, not browsers).</p>
<h2 id="usage">Usage<a class="headerlink" href="#usage" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="nx">EventSource</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;eventsource&#39;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">es</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">EventSource</span><span class="p">(</span><span class="s1">&#39;https://my-server.com/sse&#39;</span><span class="p">)</span>

<span class="cm">/*</span>
<span class="cm"> * This will listen for events with the field `event: notice`.</span>
<span class="cm"> */</span>
<span class="nx">es</span><span class="p">.</span><span class="nx">addEventListener</span><span class="p">(</span><span class="s1">&#39;notice&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="nx">event</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
...
<span class="cm">/*</span>
<span class="cm"> * This will listen for events with the field `event: update`.</span>
<span class="cm"> */</span>
<span class="nx">es</span><span class="p">.</span><span class="nx">addEventListener</span><span class="p">(</span><span class="s1">&#39;update&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="nx">event</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">event</span><span class="p">.</span><span class="nx">data</span><span class="p">)</span>
<span class="p">})</span>

<span class="cm">/*</span>
<span class="cm"> * The event &quot;message&quot; is a special case, as it will capture events _without_ an</span>
<span class="cm"> * event field, as well as events that have the specific type `event: message`.</span>
<span class="cm"> * It will not trigger on any other event type.</span>
<span class="cm"> */</span>
<span class="nx">es</span><span class="p">.</span><span class="nx">addEventListener</span><span class="p">(</span><span class="s1">&#39;message&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="nx">event</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">event</span><span class="p">.</span><span class="nx">data</span><span class="p">)</span>
<span class="p">})</span>

<span class="cm">/**</span>
<span class="cm"> * To explicitly close the connection, call the `close` method.</span>
<span class="cm"> * This will prevent any reconnection from happening.</span>
<span class="cm"> */</span>
<span class="nx">setTimeout</span><span class="p">(()</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">es</span><span class="p">.</span><span class="nx">close</span><span class="p">()</span>
<span class="p">},</span><span class="w"> </span><span class="mf">10</span><span class="nx">_000</span><span class="p">)</span>
</code></pre></div>
<h3 id="typescript">TypeScript<a class="headerlink" href="#typescript" title="Permanent link">&para;</a></h3>
<p>Make sure you have configured your TSConfig so it matches the environment you are targetting. If you are targetting browsers, this would be <code>dom</code>:</p>
...
<p>If you're using Node.js, ensure you have <code>@types/node</code> installed (and it is version 18 or higher). Cloudflare workers have <code>@cloudflare/workers-types</code> etc.</p>
<p>The following errors are caused by targetting an environment that does not have the necessary types available:</p>
<div class="highlight"><pre><span></span><code>error TS2304: Cannot find name &#39;Event&#39;.
error TS2304: Cannot find name &#39;EventTarget&#39;.
error TS2304: Cannot find name &#39;MessageEvent&#39;.
</code></pre></div>
<h2 id="migrating-from-v1-v2">Migrating from v1 / v2<a class="headerlink" href="#migrating-from-v1-v2" title="Permanent link">&para;</a></h2>
<p>See <a href="MIGRATION.md#v2-to-v3">MIGRATION.md</a> for a detailed migration guide.</p>
<h2 id="extensions-to-the-whatwgw3c-api">Extensions to the WhatWG/W3C API<a class="headerlink" href="#extensions-to-the-whatwgw3c-api" title="Permanent link">&para;</a></h2>
<h3 id="message-and-code-properties-on-errors">Message and code properties on errors<a class="headerlink" href="#message-and-code-properties-on-errors" title="Permanent link">&para;</a></h3>
<p>The <code>error</code> event has a <code>message</code> and <code>code</code> property that can be used to get more information about the error. In the specification, the Event</p>
<div class="highlight"><pre><span></span><code><span class="nx">es</span><span class="p">.</span><span class="nx">addEventListener</span><span class="p">(</span><span class="s1">&#39;error&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="nx">err</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">err</span><span class="p">.</span><span class="nx">code</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="mf">401</span><span class="w"> </span><span class="o">||</span><span class="w"> </span><span class="nx">err</span><span class="p">.</span><span class="nx">code</span><span class="w"> </span><span class="o">===</span><span class="w"> </span><span class="mf">403</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;not authorized&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">})</span>
</code></pre></div>
<h3 id="specify-fetch-implementation">Specify <code>fetch</code> implementation<a class="headerlink" href="#specify-fetch-implementation" title="Permanent link">&para;</a></h3>
<p>The <code>EventSource</code> constructor accepts an optional <code>fetch</code> property in the second argument that can be used to specify the <code>fetch</code> implementation to use.</p>
<p>This can be useful in environments where the global <code>fetch</code> function is not available - but it can also be used to alter the request/response behaviour.</p>
<h4 id="setting-http-request-headers">Setting HTTP request headers<a class="headerlink" href="#setting-http-request-headers" title="Permanent link">&para;</a></h4>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">es</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">EventSource</span><span class="p">(</span><span class="s1">&#39;https://my-server.com/sse&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">fetch</span><span class="o">:</span><span class="w"> </span><span class="p">(</span><span class="nx">input</span><span class="p">,</span><span class="w"> </span><span class="nx">init</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span>
<span class="w">    </span><span class="nx">fetch</span><span class="p">(</span><span class="nx">input</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="p">...</span><span class="nx">init</span><span class="p">,</span>
<span class="w">      </span><span class="nx">headers</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="p">...</span><span class="nx">init</span><span class="p">.</span><span class="nx">headers</span><span class="p">,</span>
<span class="w">        </span><span class="nx">Authorization</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;Bearer myToken&#39;</span><span class="p">,</span>
<span class="w">      </span><span class="p">},</span>
<span class="w">    </span><span class="p">}),</span>
<span class="p">})</span>
</code></pre></div>
<h4 id="httphttps-proxy">HTTP/HTTPS proxy<a class="headerlink" href="#httphttps-proxy" title="Permanent link">&para;</a></h4>
<p>Use a package like <a href="https://github.com/unjs/node-fetch-native"><code>node-fetch-native</code></a> to add proxy support, either through environment variables or explicit configuration.</p>
<div class="highlight"><pre><span></span><code><span class="c1">// npm install node-fetch-native --save</span>
<span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="nx">fetch</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;node-fetch-native/proxy&#39;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">es</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">EventSource</span><span class="p">(</span><span class="s1">&#39;https://my-server.com/sse&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">fetch</span><span class="o">:</span><span class="w"> </span><span class="p">(</span><span class="nx">input</span><span class="p">,</span><span class="w"> </span><span class="nx">init</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="nx">fetch</span><span class="p">(</span><span class="nx">input</span><span class="p">,</span><span class="w"> </span><span class="nx">init</span><span class="p">),</span>
<span class="p">})</span>
</code></pre></div>
<h4 id="allow-unauthorized-https-requests">Allow unauthorized HTTPS requests<a class="headerlink" href="#allow-unauthorized-https-requests" title="Permanent link">&para;</a></h4>
<p>Use a package like <a href="https://github.com/nodejs/undici"><code>undici</code></a> for more control of fetch options through the use of an <a href="https://undici.nodejs.org/#/docs/api/Agent.md"><code>Agent</code></a>.</p>
<div class="highlight"><pre><span></span><code><span class="c1">// npm install undici --save</span>
<span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="nx">fetch</span><span class="p">,</span><span class="w"> </span><span class="nx">Agent</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;undici&#39;</span>

<span class="k">await</span><span class="w"> </span><span class="nx">fetch</span><span class="p">(</span><span class="s1">&#39;https://my-server.com/sse&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">dispatcher</span><span class="o">:</span><span class="w"> </span><span class="kt">new</span><span class="w"> </span><span class="nx">Agent</span><span class="p">({</span>
<span class="w">    </span><span class="nx">connect</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">rejectUnauthorized</span><span class="o">:</span><span class="w"> </span><span class="kt">false</span><span class="p">,</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">})</span>
</code></pre></div>
<h2 id="license">License<a class="headerlink" href="#license" title="Permanent link">&para;</a></h2>
<p>MIT-licensed. See <a href="LICENSE">LICENSE</a>.</p>
