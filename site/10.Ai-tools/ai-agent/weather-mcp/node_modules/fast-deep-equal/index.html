...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/fast-deep-equal/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>fast-deep-equal - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#fast-deep-equal" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#performance-benchmark" class="md-nav__link">
    Performance benchmark
        ...
        <li class="md-nav__item">
  <a href="#enterprise-support" class="md-nav__link">
    Enterprise support
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/fast-deep-equal/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="fast-deep-equal">fast-deep-equal<a class="headerlink" href="#fast-deep-equal" title="Permanent link">&para;</a></h1>
...
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>fast-deep-equal
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">equal</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;fast-deep-equal&#39;</span><span class="p">);</span>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">equal</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;fast-deep-equal/es6&#39;</span><span class="p">);</span>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">equal</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;fast-deep-equal/react&#39;</span><span class="p">);</span>
...
<h2 id="performance-benchmark">Performance benchmark<a class="headerlink" href="#performance-benchmark" title="Permanent link">&para;</a></h2>
<p>Node.js v12.6.0:</p>
<div class="highlight"><pre><span></span><code>fast-deep-equal x 261,950 ops/sec ±0.52% (89 runs sampled)
...
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>run<span class="w"> </span>benchmark
</code></pre></div>
