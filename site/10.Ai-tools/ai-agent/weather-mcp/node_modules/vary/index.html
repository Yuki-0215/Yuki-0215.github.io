...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/vary/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>vary - Kubernetes 进阶训练营</title>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#varyres-field" class="md-nav__link">
    vary(res, field)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#varyappendheader-field" class="md-nav__link">
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#updating-the-vary-header-when-content-is-based-on-it" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/vary/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="vary">vary<a class="headerlink" href="#vary" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/vary"><img alt="NPM Version" src="https://img.shields.io/npm/v/vary.svg" /></a>
<a href="https://npmjs.org/package/vary"><img alt="NPM Downloads" src="https://img.shields.io/npm/dm/vary.svg" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://img.shields.io/node/v/vary.svg" /></a>
<a href="https://travis-ci.org/jshttp/vary"><img alt="Build Status" src="https://img.shields.io/travis/jshttp/vary/master.svg" /></a>
<a href="https://coveralls.io/r/jshttp/vary"><img alt="Test Coverage" src="https://img.shields.io/coveralls/jshttp/vary/master.svg" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>vary
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<!-- eslint-disable no-unused-vars -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">vary</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;vary&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="varyres-field">vary(res, field)<a class="headerlink" href="#varyres-field" title="Permanent link">&para;</a></h3>
<p>Adds the given header <code>field</code> to the <code>Vary</code> response header of <code>res</code>.
This can be a string of a single field, a string of a valid <code>Vary</code>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Append &quot;Origin&quot; to the Vary header of the response</span>
...
<h3 id="varyappendheader-field">vary.append(header, field)<a class="headerlink" href="#varyappendheader-field" title="Permanent link">&para;</a></h3>
<p>Adds the given header <code>field</code> to the <code>Vary</code> response header string <code>header</code>.
This can be a string of a single field, a string of a valid <code>Vary</code> header,
or an array of multiple fields.</p>
<p>This will append the header if not already listed, otherwise leaves
it listed in the current location. The new header string is returned.</p>
<!-- eslint-disable no-undef -->

<div class="highlight"><pre><span></span><code><span class="c1">// Get header string appending &quot;Origin&quot; to &quot;Accept, User-Agent&quot;</span>
...
<h3 id="updating-the-vary-header-when-content-is-based-on-it">Updating the Vary header when content is based on it<a class="headerlink" href="#updating-the-vary-header-when-content-is-based-on-it" title="Permanent link">&para;</a></h3>
