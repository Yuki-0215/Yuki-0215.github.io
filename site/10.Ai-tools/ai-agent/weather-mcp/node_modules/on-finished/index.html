...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/on-finished/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>on-finished - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#on-finished" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#onfinishedres-listener" class="md-nav__link">
    onFinished(res, listener)
          ...
          <li class="md-nav__item">
  <a href="#onfinishedreq-listener" class="md-nav__link">
    onFinished(req, listener)
          ...
          <li class="md-nav__item">
  <a href="#onfinishedisfinishedres" class="md-nav__link">
    onFinished.isFinished(res)
          ...
          <li class="md-nav__item">
  <a href="#onfinishedisfinishedreq" class="md-nav__link">
    onFinished.isFinished(req)
        ...
        <li class="md-nav__item">
  <a href="#special-nodejs-requests" class="md-nav__link">
    Special Node.js requests
  </a>
  
    <nav class="md-nav" aria-label="Special Node.js requests">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#http-connect-method" class="md-nav__link">
    HTTP CONNECT method
  </a>
          ...
          <li class="md-nav__item">
  <a href="#http-upgrade-request" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/on-finished/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="on-finished">on-finished<a class="headerlink" href="#on-finished" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/on-finished"><img alt="NPM Version" src="https://badgen.net/npm/v/on-finished" /></a>
<a href="https://npmjs.org/package/on-finished"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/on-finished" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/on-finished" /></a>
<a href="https://github.com/jshttp/on-finished/actions/workflows/ci.yml"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/on-finished/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/on-finished?branch=master"><img alt="Coverage Status" src="https://badgen.net/coveralls/c/github/jshttp/on-finished/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>on-finished
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">onFinished</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;on-finished&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="onfinishedres-listener">onFinished(res, listener)<a class="headerlink" href="#onfinishedres-listener" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">data</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;&#39;</span>
...
<span class="nx">req</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;data&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">str</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<h3 id="onfinishedisfinishedres">onFinished.isFinished(res)<a class="headerlink" href="#onfinishedisfinishedres" title="Permanent link">&para;</a></h3>
...
<h3 id="onfinishedisfinishedreq">onFinished.isFinished(req)<a class="headerlink" href="#onfinishedisfinishedreq" title="Permanent link">&para;</a></h3>
...
<h2 id="special-nodejs-requests">Special Node.js requests<a class="headerlink" href="#special-nodejs-requests" title="Permanent link">&para;</a></h2>
<h3 id="http-connect-method">HTTP CONNECT method<a class="headerlink" href="#http-connect-method" title="Permanent link">&para;</a></h3>
...
Node.js, so there is no support for one.</p>
<h3 id="http-upgrade-request">HTTP Upgrade request<a class="headerlink" href="#http-upgrade-request" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">destroy</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;destroy&#39;</span><span class="p">)</span>
