...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/accepts/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>accepts - Kubernetes 进阶训练营</title>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#acceptsreq" class="md-nav__link">
    accepts(req)
  </a>
  
    <nav class="md-nav" aria-label="accepts(req)">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#charsetcharsets" class="md-nav__link">
    .charset(charsets)
  </a>
  ...
  <a href="#charsets" class="md-nav__link">
    .charsets()
          ...
          <li class="md-nav__item">
  <a href="#encodingencodings" class="md-nav__link">
    .encoding(encodings)
  </a>
  ...
  <a href="#encodings" class="md-nav__link">
    .encodings()
          ...
          <li class="md-nav__item">
  <a href="#languagelanguages" class="md-nav__link">
    .language(languages)
  </a>
  ...
  <a href="#languages" class="md-nav__link">
    .languages()
          ...
          <li class="md-nav__item">
  <a href="#typetypes" class="md-nav__link">
    .type(types)
  </a>
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#simple-type-negotiation" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/accepts/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="accepts">accepts<a class="headerlink" href="#accepts" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/accepts"><img alt="NPM Version" src="https://badgen.net/npm/v/accepts" /></a>
<a href="https://npmjs.org/package/accepts"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/accepts" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/accepts" /></a>
<a href="https://github.com/jshttp/accepts/actions/workflows/ci.yml"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/accepts/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/accepts?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/jshttp/accepts/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>accepts
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">accepts</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;accepts&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="acceptsreq">accepts(req)<a class="headerlink" href="#acceptsreq" title="Permanent link">&para;</a></h3>
<p>Create a new <code>Accepts</code> object for the given <code>req</code>.</p>
<h4 id="charsetcharsets">.charset(charsets)<a class="headerlink" href="#charsetcharsets" title="Permanent link">&para;</a></h4>
<p>Return the first accepted charset. If nothing in <code>charsets</code> is accepted,
then <code>false</code> is returned.</p>
<h4 id="charsets">.charsets()<a class="headerlink" href="#charsets" title="Permanent link">&para;</a></h4>
<p>Return the charsets that the request accepts, in the order of the client's
preference (most preferred first).</p>
<h4 id="encodingencodings">.encoding(encodings)<a class="headerlink" href="#encodingencodings" title="Permanent link">&para;</a></h4>
<p>Return the first accepted encoding. If nothing in <code>encodings</code> is accepted,
then <code>false</code> is returned.</p>
<h4 id="encodings">.encodings()<a class="headerlink" href="#encodings" title="Permanent link">&para;</a></h4>
<p>Return the encodings that the request accepts, in the order of the client's
preference (most preferred first).</p>
<h4 id="languagelanguages">.language(languages)<a class="headerlink" href="#languagelanguages" title="Permanent link">&para;</a></h4>
<p>Return the first accepted language. If nothing in <code>languages</code> is accepted,
then <code>false</code> is returned.</p>
<h4 id="languages">.languages()<a class="headerlink" href="#languages" title="Permanent link">&para;</a></h4>
<p>Return the languages that the request accepts, in the order of the client's
preference (most preferred first).</p>
<h4 id="typetypes">.type(types)<a class="headerlink" href="#typetypes" title="Permanent link">&para;</a></h4>
...
that is not a full MIME type is passed to <code>require('mime-types').lookup</code>.</p>
...
<h3 id="simple-type-negotiation">Simple type negotiation<a class="headerlink" href="#simple-type-negotiation" title="Permanent link">&para;</a></h3>
...
<span class="kd">function</span><span class="w"> </span><span class="nx">app</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="kd">var</span><span class="w"> </span><span class="nx">accept</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">accepts</span><span class="p">(</span><span class="nx">req</span><span class="p">)</span>

<span class="w">  </span><span class="c1">// the order of this list is significant; should be server preferred order</span>
<span class="w">  </span><span class="k">switch</span><span class="w"> </span><span class="p">(</span><span class="nx">accept</span><span class="p">.</span><span class="nx">type</span><span class="p">([</span><span class="s1">&#39;json&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;html&#39;</span><span class="p">]))</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">      </span><span class="nx">res</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span><span class="s1">&#39;{&quot;hello&quot;:&quot;world!&quot;}&#39;</span><span class="p">)</span>
<span class="w">      </span><span class="k">break</span>
<span class="w">    </span><span class="k">case</span><span class="w"> </span><span class="s1">&#39;html&#39;</span><span class="o">:</span>
...
<span class="w">      </span><span class="nx">res</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span><span class="s1">&#39;&lt;b&gt;hello, world!&lt;/b&gt;&#39;</span><span class="p">)</span>
<span class="w">      </span><span class="k">break</span>
<span class="w">    </span><span class="k">default</span><span class="o">:</span>
<span class="w">      </span><span class="c1">// the fallback is text/plain, so no need to specify it above</span>
...
<span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="nx">app</span><span class="p">).</span><span class="nx">listen</span><span class="p">(</span><span class="mf">3000</span><span class="p">)</span>
</code></pre></div>
<p>You can test this out with the cURL program:
<div class="highlight"><pre><span></span><code>curl<span class="w"> </span>-I<span class="w"> </span>-H<span class="s1">&#39;Accept: text/html&#39;</span><span class="w"> </span>http://localhost:3000/
</code></pre></div></p>
