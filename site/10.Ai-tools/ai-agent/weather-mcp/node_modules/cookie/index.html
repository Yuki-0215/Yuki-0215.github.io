...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/cookie/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>cookie - Kubernetes 进阶训练营</title>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#cookieparsestr-options" class="md-nav__link">
    cookie.parse(str, options)
  </a>
  
    <nav class="md-nav" aria-label="cookie.parse(str, options)">
      <ul class="md-nav__list">
  ...
  <a href="#decode" class="md-nav__link">
    decode
          ...
          <li class="md-nav__item">
  <a href="#cookieserializename-value-options" class="md-nav__link">
    cookie.serialize(name, value, options)
  </a>
  
    <nav class="md-nav" aria-label="cookie.serialize(name, value, options)">
      <ul class="md-nav__list">
  ...
  <a href="#encode" class="md-nav__link">
    encode
          ...
          <li class="md-nav__item">
  <a href="#expires" class="md-nav__link">
    expires
  </a>
  ...
  <a href="#maxage" class="md-nav__link">
    maxAge
          ...
          <li class="md-nav__item">
  <a href="#partitioned" class="md-nav__link">
    partitioned
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/cookie/README.md" title="编辑此页" class="md-content__button md-icon">
...
<a href="https://github.com/jshttp/cookie/actions/workflows/ci.yml"><img alt="Build Status" src="https://badgen.net/github/checks/jshttp/cookie/master?label=ci" /></a>
<a href="https://coveralls.io/r/jshttp/cookie?branch=master"><img alt="Coverage Status" src="https://badgen.net/coveralls/c/github/jshttp/cookie/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>cookie
</code></pre></div>
<h2 id="api">API<a class="headerlink" href="#api" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">cookie</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;cookie&#39;</span><span class="p">);</span>
</code></pre></div>
<h3 id="cookieparsestr-options">cookie.parse(str, options)<a class="headerlink" href="#cookieparsestr-options" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">cookies</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">cookie</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">&#39;foo=bar; equation=E%3Dmc%5E2&#39;</span><span class="p">);</span>
...
<h5 id="decode">decode<a class="headerlink" href="#decode" title="Permanent link">&para;</a></h5>
...
<h3 id="cookieserializename-value-options">cookie.serialize(name, value, options)<a class="headerlink" href="#cookieserializename-value-options" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">setCookie</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">cookie</span><span class="p">.</span><span class="nx">serialize</span><span class="p">(</span><span class="s1">&#39;foo&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;bar&#39;</span><span class="p">);</span>
...
<h5 id="domain">domain<a class="headerlink" href="#domain" title="Permanent link">&para;</a></h5>
...
<h5 id="encode">encode<a class="headerlink" href="#encode" title="Permanent link">&para;</a></h5>
...
<h5 id="expires">expires<a class="headerlink" href="#expires" title="Permanent link">&para;</a></h5>
...
<h5 id="httponly">httpOnly<a class="headerlink" href="#httponly" title="Permanent link">&para;</a></h5>
...
<code>maxAge</code> are set, then <code>maxAge</code> takes precedence, but it is possible not all clients by obey this,
so if both are set, they should point to the same date and time.</p>
<h5 id="partitioned">partitioned<a class="headerlink" href="#partitioned" title="Permanent link">&para;</a></h5>
<p>Specifies the <code>boolean</code> value for the <a href="rfc-cutler-httpbis-partitioned-cookies"><code>Partitioned</code> <code>Set-Cookie</code></a>
...
<h5 id="path">path<a class="headerlink" href="#path" title="Permanent link">&para;</a></h5>
...
<h5 id="priority">priority<a class="headerlink" href="#priority" title="Permanent link">&para;</a></h5>
<p>Specifies the <code>string</code> to be the value for the <a href="https://tools.ietf.org/html/draft-west-cookie-priority-00#section-4.1"><code>Priority</code> <code>Set-Cookie</code> attribute</a>.</p>
<ul>
...
<p><strong>note</strong> This is an attribute that has not yet been fully standardized, and may change in the future.
This also means many clients may ignore this attribute until they understand it.</p>
<h5 id="samesite">sameSite<a class="headerlink" href="#samesite" title="Permanent link">&para;</a></h5>
<p>Specifies the <code>boolean</code> or <code>string</code> to be the value for the <a href="https://tools.ietf.org/html/draft-ietf-httpbis-rfc6265bis-09#section-5.4.7"><code>SameSite</code> <code>Set-Cookie</code> attribute</a>.</p>
<ul>
...
<p><strong>note</strong> This is an attribute that has not yet been fully standardized, and may change in the future.
This also means many clients may ignore this attribute until they understand it.</p>
<h5 id="secure">secure<a class="headerlink" href="#secure" title="Permanent link">&para;</a></h5>
...
<div class="highlight"><pre><span></span><code>$ npm run bench
