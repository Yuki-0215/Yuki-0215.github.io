...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/depd/Readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>depd - Kubernetes 进阶训练营</title>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#depdnamespace" class="md-nav__link">
    depd(namespace)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#deprecatemessage" class="md-nav__link">
    deprecate(message)
  </a>
          ...
          <li class="md-nav__item">
  <a href="#deprecatefunctionfn-message" class="md-nav__link">
    deprecate.function(fn, message)
          ...
          <li class="md-nav__item">
  <a href="#deprecatepropertyobj-prop-message" class="md-nav__link">
    deprecate.property(obj, prop, message)
          ...
          <li class="md-nav__item">
  <a href="#processondeprecation-fn" class="md-nav__link">
    process.on('deprecation', fn)
          ...
          <li class="md-nav__item">
  <a href="#processenvno_deprecation" class="md-nav__link">
    process.env.NO_DEPRECATION
          ...
          <li class="md-nav__item">
  <a href="#processenvtrace_deprecation" class="md-nav__link">
  ...
  <a href="#examples" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Examples">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#deprecating-all-calls-to-a-function" class="md-nav__link">
    Deprecating all calls to a function
          ...
          <li class="md-nav__item">
  <a href="#conditionally-deprecating-a-function-call" class="md-nav__link">
    Conditionally deprecating a function call
          ...
          <li class="md-nav__item">
  <a href="#deprecating-property-access" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/depd/Readme.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="depd">depd<a class="headerlink" href="#depd" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/depd"><img alt="NPM Version" src="https://badgen.net/npm/v/depd" /></a>
<a href="https://npmjs.org/package/depd"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/depd" /></a>
<a href="https://nodejs.org/en/download/"><img alt="Node.js Version" src="https://badgen.net/npm/node/depd" /></a>
<a href="https://travis-ci.org/dougwilson/nodejs-depd"><img alt="Linux Build" src="https://badgen.net/travis/dougwilson/nodejs-depd/master?label=linux" /></a>
<a href="https://ci.appveyor.com/project/dougwilson/nodejs-depd"><img alt="Windows Build" src="https://badgen.net/appveyor/ci/dougwilson/nodejs-depd/master?label=windows" /></a>
<a href="https://coveralls.io/r/dougwilson/nodejs-depd?branch=master"><img alt="Coverage Status" src="https://badgen.net/coveralls/c/github/dougwilson/nodejs-depd/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>depd
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">deprecate</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;depd&#39;</span><span class="p">)(</span><span class="s1">&#39;my-module&#39;</span><span class="p">)</span>
</code></pre></div>
...
<h3 id="depdnamespace">depd(namespace)<a class="headerlink" href="#depdnamespace" title="Permanent link">&para;</a></h3>
...
<h3 id="deprecatemessage">deprecate(message)<a class="headerlink" href="#deprecatemessage" title="Permanent link">&para;</a></h3>
...
<h3 id="deprecatefunctionfn-message">deprecate.function(fn, message)<a class="headerlink" href="#deprecatefunctionfn-message" title="Permanent link">&para;</a></h3>
<p>Call this function to wrap a given function in a deprecation message on any
call to the function. An optional message can be supplied to provide a custom
message.</p>
<h3 id="deprecatepropertyobj-prop-message">deprecate.property(obj, prop, message)<a class="headerlink" href="#deprecatepropertyobj-prop-message" title="Permanent link">&para;</a></h3>
...
<h3 id="processondeprecation-fn">process.on('deprecation', fn)<a class="headerlink" href="#processondeprecation-fn" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code>DeprecationError: my-cool-module deprecated oldfunction
...
<h3 id="processenvno_deprecation">process.env.NO_DEPRECATION<a class="headerlink" href="#processenvno_deprecation" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span><span class="nv">NO_DEPRECATION</span><span class="o">=</span>my-module,othermod<span class="w"> </span>node<span class="w"> </span>app.js
</code></pre></div>
...
<h3 id="processenvtrace_deprecation">process.env.TRACE_DEPRECATION<a class="headerlink" href="#processenvtrace_deprecation" title="Permanent link">&para;</a></h3>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span><span class="nv">TRACE_DEPRECATION</span><span class="o">=</span>my-module,othermod<span class="w"> </span>node<span class="w"> </span>app.js
</code></pre></div>
...
<p><img alt="message" src="files/message.png" /></p>
...
<div class="highlight"><pre><span></span><code>bright cyan    bright yellow
|              |          reset       cyan
|              |          |           |
▼              ▼          ▼           ▼
...
<div class="highlight"><pre><span></span><code>Sun, 15 Jun 2014 05:21:37 GMT my-cool-module deprecated oldfunction at [eval]-wrapper:6:22
▲                             ▲              ▲          ▲              ▲
|                             |              |          |              |
...
<h3 id="deprecating-all-calls-to-a-function">Deprecating all calls to a function<a class="headerlink" href="#deprecating-all-calls-to-a-function" title="Permanent link">&para;</a></h3>
<p>This will display a deprecated message about "oldfunction" being deprecated
from "my-module" on STDERR.</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">deprecate</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;depd&#39;</span><span class="p">)(</span><span class="s1">&#39;my-cool-module&#39;</span><span class="p">)</span>
...
<h3 id="conditionally-deprecating-a-function-call">Conditionally deprecating a function call<a class="headerlink" href="#conditionally-deprecating-a-function-call" title="Permanent link">&para;</a></h3>
...
<h3 id="deprecating-property-access">Deprecating property access<a class="headerlink" href="#deprecating-property-access" title="Permanent link">&para;</a></h3>
