...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/side-channel-list/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>side-channel-list Version Badge - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#side-channel-list" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#getting-started" class="md-nav__link">
    Getting started
        ...
        <li class="md-nav__item">
  <a href="#usageexamples" class="md-nav__link">
    Usage/Examples
  </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/side-channel-list/README.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="side-channel-list">side-channel-list <sup><a href="https://npmjs.org/package/side-channel-list"><img alt="Version Badge" src="https://versionbadg.es/ljharb/side-channel-list.svg" /></a></sup><a class="headerlink" href="#side-channel-list" title="Permanent link">&para;</a></h1>
<p><a href="https://github.com/ljharb/side-channel-list/actions"><img alt="github actions" src="https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/ljharb/side-channel-list" /></a>
<a href="https://app.codecov.io/gh/ljharb/side-channel-list/"><img alt="coverage" src="https://codecov.io/gh/ljharb/side-channel-list/branch/main/graphs/badge.svg" /></a>
<a href="LICENSE"><img alt="License" src="https://img.shields.io/npm/l/side-channel-list.svg" /></a>
<a href="https://npm-stat.com/charts.html?package=side-channel-list"><img alt="Downloads" src="https://img.shields.io/npm/dm/side-channel-list.svg" /></a></p>
<p><a href="https://npmjs.org/package/side-channel-list"><img alt="npm badge" src="https://nodei.co/npm/side-channel-list.png?downloads=true&amp;stars=true" /></a></p>
<p>Store information about any JS value in a side channel, using a linked list.</p>
<p>Warning: this implementation will leak memory until you <code>delete</code> the <code>key</code>.
Use <a href="https://npmjs.com/side-channel"><code>side-channel</code></a> for the best available strategy.</p>
<h2 id="getting-started">Getting started<a class="headerlink" href="#getting-started" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>--save<span class="w"> </span>side-channel-list
</code></pre></div>
<h2 id="usageexamples">Usage/Examples<a class="headerlink" href="#usageexamples" title="Permanent link">&para;</a></h2>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">getSideChannelList</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;side-channel-list&#39;</span><span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">channel</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">getSideChannelList</span><span class="p">();</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">key</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{};</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">channel</span><span class="p">.</span><span class="nx">has</span><span class="p">(</span><span class="nx">key</span><span class="p">),</span><span class="w"> </span><span class="kc">false</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="kr">throws</span><span class="p">(()</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="nx">channel</span><span class="p">.</span><span class="nx">assert</span><span class="p">(</span><span class="nx">key</span><span class="p">),</span><span class="w"> </span><span class="ne">TypeError</span><span class="p">);</span>

<span class="nx">channel</span><span class="p">.</span><span class="nx">set</span><span class="p">(</span><span class="nx">key</span><span class="p">,</span><span class="w"> </span><span class="mf">42</span><span class="p">);</span>

<span class="nx">channel</span><span class="p">.</span><span class="nx">assert</span><span class="p">(</span><span class="nx">key</span><span class="p">);</span><span class="w"> </span><span class="c1">// does not throw</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">channel</span><span class="p">.</span><span class="nx">has</span><span class="p">(</span><span class="nx">key</span><span class="p">),</span><span class="w"> </span><span class="kc">true</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">channel</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="nx">key</span><span class="p">),</span><span class="w"> </span><span class="mf">42</span><span class="p">);</span>

<span class="nx">channel</span><span class="p">.</span><span class="ow">delete</span><span class="p">(</span><span class="nx">key</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">channel</span><span class="p">.</span><span class="nx">has</span><span class="p">(</span><span class="nx">key</span><span class="p">),</span><span class="w"> </span><span class="kc">false</span><span class="p">);</span>
<span class="nx">assert</span><span class="p">.</span><span class="kr">throws</span><span class="p">(()</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="nx">channel</span><span class="p">.</span><span class="nx">assert</span><span class="p">(</span><span class="nx">key</span><span class="p">),</span><span class="w"> </span><span class="ne">TypeError</span><span class="p">);</span>
</code></pre></div>
