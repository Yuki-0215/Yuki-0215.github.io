...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/10.Ai-tools/ai-agent/weather-mcp/node_modules/bytes/Readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Bytes utility - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#bytes-utility" class="md-skip">
          跳转至
        </a>
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Usage">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#bytesnumberstring-value-options-numberstringnull" class="md-nav__link">
    bytes(number｜string value, [options]): number｜string｜null
          ...
          <li class="md-nav__item">
  <a href="#bytesformatnumber-value-options-stringnull" class="md-nav__link">
    bytes.format(number value, [options]): string｜null
          ...
          <li class="md-nav__item">
  <a href="#bytesparsestringnumber-value-numbernull" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/10.Ai-tools/ai-agent/weather-mcp/node_modules/bytes/Readme.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="bytes-utility">Bytes utility<a class="headerlink" href="#bytes-utility" title="Permanent link">&para;</a></h1>
<p><a href="https://npmjs.org/package/bytes"><img alt="NPM Version" src="https://badgen.net/npm/v/bytes" /></a>
<a href="https://npmjs.org/package/bytes"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/bytes" /></a>
<a href="https://github.com/visionmedia/bytes.js/actions?query=workflow%3Aci"><img alt="Build Status" src="https://badgen.net/github/checks/visionmedia/bytes.js/master?label=ci" /></a>
<a href="https://coveralls.io/r/visionmedia/bytes.js?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/visionmedia/bytes.js/master" /></a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>bytes
</code></pre></div>
<h2 id="usage">Usage<a class="headerlink" href="#usage" title="Permanent link">&para;</a></h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">bytes</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;bytes&#39;</span><span class="p">);</span>
</code></pre></div>
<h4 id="bytesnumberstring-value-options-numberstringnull">bytes(number｜string value, [options]): number｜string｜null<a class="headerlink" href="#bytesnumberstring-value-options-numberstringnull" title="Permanent link">&para;</a></h4>
...
<td>Number value to format or string value to parse</td>
</tr>
<tr>
<td>options</td>
<td><code>Object</code></td>
<td>Conversion options for <code>format</code></td>
</tr>
</tbody>
</table>
...
<td>Return null upon error. Numeric value in bytes, or string value otherwise.</td>
</tr>
</tbody>
</table>
<p><strong>Example</strong></p>
<div class="highlight"><pre><span></span><code><span class="nx">bytes</span><span class="p">(</span><span class="mf">1024</span><span class="p">);</span>
<span class="c1">// output: &#39;1KB&#39;</span>

<span class="nx">bytes</span><span class="p">(</span><span class="s1">&#39;1KB&#39;</span><span class="p">);</span>
<span class="c1">// output: 1024</span>
</code></pre></div>
<h4 id="bytesformatnumber-value-options-stringnull">bytes.format(number value, [options]): string｜null<a class="headerlink" href="#bytesformatnumber-value-options-stringnull" title="Permanent link">&para;</a></h4>
...
<p><strong>Example</strong></p>
<div class="highlight"><pre><span></span><code><span class="nx">bytes</span><span class="p">.</span><span class="nx">format</span><span class="p">(</span><span class="mf">1024</span><span class="p">);</span>
<span class="c1">// output: &#39;1KB&#39;</span>

<span class="nx">bytes</span><span class="p">.</span><span class="nx">format</span><span class="p">(</span><span class="mf">1000</span><span class="p">);</span>
<span class="c1">// output: &#39;1000B&#39;</span>

<span class="nx">bytes</span><span class="p">.</span><span class="nx">format</span><span class="p">(</span><span class="mf">1000</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="nx">thousandsSeparator</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39; &#39;</span><span class="p">});</span>
<span class="c1">// output: &#39;1 000B&#39;</span>

<span class="nx">bytes</span><span class="p">.</span><span class="nx">format</span><span class="p">(</span><span class="mf">1024</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="mf">1.7</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="nx">decimalPlaces</span><span class="o">:</span><span class="w"> </span><span class="mf">0</span><span class="p">});</span>
<span class="c1">// output: &#39;2KB&#39;</span>

<span class="nx">bytes</span><span class="p">.</span><span class="nx">format</span><span class="p">(</span><span class="mf">1024</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="nx">unitSeparator</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39; &#39;</span><span class="p">});</span>
<span class="c1">// output: &#39;1 KB&#39;</span>
</code></pre></div>
<h4 id="bytesparsestringnumber-value-numbernull">bytes.parse(string｜number value): number｜null<a class="headerlink" href="#bytesparsestringnumber-value-numbernull" title="Permanent link">&para;</a></h4>
...
<p><strong>Example</strong></p>
<div class="highlight"><pre><span></span><code><span class="nx">bytes</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">&#39;1KB&#39;</span><span class="p">);</span>
<span class="c1">// output: 1024</span>

<span class="nx">bytes</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="s1">&#39;1024&#39;</span><span class="p">);</span>
<span class="c1">// output: 1024</span>

<span class="nx">bytes</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="mf">1024</span><span class="p">);</span>
<span class="c1">// output: 1024</span>
</code></pre></div>
