...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/onnxruntime/Privacy/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Privacy - Kubernetes 进阶训练营</title>
  ...
  <a href="#data-collection" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Data Collection">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#private-builds" class="md-nav__link">
    Private Builds
  </a>
          ...
          <li class="md-nav__item">
  <a href="#official-builds" class="md-nav__link">
    Official Builds
  </a>
  
    <nav class="md-nav" aria-label="Official Builds">
      <ul class="md-nav__list">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/onnxruntime/Privacy.md" title="编辑此页" class="md-content__button md-icon">
...
<h2 id="data-collection">Data Collection<a class="headerlink" href="#data-collection" title="Permanent link">&para;</a></h2>
<p>The software may collect information about you and your use of the software and send it to Microsoft. Microsoft may use this information to provide services and improve our products and services. You may turn off the telemetry as described in the repository. There are also some features in the software that may enable you and Microsoft to collect data from users of your applications. If you use these features, you must comply with applicable law, including providing appropriate notices to users of your applications together with a copy of Microsoft's privacy statement. Our privacy statement is located at https://go.microsoft.com/fwlink/?LinkID=824704. You can learn more about data collection and use in the help documentation and our privacy statement. Your use of the software operates as your consent to these practices.</p>
<hr />
<h3 id="private-builds">Private Builds<a class="headerlink" href="#private-builds" title="Permanent link">&para;</a></h3>
<p>No data collection is performed when using your private builds built from source code.</p>
<h3 id="official-builds">Official Builds<a class="headerlink" href="#official-builds" title="Permanent link">&para;</a></h3>
<p>ONNX Runtime does not maintain any independent telemetry collection mechanisms outside of what is provided by the platforms it supports. However, where applicable, ONNX Runtime will take advantage of platform-supported telemetry systems to collect trace events with the goal of improving product quality.</p>
<p>Currently telemetry is only implemented for Windows builds and is turned <strong>ON</strong> by default in the official builds distributed in their respective package management repositories (<a href="../README.md#binaries">see here</a>). This may be expanded to cover other platforms in the future. Data collection is implemented via 'Platform Telemetry' per vendor platform providers (see <a href="../onnxruntime/core/platform/telemetry.h">telemetry.h</a>).</p>
<h4 id="technical-details">Technical Details<a class="headerlink" href="#technical-details" title="Permanent link">&para;</a></h4>
<p>The Windows provider uses the <a href="https://docs.microsoft.com/en-us/windows/win32/tracelogging/trace-logging-about">TraceLogging</a> API for its implementation. This enables ONNX Runtime trace events to be collected by the operating system, and based on user consent, this data may be periodically sent to Microsoft servers following GDPR and privacy regulations for anonymity and data access controls. </p>
<p>Windows ML and onnxruntime C APIs allow Trace Logging to be turned on/off (see <a href="../README.md#api-documentation">API pages</a> for details).
For information on how to enable and disable telemetry, see <a href="./C_API.md#telemetry">C API: Telemetry</a>. 
There are equivalent APIs in the C#, Python, and Java language bindings as well.</p>
