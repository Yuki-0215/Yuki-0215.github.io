...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/onnxruntime/tools/mobile_helpers/coreml_supported_neuralnetwork_ops/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Coreml supported neuralnetwork ops - Kubernetes 进阶训练营</title>
      ...
      <div class="md-header__ellipsis">
        ...
        <div class="md-header__topic" data-md-component="header-topic">
          <span class="md-ellipsis">
              ...
              Coreml supported neuralnetwork ops
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/onnxruntime/tools/mobile_helpers/coreml_supported_neuralnetwork_ops.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


  <h1>Coreml supported neuralnetwork ops</h1>
...
<td>Only 2D Pool is supported.</td>
</tr>
<tr>
<td>ai.onnx:BatchNormalization</td>
<td></td>
</tr>
<tr>
<td>ai.onnx:Cast</td>
...
<tr>
<td>ai.onnx:Conv</td>
<td>Only 1D/2D Conv is supported.<br/>Weights and bias should be constant.</td>
</tr>
<tr>
<td>ai.onnx:DepthToSpace</td>
<td>Only DCR mode DepthToSpace is supported.</td>
</tr>
<tr>
<td>ai.onnx:Div</td>
<td></td>
...
<tr>
<td>ai.onnx:Flatten</td>
<td></td>
</tr>
<tr>
<td>ai.onnx:Gather</td>
<td>Input <code>indices</code> with scalar value is not supported.</td>
</tr>
<tr>
<td>ai.onnx:Gemm</td>
<td>Input B should be constant.</td>
</tr>
<tr>
...
<tr>
<td>ai.onnx:Pad</td>
<td>Only constant mode and last two dim padding is supported.<br/>Input pads and constant_value should be constant.<br/>If provided, axes should be constant.</td>
</tr>
<tr>
<td>ai.onnx:Pow</td>
...
<tr>
<td>ai.onnx:PRelu</td>
<td>Input slope should be constant.<br/>Input slope should either have shape [C, 1, 1] or have 1 element.</td>
</tr>
<tr>
...
<td>4D input.<br/><code>coordinate_transformation_mode</code> == <code>asymmetric</code>.<br/><code>mode</code> == <code>linear</code> or <code>nearest</code>.<br/><code>nearest_mode</code> == <code>floor</code>.<br/><code>exclude_outside</code> == false<br/><code>scales</code> or <code>sizes</code> must be constant.</td>
</tr>
<tr>
<td>ai.onnx:Shape</td>
<td>Attribute <code>start</code> with non-default value is not supported.<br/>Attribute <code>end</code> is not supported.</td>
</tr>
<tr>
...
<tr>
<td>ai.onnx:Slice</td>
<td>Inputs <code>starts</code>, <code>ends</code>, <code>axes</code>, and <code>steps</code> should be constant. Empty slice is not supported.</td>
</tr>
<tr>
