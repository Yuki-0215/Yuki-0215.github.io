...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/onnxruntime/tools/mobile_helpers/nnapi_supported_ops/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>Nnapi supported ops - Kubernetes 进阶训练营</title>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/onnxruntime/tools/mobile_helpers/nnapi_supported_ops.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


  <h1>Nnapi supported ops</h1>
...
<tr>
<td>ai.onnx:Conv</td>
<td>Only 2D Conv is supported.<br/>Weights and bias should be constant.</td>
</tr>
<tr>
...
<tr>
<td>ai.onnx:DequantizeLinear</td>
<td>All quantization scales and zero points should be constant.</td>
</tr>
<tr>
<td>ai.onnx:Div</td>
<td></td>
...
<td>Input indices should be constant if not int32 type.</td>
</tr>
<tr>
<td>ai.onnx:Gemm</td>
<td>If input B is not constant, transB should be 1.</td>
</tr>
<tr>
...
<tr>
<td>ai.onnx:Pad</td>
<td>Only constant mode Pad is supported.<br/>Input pads and constant_value should be constant.<br/>Input pads values should be non-negative.</td>
</tr>
<tr>
<td>ai.onnx:Pow</td>
<td></td>
...
<tr>
<td>ai.onnx:QLinearConv</td>
<td>Only 2D Conv is supported.<br/>Weights and bias should be constant.<br/>All quantization scales and zero points should be constant.</td>
</tr>
<tr>
<td>ai.onnx:QLinearMatMul</td>
<td>All quantization scales and zero points should be constant.</td>
</tr>
<tr>
<td>ai.onnx:QuantizeLinear</td>
<td>All quantization scales and zero points should be constant.</td>
</tr>
<tr>
...
<td>Only 2D Resize is supported.</td>
</tr>
<tr>
...
<tr>
<td>ai.onnx:Split</td>
<td>Number of splits must evenly divide split axis size. Input split should be constant if provided.</td>
</tr>
<tr>
<td>ai.onnx:Sqrt</td>
<td></td>
...
<td>Input axes should be constant.</td>
</tr>
<tr>
<td>ai.onnx:Sub</td>
<td></td>
...
<tr>
<td>com.microsoft:QLinearAdd</td>
<td>All quantization scales and zero points should be constant.</td>
</tr>
<tr>
<td>com.microsoft:QLinearAveragePool</td>
<td>Only 2D Pool is supported.<br/>All quantization scales and zero points should be constant.</td>
</tr>
<tr>
<td>com.microsoft:QLinearSigmoid</td>
<td>All quantization scales and zero points should be constant.</td>
</tr>
</tbody>
</table>
