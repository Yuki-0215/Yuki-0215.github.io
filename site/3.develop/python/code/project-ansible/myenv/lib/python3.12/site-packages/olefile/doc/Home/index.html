...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/olefile/doc/Home/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>olefile v0.42 documentation - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#olefile-v042-documentation" class="md-skip">
          跳转至
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="目录">
  ...
  <a href="#history" class="md-nav__link">
    History
        ...
        <li class="md-nav__item">
  <a href="#main-improvements-over-the-original-version-of-olefileio-in-pil" class="md-nav__link">
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/olefile/doc/Home.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="olefile-v042-documentation">olefile v0.42 documentation<a class="headerlink" href="#olefile-v042-documentation" title="Permanent link">&para;</a></h1>
<p>This is the home page of the documentation for olefile. The latest version can be found 
<a href="https://bitbucket.org/decalage/olefileio_pl/wiki">online</a>, otherwise a copy is provided in the doc subfolder of the package.</p>
<p><a href="http://www.decalage.info/olefile">olefile</a> is a Python package to parse, read and write 
<a href="http://en.wikipedia.org/wiki/Compound_File_Binary_Format">Microsoft OLE2 files</a>
...
formats, McAfee antivirus quarantine files, etc.</p>
<p><strong>Quick links:</strong> 
<a href="http://www.decalage.info/olefile">Home page</a> - 
<a href="https://bitbucket.org/decalage/olefileio_pl/wiki/Install">Download/Install</a> - 
<a href="https://bitbucket.org/decalage/olefileio_pl/wiki">Documentation</a> - 
<a href="https://bitbucket.org/decalage/olefileio_pl/issues?status=new&amp;status=open">Report Issues/Suggestions/Questions</a> - 
<a href="http://decalage.info/contact">Contact the author</a> - 
<a href="https://bitbucket.org/decalage/olefileio_pl">Repository</a> - 
<a href="https://twitter.com/decalage2">Updates on Twitter</a></p>
<h2 id="documentation-pages">Documentation pages<a class="headerlink" href="#documentation-pages" title="Permanent link">&para;</a></h2>
<ul>
<li>[[License]]</li>
<li>[[Install]]</li>
...
<ul>
<li>Parse, read and write any OLE file such as Microsoft Office 97-2003 legacy document formats (Word .doc, Excel .xls, 
    PowerPoint .ppt, Visio .vsd, Project .mpp), Image Composer and FlashPix files, Outlook messages, StickyNotes, Zeiss 
    AxioVision ZVI files, Olympus FluoView OIB files, etc</li>
...
<p>olefile is mostly meant for developers. If you are looking for tools to analyze OLE files or to extract data 
(especially for security purposes such as malware analysis and forensics), then please also check my 
<a href="http://www.decalage.info/python/oletools">python-oletools</a>, which are built upon olefile and provide a higher-level 
interface.</p>
<h2 id="history">History<a class="headerlink" href="#history" title="Permanent link">&para;</a></h2>
<p>olefile is based on the OleFileIO module from <a href="http://www.pythonware.com/products/pil/index.htm">PIL</a>, the excellent 
...
its 9 years and its new write features. </p>
<p>As far as I know, this module is the most complete and robust Python implementation to read MS OLE2 files, portable on 
several operating systems. (please tell me if you know other similar Python modules)</p>
<p>Since 2014 olefile/OleFileIO_PL has been integrated into <a href="http://python-imaging.github.io/">Pillow</a>, the friendly fork 
of PIL. olefile will continue to be improved as a separate project, and new versions will be merged into Pillow regularly.</p>
<h2 id="main-improvements-over-the-original-version-of-olefileio-in-pil">Main improvements over the original version of OleFileIO in PIL:<a class="headerlink" href="#main-improvements-over-the-original-version-of-olefileio-in-pil" title="Permanent link">&para;</a></h2>
<ul>
