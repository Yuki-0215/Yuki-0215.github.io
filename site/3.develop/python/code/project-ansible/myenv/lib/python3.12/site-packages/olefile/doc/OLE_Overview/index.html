...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/olefile/doc/OLE_Overview/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>About the structure of OLE files - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#about-the-structure-of-ole-files" class="md-skip">
          跳转至
        </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/olefile/doc/OLE_Overview.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="about-the-structure-of-ole-files">About the structure of OLE files<a class="headerlink" href="#about-the-structure-of-ole-files" title="Permanent link">&para;</a></h1>
...
<p>Special streams can contain <strong>properties</strong>. A property is a specific value that can be used to store information such as the metadata of a document (title, author, creation date, etc). Property stream names usually start with the character '\x05'.</p>
<p>For example, a typical MS Word document may look like this:</p>
<p><img alt="" src="../OLE_VBA_sample.png" /></p>
<p>Go to the [[API]] page to see how to use all olefile features to parse OLE files.</p>
<hr />
