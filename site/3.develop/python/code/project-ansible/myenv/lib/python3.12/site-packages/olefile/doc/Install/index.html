...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://barry-boy.github.io/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/olefile/doc/Install/">
      ...
      <meta name="generator" content="mkdocs-1.6.0, mkdocs-material-8.0.0">
        ...
        <title>How to Download and Install olefile - Kubernetes 进阶训练营</title>
    ...
    <div data-md-component="skip">
        ...
        <a href="#how-to-download-and-install-olefile" class="md-skip">
          跳转至
        </a>
...
<a href="https://github.com/barry-boy/barry-boy.github.io/edit/master/docs/3.develop/python/code/project-ansible/myenv/lib/python3.12/site-packages/olefile/doc/Install.md" title="编辑此页" class="md-content__button md-icon">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.71 7.04c.39-.39.39-1.04 0-1.41l-2.34-2.34c-.37-.39-1.02-.39-1.41 0l-1.84 1.83 3.75 3.75M3 17.25V21h3.75L17.81 9.93l-3.75-3.75L3 17.25z"/></svg>
</a>


<h1 id="how-to-download-and-install-olefile">How to Download and Install olefile<a class="headerlink" href="#how-to-download-and-install-olefile" title="Permanent link">&para;</a></h1>
...
<p>For Python 2.5 and older, olefile falls back to an older version (based on OleFileIO_PL 0.26) which might not contain 
all the enhancements implemented in olefile. </p>
...
<p>To use olefile with other Python applications or your own scripts, the simplest solution is to run <strong>pip install olefile</strong> 
or <strong>easy_install olefile</strong>, to download and install the package in one go. Pip is part of the standard Python 
distribution since v2.7.9.</p>
<p>To update olefile if a previous version is already installed, run <strong>pip install -U olefile</strong>.</p>
<p>Otherwise you may download/extract the <a href="https://bitbucket.org/decalage/olefileio_pl/downloads">zip archive</a> in a 
temporary directory and run <strong>python setup.py install</strong>. </p>
